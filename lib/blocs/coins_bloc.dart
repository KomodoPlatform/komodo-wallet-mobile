  ...
  Future<CoinToActivate> _activeCoinFuture(Coin coin) async {
    ...
    return await ApiProvider()
      ...
      if (activeCoin is ActiveCoin) {
        ...
        Log.println('coins_bloc:307', 'ERROR: ' + activeCoin.error.toString());
        ...
        if (activeCoin is ErrorString) {
          Log.println(
              'coins_bloc:313', 'ERROR: ' + activeCoin.error.toString());
        }
        currentCoinActivate(CoinToActivate(
      ...
      Log.println('coins_bloc:321', 'Sorry, ${coin.abbr} not available.');
      currentCoinActivate(
