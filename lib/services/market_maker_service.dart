...
class MarketMakerService {
  ...
  Future<void> runBin() async {
    ...
    List<Coin> coinsJson = await coinsBloc.readJsonCoin();
    if (coinsJson.isEmpty) {
      coinsJson = await mm2.loadJsonCoinsDefault();
      await coinsBloc.writeJsonCoin(coinsJson);
    }
