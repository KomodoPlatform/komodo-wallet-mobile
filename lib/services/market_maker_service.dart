...
class MarketMakerService {
  ...
  bool mm2Ready = false;
  String pubkey = "";
  String filesPath = "/data/data/com.komodoplatform.atomicdex/files/";
  var sink;
  ...
  Future<void> runBin() async {
    ...
    String startParam =
        '{\"gui\":\"atomicDEX\",\"netid\":9999,\"client\":1,\"userhome\":\"${filesPath}\",\"passphrase\":\"$passphrase\",\"rpc_password\":\"$userpass\",\"coins\":$coins}';
