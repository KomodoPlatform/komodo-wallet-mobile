...
class MarketMakerService {
  ...
  Future<void> runBin() async {
    ...
    ProcessResult checkmm2 = await Process.run(
        'ls', ['/data/data/com.komodoplatform.atomicdex/files/mm2']);

    if (checkmm2.stdout.toString().trim() !=
        "/data/data/com.komodoplatform.atomicdex/files/mm2") {
  ...
  Future<File> get _localFile async {
    return File('/data/data/com.komodoplatform.atomicdex/files/mm2');
  }
