...
class MarketMakerService {
  ...
  Future<List<Balance>> getAllBalances(bool forceUpdate) async {
    ...
    if (this.balances.isEmpty || forceUpdate || coins.length != this.balances.length) {
      List<Balance> balances = new List<Balance>();
  ...
  Future<dynamic> postWithdraw(
      Coin coin, String addressTo, double amount) async {
