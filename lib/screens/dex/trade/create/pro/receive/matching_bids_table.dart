...
import 'package:komodo_dex/screens/dex/trade/create/pro/receive/bid_details_dialog.dart';
import 'package:komodo_dex/screens/dex/trade/create/pro/receive/not_enough_volume_dialog.dart';
...
class _MatchingBidsTableState extends State<MatchingBidsTable> {
  ...
  void _createOrder(Ask bid) {
    final double myVolume = bid.getReceiveAmount(deci(_sellAmount)).toDouble();
    final bool isEnoughVolume =
        !(bid.minVolume != null && myVolume < bid.minVolume);
