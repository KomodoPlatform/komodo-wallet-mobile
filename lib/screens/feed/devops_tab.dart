          ...
          statusHistory: [
            ...
            DevStatus(
                ...
                issue: Issue(
                  id: '701',
                  title:
                      'rewamp the news section rewamp the news section rewamp the news section rewamp the news section rewamp the news section rewamp the news section rewamp the news section rewamp the news section rewamp the news section rewamp the news section ',
                  url: 'https://github.com/ca333/komodoDEX/issues/701',
                )),
          ]),
    ];
