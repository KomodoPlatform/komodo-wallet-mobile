...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} está disponible para dispositivos móviles en Android y iPhone, y para computadoras de escritorio en <a href=\"https://piratechain.com/\">sistemas operativos Windows, Mac y Linux</a>.";
  ...
  static m15(appName) =>
      "¡Absolutamente! Puede leer nuestra <a href=\"https://piratechain.com/faq/\">documentación para desarrolladores</a> para obtener más detalles o contactarnos con sus consultas sobre asociaciones. ¿Tiene una pregunta técnica específica? ¡La comunidad de desarrolladores de ${appName} siempre está lista para ayudar!";
