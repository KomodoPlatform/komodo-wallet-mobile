...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m24(title) => "Solo mostrar contactos con direcciones ${title}";
  ...
  static m2(index) => "¿Cuál es la palabra ${index} en su frase inicial?";
  ...
  static m38(gas) => "No hay suficiente gas: usa al menos ${gas} Gwei";
  ...
  static m39(coin) => "Enviando solicitud a la llave ${coin}...";

  static m40(appCompanyShort) => "${appCompanyShort} noticias";
  ...
  static m46(coin) => "Active ${coin} y añada saldo primero";

  static m17(coinName) => "Ingrese la cantidad de ${coinName}.";

  static m47(coin) => "¡Ha recibido una transacción de ${coin}!";

  static m48(coin) => "Todos los pedidos de ${coin} serán cancelados.";

  static m49(delta) => "Expediente: CEX +${delta}%";

  static m50(delta) => "Caro: CEX ${delta}%";

  static m51(fill) => "${fill}% llenado";

  static m52(coin) => "Cantidad (${coin})";

  static m53(coin) => "Total (${coin})";

  static m54(abbr) => "${abbr} no está activo. Activa e inténtalo de nuevo..";

  static m55(appName) => "¿En qué dispositivos puedo usar ${appName}?";

  static m56(appName) =>
      "¿En qué se diferencia el comercio en ${appName} del comercio en otros DEX?";

  static m57(appName) => "¿Cómo se calculan las tarifas de ${appName}?";

  static m58(appName) => "¿Quién está detrás de ${appName}?";

  static m59(appName) =>
      "¿Es posible desarrollar mi propio intercambio con ${appName}?";

  static m60(dd) => "${dd} dias(s)";

  static m61(hh, minutes) => "${hh}h ${minutes}m";

  static m62(mm) => "${mm}min";

  static m63(coin) => "Ingrese la cantidad de ${coin} para comprar";

  static m64(maxCoins) =>
      "El número máximo de monedas activas es ${maxCoins}. Por favor, desactive algunos.";

  static m65(coin) => "${coin} no está activo!";

  static m66(coin) => "Ingrese la cantidad de ${coin} para vender";
  ...
  static m69(coin) => "Activa ${coin} y recarga el saldo primero";

  static m70(coin) =>
      "El saldo de ${coin} no es suficiente para pagar las tarifas de transacción.";

  static m71(appName) => "${appName} actualizar";
