...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} 适用于 Android 和 iPhone 上的移动设备，以及 <a href=\"https://piratechain.com/\">Windows、Mac 和 Linux 操作系统</a> 上的桌面设备。";
  ...
  static m10(appName) =>
      "几个因素决定了每次交易的处理时间。交易资产的区块时间取决于各自的网络（比特币通常是最慢的）。此外，用户可以自定义安全偏好。例如，您可以要求${appName}在确认ARRR交易为最终交易前确认3次，这使得交易时间短于等待公证的<a href=\"https://piratechain.com/faq/\">时间</a>.";
  ...
  static m15(appName) =>
      "绝对地！您可以阅读我们的<a href=\"https://piratechain.com/faq/\">开发者文档</a>了解更多详细信息，或者联系我们咨询您的合作伙伴关系。有具体的技术问题吗？ ${appName} 开发者社区随时准备提供帮助！";
