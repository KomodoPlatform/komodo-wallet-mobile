...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static dynamic m10(dynamic coinName, dynamic number) => '最低可卖出数量 ${number} ${coinName}';

  static dynamic m11(dynamic coinName, dynamic number) => '最低可买入数量 ${number} ${coinName}';
  ...
  static dynamic m7(dynamic amount, dynamic coinName) => '提领 ${amount} ${coinName}';
  ...
  static dynamic _notInlinedMessages(dynamic _) => <String, Function>{
    ...
    'activateAccessBiometric' : MessageLookupByLibrary.simpleMessage('开启生物识别功能'),
    ...
    'buySuccessWaiting' : MessageLookupByLibrary.simpleMessage('兑换需求发布, 请稍后！'),
    ...
    'checkSeedPhraseButton2' : MessageLookupByLibrary.simpleMessage('返回并再次检查'),
    'checkSeedPhraseHint' : m1,
    'checkSeedPhraseInfo' : MessageLookupByLibrary.simpleMessage('您的助记词是很重要的所以我们要确认您有正确备份。我们将问您三个有关您的助记词的问题以确保您可以随时恢复钱包。'),
    ...
    'confirmeula' : MessageLookupByLibrary.simpleMessage('我了解点击以下的按钮，即表示我已阅读及接受终端使用者授权协议(EULA) & 使用条款与条件 。'),
    ...
    'getBackupPhrase' : MessageLookupByLibrary.simpleMessage('重要提醒: 在继续之前请记得备份助记词！'),
    ...
    'infoPasswordDialog' : MessageLookupByLibrary.simpleMessage('如果您不使用密码，每次进入钱包时都需要输入助记词。'),
    'infoTrade1' : MessageLookupByLibrary.simpleMessage('兑换需求是无法撤销的！'),
    'infoTrade2' : MessageLookupByLibrary.simpleMessage('此交易时间可能长达 10 分钟 - 请勿关闭应用程式！'),
    'infoWalletPassword' : MessageLookupByLibrary.simpleMessage('您可以选择使用密码加密您的钱包。如果您选择不使用密码，则每次进入钱包时都需要输入助记词。'),
    ...
    'noRewardYet' : MessageLookupByLibrary.simpleMessage('没有奖励可领取 - 请一个小时后重试。'),
    ...
    'notEnoughtBalanceForFee' : MessageLookupByLibrary.simpleMessage('余额不足以支付手续费 - 请调整交易数量。'),
    'numberAssets' : m4,
    ...
    'recommendSeedMessage' : MessageLookupByLibrary.simpleMessage('我们强烈建议离线保管。'),
    ...
    'settingDialogSpan5' : MessageLookupByLibrary.simpleMessage(' 以便将来恢复钱包。'),
    ...
    'welcomeInfo' : MessageLookupByLibrary.simpleMessage('ATOMIC DEX 是次世代多币别钱包, 具有原生第三代的DEX功能等等。'),
