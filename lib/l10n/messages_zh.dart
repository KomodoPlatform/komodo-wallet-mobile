...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m9(appName) =>
      "其他DEX（去中心化交易所）通常只允许您使用代理代币交易基于单个区块链网络的资产，并且只能用一个基金下一个订单。\n但用${appName}您可以在两个不同的区块链网络之间进行交易，且无需代理代币。您还可以用一个基金下多个订单。例如，您可以用FIRO、QTUM或VRSC兑0.1 BTC，第一个订单成交后自动取消其他所有订单";

  static m10(appName) =>
      "几个因素决定了每次交易的处理时间。交易资产的区块时间取决于各自的网络（比特币通常是最慢的）。此外，用户可以自定义安全偏好。例如，您可以要求${appName}在确认FIRO交易为最终交易前确认3次，这使得交易时间短于等待公证的<a href=\"https://firo.org/\">时间</a>.";
  ...
  static m15(appName) =>
      "绝对地！您可以阅读我们的<a href=\"https://firo.org/\">开发者文档</a>了解更多详细信息，或者联系我们咨询您的合作伙伴关系。有具体的技术问题吗？ ${appName} 开发者社区随时准备提供帮助！";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "builtFiro": MessageLookupByLibrary.simpleMessage("基于Firo"),
        "builtOnKmd": MessageLookupByLibrary.simpleMessage("基于Firo"),
        ...
        "dPow": MessageLookupByLibrary.simpleMessage("Firo dPoW安全"),
        ...
        "poweredOnKmd": MessageLookupByLibrary.simpleMessage("由Firo支持"),
        ...
        "rebrandingAnnouncement": MessageLookupByLibrary.simpleMessage(
            "这是一个新时代！我们已正式将名称从“AtomicDEX”更改为“Firo Wallet”"),
