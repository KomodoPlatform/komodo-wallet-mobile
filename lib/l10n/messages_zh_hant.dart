...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static dynamic m10(dynamic coinName, dynamic number) => '最低可賣出數量 ${number} ${coinName}';

  static dynamic m11(dynamic coinName, dynamic number) => '最低可買入數量 ${number} ${coinName}';
  ...
  static dynamic m6(dynamic coinName, dynamic address) => '我的 ${coinName} 地址: \\n${address}';

  static dynamic m7(dynamic amount, dynamic coinName) => '提領${amount} ${coinName}';
  ...
  static dynamic _notInlinedMessages(dynamic _) => <String, Function>{
    'accepteula' : MessageLookupByLibrary.simpleMessage('同意接受終端使用者授權協議 (EULA)'),
    'accepttac' : MessageLookupByLibrary.simpleMessage('接受條款與條件'),
    'activateAccessBiometric' : MessageLookupByLibrary.simpleMessage('開啟生物識別功能'),
    ...
    'buySuccessWaiting' : MessageLookupByLibrary.simpleMessage('兌換需求發布, 請稍後！'),
    ...
    'checkSeedPhraseInfo' : MessageLookupByLibrary.simpleMessage('您的助記詞是很重要的所以我們要確認您有正確備份。我們將問您三個有關您的助記詞的問題以確保您可以隨時恢復錢包。'),
    'checkSeedPhraseSubtile' : m2,
    'checkSeedPhraseTitle' : MessageLookupByLibrary.simpleMessage('請再次確認助記詞'),
    ...
    'confirmeula' : MessageLookupByLibrary.simpleMessage('我了解點擊以下的按鈕，即表示我已閱讀及接受終端使用者授權協議(EULA) & 使用條款與條件 。'),
    ...
    'getBackupPhrase' : MessageLookupByLibrary.simpleMessage('重要提醒: 在繼續之前請記得備份助記詞 !'),
    ...
    'infoPasswordDialog' : MessageLookupByLibrary.simpleMessage('如果您不使用密碼，每次進入錢包時都需要輸入助記詞。'),
    'infoTrade1' : MessageLookupByLibrary.simpleMessage('兌換需求是無法撤銷的！'),
    'infoTrade2' : MessageLookupByLibrary.simpleMessage('此交易時間可能長達 10 分鐘 - 請勿關閉應用程式！'),
    'infoWalletPassword' : MessageLookupByLibrary.simpleMessage('您可以選擇使用密碼加密您的錢包。如果您選擇不使用密碼，則每次進入錢包時都需要輸入助記詞。'),
    ...
    'mediaNotSavedDescription' : MessageLookupByLibrary.simpleMessage('您沒有收藏的文章'),
    ...
    'noFundsDetected' : MessageLookupByLibrary.simpleMessage('當前無資產 - 請儲存資產。'),
    'noInternet' : MessageLookupByLibrary.simpleMessage('無法連上網路'),
    'noOrder' : m3,
    'noOrderAvailable' : MessageLookupByLibrary.simpleMessage('點擊建立訂單'),
    'noRewardYet' : MessageLookupByLibrary.simpleMessage('沒有獎勵可領取 - 請一個小時後重試。'),
    ...
    'notEnoughtBalanceForFee' : MessageLookupByLibrary.simpleMessage('餘額不足以支付手續費 - 請調整交易數量。'),
    'numberAssets' : m4,
    ...
    'recommendSeedMessage' : MessageLookupByLibrary.simpleMessage('我們強烈建議離線保管。'),
    ...
    'settingDialogSpan5' : MessageLookupByLibrary.simpleMessage(' 以便將來恢復錢包。'),
    ...
    'welcomeInfo' : MessageLookupByLibrary.simpleMessage('ATOMIC DEX 是次世代多幣別錢包, 具有原生第三代的DEX功能等等。'),
