...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName}, hem Android hem de iPhone\'da mobil cihazlar için ve <a href=\"https://piratechain.com/\">Windows, Mac ve Linux işletim sistemlerinde</a> masaüstü için kullanılabilir.";
  ...
  static m15(appName) =>
      "Kesinlikle! Daha fazla ayrıntı için <a href=\"https://piratechain.com/faq/\">geliştirici belgelerimizi</a> okuyabilir veya ortaklık sorularınız için bizimle iletişime geçebilirsiniz. Belirli bir teknik sorunuz mu var? ${appName} geliştirici topluluğu her zaman yardıma hazır!";
