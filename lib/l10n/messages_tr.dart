...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(index) => "${index}. kelimeyi girin.";

  static m2(index) => "Gizli kelimelerinizin ${index}. kelimesi nedir?";
  ...
  static m16(appName) =>
      "Son Kullanıcı Lisans Anlaşması (EULA), atomicDEX mobil:\n\n";

  static m17(coinName) =>
      "Uygun bir ${coinName} emri bulunmuyor - bir emir girmeyi deneyin veya daha sonra yeniden kontrol edin.";

  static m18(assets) => "${assets} Varlıklar";

  static m19(amount) => "${amount} adet emri görmek için tıklayın";

  static m20(coinName, address) => "${coinName} adresim: \n${address}";

  static m21(appName) =>
      "AtomicDEX mobil yerleşik üçüncü nesil DEX işlevselliği ve daha fazla özellikleri ile yeni nesil bir çoklu-kriptopara cüzdanıdır.";

  static m22(amount, coinName) => "${amount} adet ${coinName} ÇEK";

  static m23(amount, coin) => "${amount} adet ${coin} alacaksınız";
