...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m13(batteryLevelLow) => "Telefonunuzun bataryası %${batteryLevelLow}\'den daha az. Lütfen telefonunuzu şarj ediniz.";

  static m14(seconde) => "Emir eşleşmesi devam ediyor, lütfen ${seconde} saniye kadar bekleyiniz.";

  static m15(index) => "${index} kelimesini giriniz.";

  static m16(index) => "Gizli kelimeleriniz arasından ${index} olanı hangisidir ?";
  ...
  static m20(gas) => "Yeteri kadar gaz ücreti yok, en az ${gas} Gwei gerekli";
  ...
  static m35(coin) => "${coin} musluğuna talep gönderiliyor..";

  static m36(appCompanyShort) => "${appCompanyShort} haberleri";

  static m37(coin) => "${coin} gideri";

  static m38(coin) => "Lütfen ${coin} koinini aktifleştirin.";

  static m39(abbr) => "${abbr} bakiyesi, alım satım işlem ücretlerini karşılamaya yetmiyor.";

  static m40(coinAbbr) => "${coinAbbr} mevcut değil :(";

  static m41(coinName, number) => "${coinName} için yapılabilecek en düşük satış hacmi: ${number}";

  static m42(coinName, number) => "${coinName} için yapılabilecek en düşük alım hacmi: ${number}";

  static m43(buyCoin, buyAmount, sellCoin, sellAmount) => "En düşük emir için: ${buyCoin} ${buyAmount}\n(${sellCoin} ${sellAmount})";

  static m44(coinName, number) => "${coinName} için en düşük satım miktarı: ${number}";

  static m45(minValue, coin) => "${minValue} ${coin}\'den büyük olmalı";

  static m46(appName) => "Lütfen artık hücresel veri kullandığınızı ve ${appName} P2P ağına katılımınızın internet trafiğini tükettiğini unutmayın. Hücresel veri planınız maliyetliyse bir WiFi ağı kullanmak daha iyidir.";

  static m47(coin) => "Önce ${coin}\'i etkinleştirin ve bakiyeyi tamamlayın";

  static m48(number) => "${number} Sipariş oluştur:";

  static m49(coin) => "${coin} bakiyesi yetersiz";

  static m50(coin, fee) => "İşlem masrafını ödemeye yetecek ${coin} yok. En az ${fee} ${coin} olmalı.";

  static m51(coinName) => "Uygun bir ${coinName} emri bulunmuyor - bir emir girmeyi deneyin veya daha sonra yeniden kontrol edin.";

  static m52(coin) => "İşlem için yeteri kadar ${coin} yok !";

  static m53(sell, buy) => "${sell}/${buy} takası başarıyla tamamlandı";

  static m54(sell, buy) => "${sell}/${buy} takası başarısız oldu";

  static m55(sell, buy) => "${sell}/${buy} takası başladı";

  static m56(sell, buy) => "${sell}/${buy} takas zaman aşımına uğradı";

  static m57(coin) => "${coin} işlemi aldınız!";

  static m58(assets) => "${assets} Varlıklar";

  static m59(coin) => "Tüm ${coin} emirleri iptal edilecek";

  static m60(delta) => "Ucuz: CEX + %${delta}";

  static m61(delta) => "Pahalı: CEX + %${delta}";

  static m62(fill) => "${fill}% tamamlandı";

  static m63(coin) => "(${coin}) miktarı";

  static m64(coin) => "(${coin}) fiyatı";

  static m65(coin) => "Toplam (${coin})";

  static m66(abbr) => "${abbr} aktif değil. Lütfen aktifleştirip öyle deneyiniz.";
  ...
  static m71(appName) => "${appName} üzerinde kendi beyaz etiketli değişimimi geliştirmem mümkün mü?";

  static m72(amount) => "Başarılı ! ${amount} KMD geldi.";

  static m73(dd) => "${dd} gün";

  static m74(hh, minutes) => "${hh}sa ${minutes}dk";

  static m75(mm) => "${mm}dk";

  static m76(amount) => "${amount} adet emri görmek için tıklayın";

  static m77(coinName, address) => "${coinName} adresim:\n${address}";

  static m78(coin) => "Lütfen alınacak ${coin} adetini girin";

  static m79(maxCoins) => "Maksimum aktif jeton sayısı ${maxCoins}\'dir. Lütfen bazılarını devre dışı bırakın.";

  static m80(coin) => "${coin} koini aktif değil !";

  static m81(coin) => "Lütfen satmak için ${coin} miktarı girin";

  static m82(coin) => "${coin} aktifleştirilemedi";

  static m83(description) => "Lütfen bir mp3 ya da waw dosyası seçin. ${description}\'de ses dosyalarını oynatacağız.";

  static m84(description) => "${description}\'de oynatıldı.";

  static m85(appName) => "Herhangi bir sorunuz varsa veyahut ${appName} uygulamasıyla ile ilgili teknik bir hata bulduğunuzu düşünüyorsanız bunu ekibimize bildirebilir ve destek alabilirsiniz.";

  static m86(coin) => "Lütfen önce ${coin} ve kontör bakiyesini etkinleştirin";

  static m87(coin) => "${coin} bakiyesi, işlem ücretlerini karşılayamayacak kadar düşük.";

  static m88(coin, amount) => "${coin} bakiyesi, işlem ücretlerini karşılayamayacak kadar düşük. ${amount} ${coin} gerekli.";

  static m89(left) => "Kalan işlem: ${left}";

  static m90(amnt, hash) => "${amnt} fonun kilidi başarıyla kaldırıldı - TX: ${hash}";

  static m91(version) => "${version} sürümünü kullanmaktasınız.";

  static m92(version) => "Güncel ${version} sürümü mevcut. Lütfen güncelleyiniz.";

  static m93(appName) => "AtomicDEX güncellemeleri";

  static m94(coinAbbr) => "${coinAbbr} koinini etkinleştiremedik.";

  static m95(coinAbbr) => "${coinAbbr} koinini etkinleştiremedik.\nLütfen uygulamayı yeniden başlatıp tekrar deneyiniz.";
  ...
  static m99(amount, coin) => "${amount} adet ${coin} alacaksınız";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "traditionalChinese" : MessageLookupByLibrary.simpleMessage("Geleneksel Çince"),
