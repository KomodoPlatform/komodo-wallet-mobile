...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(index) => "Írja be a  ${index}. szót";

  static m2(index) => "Mi a ${index}. szó a SEED-ben?";
  ...
  static m18(assets) => "${assets} Aktív";

  static m19(amount) => "Kattintson a megtekintéshez ${amount} rendelések";

  static m20(coinName, address) => "Az én ${coinName} címem: \n${address}";

  static m21(appName) =>
      "AtomicDEX mobil egy következő generációs többérmés pénztárca natív harmadik generációs DEX funkcióval és még sokkal több";

  static m22(amount, coinName) => "KIUTAL ${amount} ${coinName}";

  static m23(amount, coin) => "Kapni fog ${amount} ${coin}";
