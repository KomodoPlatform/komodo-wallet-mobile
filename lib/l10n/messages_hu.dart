...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m9(appName) =>
      "Más DEX-ek általában csak olyan eszközökkel lehet kereskedni, amelyek egyetlen blokklánc-hálózaton alapulnak, proxy tokeneket használnak, és csak egyetlen megbízás leadását teszik lehetővé ugyanazokkal az eszközökkel.\n\nAz ${appName} lehetővé teszi, hogy natívan, proxy tokenek nélkül kereskedhessen két különböző blokklánc hálózaton. Több megbízást is adhat ugyanazokkal az alapokkal. Például 0,1 BTC-t adhatsz el FIRO, QTUM vagy VRSC ellenében - az első teljesített megbízás automatikusan törli az összes többi megbízást.";
  ...
  static m15(appName) =>
      "Teljesen! További részletekért olvassa el <a href=\"https://firo.org/\">fejlesztői dokumentációnkat</a>, vagy forduljon hozzánk partnerségi kérdéseivel. Konkrét technikai kérdése van? A ${appName} fejlesztői közössége mindig készen áll a segítségére!";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "rebrandingAnnouncement": MessageLookupByLibrary.simpleMessage(
            "Ez egy új korszak! Hivatalosan megváltoztattuk a nevünket „AtomicDEX”-ről „Firo Wallet”-ra"),
