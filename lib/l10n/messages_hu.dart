...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m4(appName) =>
      "Az ${appName} elérhető mobilra Android és iPhone operációs rendszereken, valamint asztali számítógépre Windows, Mac és Linux operációs rendszereken.";
  ...
  static m11(appName) =>
      "Abszolút! További részletekért olvassa el <a href=\"https://developers.atomicdex.io/\">fejlesztői dokumentációnkat</a>, vagy vegye fel velünk a kapcsolatot partnerségi kérdéseivel. Konkrét technikai kérdése van? Az ${appName} fejlesztői közösség mindig készen áll a segítségre!";
