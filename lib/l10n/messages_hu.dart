...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(name) => "${name} sikeresen aktiválva !";

  static m1(title) => "Csak a ${title} címekkel rendelkező kapcsolatok megjelenítése";

  static m2(abbr) => "Nem tud pénzt küldeni a ${abbr} címre, mert a ${abbr} nincs aktiválva. Kérjük, menjen a portfólióhoz.";

  static m3(appName) => "Nem! Az ${appName} nem felügyeleti joggal rendelkezik. Soha nem tárolunk semmilyen érzékeny adatot, beleértve az Ön privát kulcsait, magvas kifejezéseit vagy PIN-kódját. Ezeket az adatokat csak a felhasználó készülékén tároljuk, és soha nem hagyják el azt. Ön teljes mértékben ura az eszközeinek.";

  static m4(appName) => "Az ${appName} elérhető mobilra Android és iPhone operációs rendszereken, valamint asztali számítógépre Windows, Mac és Linux operációs rendszereken.";

  static m5(appName) => "Más DEX-ek általában csak olyan eszközökkel lehet kereskedni, amelyek egyetlen blokklánc-hálózaton alapulnak, proxy tokeneket használnak, és csak egyetlen megbízás leadását teszik lehetővé ugyanazokkal az eszközökkel.\n\nAz ${appName} lehetővé teszi, hogy natívan, proxy tokenek nélkül kereskedhessen két különböző blokklánc hálózaton. Több megbízást is adhat ugyanazokkal az alapokkal. Például 0,1 BTC-t adhatsz el KMD, QTUM vagy VRSC ellenében - az első teljesített megbízás automatikusan törli az összes többi megbízást.";

  static m6(appName) => "Az egyes swapok feldolgozási idejét több tényező határozza meg. A kereskedett eszközök blokkolási ideje az egyes hálózatoktól függ (a Bitcoin jellemzően a leglassabb) Ezen kívül a felhasználó testre szabhatja a biztonsági beállításokat. Például kérheti az ${appName}-t, hogy egy KMD tranzakciót már 3 megerősítés után véglegesnek tekintsen, ami rövidebbé teszi a csereidőt, mintha <a href=\"https://komodoplatform.com/security-delayed-proof-of-work-dpow/\">jegyesítésre</a> kellene várni.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "Can\'t play that" : MessageLookupByLibrary.simpleMessage("Ezt nem lehet lejátszani"),
    "Failed" : MessageLookupByLibrary.simpleMessage("Sikertelen"),
    "Maker" : MessageLookupByLibrary.simpleMessage("Készítő"),
    "Play at full volume" : MessageLookupByLibrary.simpleMessage("Játssz teljes hangerőn"),
    "Sound" : MessageLookupByLibrary.simpleMessage("Hang"),
    "Taker" : MessageLookupByLibrary.simpleMessage("Átvevő"),
    "a swap fails" : MessageLookupByLibrary.simpleMessage("a csere meghiúsul"),
    "a swap runs to completion" : MessageLookupByLibrary.simpleMessage("a csere befejeződik"),
    "accepteula" : MessageLookupByLibrary.simpleMessage("Fogadja el az EULA-t"),
    "accepttac" : MessageLookupByLibrary.simpleMessage("Fogadja el a feltételeket és a kondíciókat"),
    "activateAccessBiometric" : MessageLookupByLibrary.simpleMessage("Biometrikus védelem aktiválása"),
    "activateAccessPin" : MessageLookupByLibrary.simpleMessage("PIN védelem aktviálása"),
    ...
    "addressBookEmpty" : MessageLookupByLibrary.simpleMessage("A címjegyzék üres"),
    "addressBookFilter" : m1,
    "addressBookTitle" : MessageLookupByLibrary.simpleMessage("Címjegyzék"),
    "addressCoinInactive" : m2,
    "addressNotFound" : MessageLookupByLibrary.simpleMessage("Semmi sem található"),
    "addressSelectCoin" : MessageLookupByLibrary.simpleMessage("Válassza ki az érmét"),
    ...
    "allowCustomSeed" : MessageLookupByLibrary.simpleMessage("Egyedi SEED engedélyezése"),
    ...
    "automaticRedirected" : MessageLookupByLibrary.simpleMessage("Az újbóli aktiválási folyamat befejeztével automatikusan átirányítjuk a portfólió oldalra."),
    ...
    "batterySavingWarning" : MessageLookupByLibrary.simpleMessage("A telefon akkumulátor-takarékos üzemmódban van. Kérjük, kapcsolja ki ezt az üzemmódot, vagy NE tegye az alkalmazást a háttérbe, különben az alkalmazást az operációs rendszer megölheti, és a csere sikertelen lesz."),
    "bestAvailableRate" : MessageLookupByLibrary.simpleMessage("A rendelkezésrre álló legjobb ár"),
    "builtKomodo" : MessageLookupByLibrary.simpleMessage("Komodo rendszerrel fejlesztve"),
    "builtOnKmd" : MessageLookupByLibrary.simpleMessage("Komodo rendszerrel fejlesztve"),
    "buy" : MessageLookupByLibrary.simpleMessage("Vétel"),
    "buyOrderType" : MessageLookupByLibrary.simpleMessage("Átalakítás vevővé, ha nem egyezik"),
    "buySuccessWaiting" : MessageLookupByLibrary.simpleMessage("Csere kiadva, kérjük várjon!"),
    "buySuccessWaitingError" : m13,
    "buyTestCoinWarning" : MessageLookupByLibrary.simpleMessage("Figyelmeztetés, Ön hajlandó teszt érméket vásárolni NÉLKÜL valós értéket!"),
    "camoPinBioProtectionConflict" : MessageLookupByLibrary.simpleMessage("Az álcázó PIN és a Bio védelem nem engedélyezhető egyszerre."),
    "camoPinBioProtectionConflictTitle" : MessageLookupByLibrary.simpleMessage("Az álcázó PIN és a bio védelem konfliktusban van egymással."),
    "camoPinChange" : MessageLookupByLibrary.simpleMessage("Álcázó PIN megváltoztatása"),
    "camoPinCreate" : MessageLookupByLibrary.simpleMessage("Álcázó PIN létrehozása"),
    "camoPinDesc" : MessageLookupByLibrary.simpleMessage("Ha az álcázó PIN kóddal nyitod fel az alkalmazást, egy hamis alacsony egyenleg fog megjelenni, és az álzácási PIN konfigurációs opció NEM lesz látható a beállításokban."),
    "camoPinInvalid" : MessageLookupByLibrary.simpleMessage("Érvénytelen álcázási PIN-kód"),
    "camoPinLink" : MessageLookupByLibrary.simpleMessage("Álcázó PIN-kód"),
    "camoPinNotFound" : MessageLookupByLibrary.simpleMessage("Az álcázási PIN-kód nem található"),
    "camoPinOff" : MessageLookupByLibrary.simpleMessage("Off"),
    "camoPinOn" : MessageLookupByLibrary.simpleMessage("Be"),
    "camoPinSaved" : MessageLookupByLibrary.simpleMessage("Álcázási PIN mentve"),
    "camoPinTitle" : MessageLookupByLibrary.simpleMessage("Álcázó PIN-kód"),
    "camoSetupSubtitle" : MessageLookupByLibrary.simpleMessage("Új álcázási PIN megadása"),
    "camoSetupTitle" : MessageLookupByLibrary.simpleMessage("Álcázási PIN beállítása"),
    "camouflageSetup" : MessageLookupByLibrary.simpleMessage("Álcázási PIN beállítása"),
    "cancel" : MessageLookupByLibrary.simpleMessage("visszamond"),
    "cancelButton" : MessageLookupByLibrary.simpleMessage("Visszavonás"),
    "cancelOrder" : MessageLookupByLibrary.simpleMessage("Megrendelés visszavonása"),
    "candleChartError" : MessageLookupByLibrary.simpleMessage("Valami rosszul sült el. Próbálja meg később újra."),
    "cantDeleteDefaultCoinOk" : MessageLookupByLibrary.simpleMessage("Ok"),
    "cantDeleteDefaultCoinSpan" : MessageLookupByLibrary.simpleMessage("egy alapértelmezett érme. Az alapértelmezett érméket nem lehet letiltani."),
    "cantDeleteDefaultCoinTitle" : MessageLookupByLibrary.simpleMessage("Nem lehet letiltani"),
    ...
    "cexDataDesc" : MessageLookupByLibrary.simpleMessage("Az ezzel az ikonnal jelölt piaci adatok (árak, grafikonok stb.) harmadik féltől származó forrásokból származnak (<a href=\"https://www.coingecko.com/\">coingecko.com</a>, <a href=\"https://openrates.io/\">openrates.io</a>)."),
    "changePin" : MessageLookupByLibrary.simpleMessage("PIN módosítása"),
    "checkForUpdates" : MessageLookupByLibrary.simpleMessage("Frissítések ellenőrzése"),
    "checkOut" : MessageLookupByLibrary.simpleMessage("Kifizetés"),
    "checkSeedPhrase" : MessageLookupByLibrary.simpleMessage("ellenőrizze a SEED-jét"),
    "checkSeedPhraseButton1" : MessageLookupByLibrary.simpleMessage("FOLYTATÁS"),
    "checkSeedPhraseButton2" : MessageLookupByLibrary.simpleMessage("Lépjen vissza és ellenőrizze ismét"),
    "checkSeedPhraseHint" : m14,
    "checkSeedPhraseInfo" : MessageLookupByLibrary.simpleMessage("A SEED-ed fontos - ezért szeretnénk ellenőrizni, hogy helyes-e. Három különféle kérdést fogunk feltenni a SEED-el kapcsolatban, hogy megbizonyosodjon arról, hogy bármikor könnyedén visszaállíthatja a pénztárcáját."),
    "checkSeedPhraseSubtile" : m15,
    "checkSeedPhraseTitle" : MessageLookupByLibrary.simpleMessage("DUPLÁN ellenőrizze a SEED-jét"),
    "chineseLanguage" : MessageLookupByLibrary.simpleMessage("Kínai"),
    "claim" : MessageLookupByLibrary.simpleMessage("Igényel"),
    "claimTitle" : MessageLookupByLibrary.simpleMessage("Igényelje meg KMD jutalmát?"),
    "clickToSee" : MessageLookupByLibrary.simpleMessage("Kattintson a megtekintéshez"),
    "clipboard" : MessageLookupByLibrary.simpleMessage("Vágólapra másolva"),
    "clipboardCopy" : MessageLookupByLibrary.simpleMessage("Vágólapra másolva"),
    "close" : MessageLookupByLibrary.simpleMessage("Bezár"),
    "closeMessage" : MessageLookupByLibrary.simpleMessage("Hibaüzenet bezárása"),
    "closePreview" : MessageLookupByLibrary.simpleMessage("Előnézet bezárása"),
    "code" : MessageLookupByLibrary.simpleMessage("Kód:"),
    "coinSelectClear" : MessageLookupByLibrary.simpleMessage("Tiszta"),
    "coinSelectNotFound" : MessageLookupByLibrary.simpleMessage("Nincsenek aktív érmék"),
    "coinSelectTitle" : MessageLookupByLibrary.simpleMessage("Érme kiválasztása"),
    "comingSoon" : MessageLookupByLibrary.simpleMessage("Hamarosan..."),
    "commingsoon" : MessageLookupByLibrary.simpleMessage("Tranzakció részletek hamarosan!"),
    "commingsoonGeneral" : MessageLookupByLibrary.simpleMessage("A részletek hamarosan megjelennek!"),
    "commissionFee" : MessageLookupByLibrary.simpleMessage("Jutalék díj"),
    "comparedToCex" : MessageLookupByLibrary.simpleMessage("a CEX-hez képest"),
    "configureWallet" : MessageLookupByLibrary.simpleMessage("A pénztárca konfigurálása, kérjük várjon..."),
    "confirm" : MessageLookupByLibrary.simpleMessage("Megerősít"),
    "confirmCamouflageSetup" : MessageLookupByLibrary.simpleMessage("Álcázási PIN megerősítése"),
    "confirmCancel" : MessageLookupByLibrary.simpleMessage("Biztos, hogy törölni szeretné a rendelést"),
    "confirmPassword" : MessageLookupByLibrary.simpleMessage("Jelszó megerősítése"),
    "confirmPin" : MessageLookupByLibrary.simpleMessage("PIN kód megerősítése"),
    "confirmSeed" : MessageLookupByLibrary.simpleMessage("SEED megerősítése"),
    "confirmeula" : MessageLookupByLibrary.simpleMessage("Az alábbi gombokra kattintva megerősítheti, hogy elolvasta a „EULA” és a „Általános Szerződési Feltételeket”, és elfogadja ezeket"),
    ...
    "contactDelete" : MessageLookupByLibrary.simpleMessage("Kapcsolat törlése"),
    "contactDeleteBtn" : MessageLookupByLibrary.simpleMessage("törlése"),
    "contactDeleteWarning" : m16,
    ...
    "contactExitWarning" : MessageLookupByLibrary.simpleMessage("Elveti a módosításokat?"),
    "contactNotFound" : MessageLookupByLibrary.simpleMessage("Nem találtam kapcsolatot"),
    "contactSave" : MessageLookupByLibrary.simpleMessage("Mentés"),
    "contactTitle" : MessageLookupByLibrary.simpleMessage("Kapcsolattartási adatok"),
    "contactTitleName" : MessageLookupByLibrary.simpleMessage("Név"),
    "convert" : MessageLookupByLibrary.simpleMessage("Megváltoztatni"),
    "couldntImportError" : MessageLookupByLibrary.simpleMessage("Nem sikerült importálni:"),
    "create" : MessageLookupByLibrary.simpleMessage("Kereskedelem"),
    "createAWallet" : MessageLookupByLibrary.simpleMessage("PÉNZTÁRCA LÉTREHOZÁSA"),
    "createContact" : MessageLookupByLibrary.simpleMessage("Kapcsolat létrehozása"),
    "createPin" : MessageLookupByLibrary.simpleMessage("PIN kód létrehozása"),
    "currency" : MessageLookupByLibrary.simpleMessage("Pénznem"),
    "currencyDialogTitle" : MessageLookupByLibrary.simpleMessage("Pénznem"),
    "currentValue" : MessageLookupByLibrary.simpleMessage("Jelenlegi érték:"),
    "customFee" : MessageLookupByLibrary.simpleMessage("Egyedi díj"),
    "customFeeWarning" : MessageLookupByLibrary.simpleMessage("Csak akkor használjon egyéni díjakat, ha tudja, mit csinál!"),
    "customSeedWarning" : m17,
    "dPow" : MessageLookupByLibrary.simpleMessage("Komodo dPoW biztonság"),
    "date" : MessageLookupByLibrary.simpleMessage("Dátum"),
    "decryptingWallet" : MessageLookupByLibrary.simpleMessage("Pénztárca dekódolása"),
    "delete" : MessageLookupByLibrary.simpleMessage("Törlés"),
    "deleteConfirm" : MessageLookupByLibrary.simpleMessage("Hatályon kívül helyezés megerősítése"),
    "deleteSpan1" : MessageLookupByLibrary.simpleMessage("El akarja távolítani"),
    "deleteSpan2" : MessageLookupByLibrary.simpleMessage("a portfóliójából? Minden nem egyező megbízás törlésre kerül."),
    "deleteWallet" : MessageLookupByLibrary.simpleMessage("Pénztárca törlése"),
    "deletingWallet" : MessageLookupByLibrary.simpleMessage("Pénztárca törlése..."),
    ...
    "dexIsNotAvailable" : MessageLookupByLibrary.simpleMessage("DEX nem elérhető ehhez az érméhez"),
    "disclaimerAndTos" : MessageLookupByLibrary.simpleMessage("Felelősségi nyilatkozat & használati feltételek"),
    "done" : MessageLookupByLibrary.simpleMessage("Kész"),
    "dontAskAgain" : MessageLookupByLibrary.simpleMessage("Ne kérdezze újra"),
    "dontWantPassword" : MessageLookupByLibrary.simpleMessage("Nem akarok jelszót"),
    "duration" : MessageLookupByLibrary.simpleMessage("Időtartam"),
    "editContact" : MessageLookupByLibrary.simpleMessage("Kapcsolat szerkesztése"),
    "emptyCoin" : m18,
    "emptyExportPass" : MessageLookupByLibrary.simpleMessage("A titkosítási jelszó nem lehet üres"),
    "emptyImportPass" : MessageLookupByLibrary.simpleMessage("A jelszó nem lehet üres"),
    "emptyName" : MessageLookupByLibrary.simpleMessage("Kapcsolattartó neve nem lehet üres"),
    "emptyWallet" : MessageLookupByLibrary.simpleMessage("A tárca neve nem lehet üres"),
    "enableTestCoins" : MessageLookupByLibrary.simpleMessage("Tesztérmék engedélyezése"),
    "enablingTooManyAssetsSpan1" : MessageLookupByLibrary.simpleMessage("Ön rendelkezik"),
    "enablingTooManyAssetsSpan2" : MessageLookupByLibrary.simpleMessage("eszközök engedélyezve, és megpróbálja engedélyezni"),
    "enablingTooManyAssetsSpan3" : MessageLookupByLibrary.simpleMessage("többet. Az engedélyezett eszközök maximális korlátja"),
    "enablingTooManyAssetsSpan4" : MessageLookupByLibrary.simpleMessage(". Kérjük, tiltson le néhányat, mielőtt újakat adna hozzá."),
    "enablingTooManyAssetsTitle" : MessageLookupByLibrary.simpleMessage("Túl sok eszközt próbál engedélyezni"),
    "encryptingWallet" : MessageLookupByLibrary.simpleMessage("Pénztárca titkosítása"),
    "englishLanguage" : MessageLookupByLibrary.simpleMessage("Angol"),
    "enter" : MessageLookupByLibrary.simpleMessage("Mentés"),
    "enterNewPinCode" : MessageLookupByLibrary.simpleMessage("Adja meg új PIN-kódját"),
    "enterOldPinCode" : MessageLookupByLibrary.simpleMessage("Adja meg régi PIN kódját"),
    "enterPinCode" : MessageLookupByLibrary.simpleMessage("Adja meg a PIN kódját"),
    "enterSeedPhrase" : MessageLookupByLibrary.simpleMessage("Adja meg a Seed-jét"),
    "enterSellAmount" : MessageLookupByLibrary.simpleMessage("Először az Eladási összeget kell megadnia"),
    "enterpassword" : MessageLookupByLibrary.simpleMessage("Kérjük, írja be a jelszavát a folytatáshoz."),
    "errorAmountBalance" : MessageLookupByLibrary.simpleMessage("Nincs elég egyenleg"),
    "errorNotAValidAddress" : MessageLookupByLibrary.simpleMessage("Hiba! Helytelen / nem valós cím!"),
    "errorNotAValidAddressSegWit" : MessageLookupByLibrary.simpleMessage("A Segwit címek (még) nem támogatottak"),
    "errorNotEnoughGas" : m19,
    "errorTryAgain" : MessageLookupByLibrary.simpleMessage("Hiba, kérem próbálja újra"),
    "errorTryLater" : MessageLookupByLibrary.simpleMessage("Hiba, kérjük próbálja újra"),
    "errorValueEmpty" : MessageLookupByLibrary.simpleMessage("Az érték túl magas vagy alacsony"),
    "errorValueNotEmpty" : MessageLookupByLibrary.simpleMessage("Kérjük adjon meg adatokat"),
    "estimateValue" : MessageLookupByLibrary.simpleMessage("Becsült Teljes Érték"),
    "eulaParagraphe1" : m20,
    "eulaParagraphe10" : m21,
    "eulaParagraphe11" : m22,
    ...
    "eulaParagraphe13" : m23,
    "eulaParagraphe14" : m24,
    "eulaParagraphe15" : m25,
    "eulaParagraphe16" : m26,
    "eulaParagraphe17" : m27,
    "eulaParagraphe18" : m28,
    "eulaParagraphe19" : m29,
    "eulaParagraphe2" : m30,
    ...
    "exampleHintSeed" : MessageLookupByLibrary.simpleMessage("Például: build case level ..."),
    ...
    "exchangeIdentical" : MessageLookupByLibrary.simpleMessage("Azonos a CEX-szel"),
    ...
    "exportContactsTitle" : MessageLookupByLibrary.simpleMessage("Kapcsolatok"),
    "exportDesc" : MessageLookupByLibrary.simpleMessage("Kérjük, válassza ki a titkosított fájlba exportálandó elemeket."),
    ...
    "exportSuccessTitle" : MessageLookupByLibrary.simpleMessage("A tételek exportálása sikeresen megtörtént:"),
    "exportSwapsTitle" : MessageLookupByLibrary.simpleMessage("Cserék"),
    "exportTitle" : MessageLookupByLibrary.simpleMessage("Exportálás"),
    "fakeBalanceAmt" : MessageLookupByLibrary.simpleMessage("Hamis egyenleg összege:"),
    "faqTitle" : MessageLookupByLibrary.simpleMessage("Gyakran ismételt kérdések"),
    "faucetError" : MessageLookupByLibrary.simpleMessage("Hiba"),
    "faucetInProgress" : m34,
    "faucetName" : MessageLookupByLibrary.simpleMessage("FAUCET"),
    "faucetSuccess" : MessageLookupByLibrary.simpleMessage("Siker"),
    "faucetTimedOut" : MessageLookupByLibrary.simpleMessage("A kérés lejárt"),
    ...
    "feedUnableToProceed" : MessageLookupByLibrary.simpleMessage("Nem folytatható a hírfrissítés"),
    "feedUnableToUpdate" : MessageLookupByLibrary.simpleMessage("Nem lehetséges a hírfrissítés"),
    "feedUpToDate" : MessageLookupByLibrary.simpleMessage("Már naprakész"),
    "feedUpdated" : MessageLookupByLibrary.simpleMessage("Hírfolyam frissítve"),
    "feedback" : MessageLookupByLibrary.simpleMessage("Visszajelzés küldése"),
    "filtersAll" : MessageLookupByLibrary.simpleMessage("Minden"),
    "filtersButton" : MessageLookupByLibrary.simpleMessage("Szűrő"),
    "filtersClearAll" : MessageLookupByLibrary.simpleMessage("Összes szűrő törlése"),
    ...
    "filtersReceive" : MessageLookupByLibrary.simpleMessage("Érmét kapott érme"),
    ...
    "generalPinNotActive" : MessageLookupByLibrary.simpleMessage("Az általános PIN-védelem nem aktív.\n Az álcázási mód nem lesz elérhető.\n Kérjük, aktiválja a PIN-védelmet."),
    "getBackupPhrase" : MessageLookupByLibrary.simpleMessage("Fontos: Mentse el a SEED-jét mielött tovább haladnánk!"),
    "goToPorfolio" : MessageLookupByLibrary.simpleMessage("Ugrás a portfólióhoz"),
    "helpLink" : MessageLookupByLibrary.simpleMessage("Segítség"),
    "helpTitle" : MessageLookupByLibrary.simpleMessage("Segítség és támogatás"),
    "hideBalance" : MessageLookupByLibrary.simpleMessage("Egyenlegek elrejtése"),
    "hintConfirmPassword" : MessageLookupByLibrary.simpleMessage("Jelszó megerősítése"),
    "hintCreatePassword" : MessageLookupByLibrary.simpleMessage("Jelszó létrehozása"),
    "hintCurrentPassword" : MessageLookupByLibrary.simpleMessage("Jelenlegi jelszó"),
    "hintEnterPassword" : MessageLookupByLibrary.simpleMessage("Írja be a jelszavát"),
    "hintEnterSeedPhrase" : MessageLookupByLibrary.simpleMessage("Írja be a SEED-jét"),
    "hintNameYourWallet" : MessageLookupByLibrary.simpleMessage("Pénztárcád neve"),
    ...
    "importDecryptError" : MessageLookupByLibrary.simpleMessage("Érvénytelen jelszó vagy sérült adatok"),
    "importDesc" : MessageLookupByLibrary.simpleMessage("Importálandó tételek:"),
    "importFileNotFound" : MessageLookupByLibrary.simpleMessage("Fájl nem található"),
    "importInvalidSwapData" : MessageLookupByLibrary.simpleMessage("Érvénytelen csereadatok. Kérjük, adjon meg egy érvényes swap-státusz JSON fájlt."),
    "importLink" : MessageLookupByLibrary.simpleMessage("Importálás"),
    "importLoadDesc" : MessageLookupByLibrary.simpleMessage("Kérjük, válasszon titkosított fájlt az importáláshoz."),
    "importLoadSwapDesc" : MessageLookupByLibrary.simpleMessage("Kérjük, válasszon egyszerű szöveges swapfájlt az importáláshoz."),
    ...
    "importSingleSwapLink" : MessageLookupByLibrary.simpleMessage("Egyetlen swap importálása"),
    "importSingleSwapTitle" : MessageLookupByLibrary.simpleMessage("Swap importálása"),
    "importSomeItemsSkippedWarning" : MessageLookupByLibrary.simpleMessage("Néhány elemet kihagytunk"),
    "importSuccessTitle" : MessageLookupByLibrary.simpleMessage("A tételek importálása sikeresen megtörtént:"),
    "importSwapFailed" : MessageLookupByLibrary.simpleMessage("Nem sikerült a swap importálása"),
    "importSwapJsonDecodingError" : MessageLookupByLibrary.simpleMessage("Hiba a json fájl dekódolásában"),
    "importTitle" : MessageLookupByLibrary.simpleMessage("Importálás"),
    "infoPasswordDialog" : MessageLookupByLibrary.simpleMessage("Ha nem ad meg jelszót, akkor minden alkalommal be kell írnia a SEED-jét, amikor hozzáférni szeretne a pénztárcájához."),
    "infoTrade1" : MessageLookupByLibrary.simpleMessage("A megkezdett cserét visszavonni nem lehet, ez végleges!"),
    "infoTrade2" : MessageLookupByLibrary.simpleMessage("Ez a tranzakció akár 10 percet is igénybe vehet - NE zárja be ezt az alkalmazást!"),
    "infoWalletPassword" : MessageLookupByLibrary.simpleMessage("Dönthet úgy is, hogy jelszóval titkosítja a pénztárcáját. Ha úgy dönt, hogy nem használ jelszót, akkor minden alkalommal meg kell adnia a SEED-jét, amikor hozzáférni szeretne a pénztárcájához."),
    "insufficientBalanceToPay" : m38,
    "insufficientText" : MessageLookupByLibrary.simpleMessage("A megbízáshoz szükséges minimális mennyiség"),
    "insufficientTitle" : MessageLookupByLibrary.simpleMessage("Elégtelen mennyiség"),
    "internetRefreshButton" : MessageLookupByLibrary.simpleMessage("Frissítés"),
    "internetRestored" : MessageLookupByLibrary.simpleMessage("Internet kapcsolat helyreállt"),
    "invalidSwap" : MessageLookupByLibrary.simpleMessage("Nem lehet folytatni a swapot"),
    "invalidSwapDetailsLink" : MessageLookupByLibrary.simpleMessage("Részletek"),
    "isUnavailable" : m39,
    ...
    "latestTxs" : MessageLookupByLibrary.simpleMessage("Legutóbbi tranzakciók"),
    ...
    "loadingOrderbook" : MessageLookupByLibrary.simpleMessage("Rendelési könyv betöltése..."),
    "lockScreen" : MessageLookupByLibrary.simpleMessage("Képernyő lezárva"),
    "lockScreenAuth" : MessageLookupByLibrary.simpleMessage("Kérjük hitelesítse!"),
    "login" : MessageLookupByLibrary.simpleMessage("belépés"),
    "logout" : MessageLookupByLibrary.simpleMessage("Kijelentkezés"),
    "logoutOnExit" : MessageLookupByLibrary.simpleMessage("Kijelentkezés kilépéskor"),
    "logoutWarning" : MessageLookupByLibrary.simpleMessage("Biztos, hogy most már ki akarsz jelentkezni?"),
    "logoutsettings" : MessageLookupByLibrary.simpleMessage("Kijelentkezés beállításai"),
    "longMinutes" : MessageLookupByLibrary.simpleMessage("percek"),
    "makeAorder" : MessageLookupByLibrary.simpleMessage("Rendelés készítése"),
    "makerDetailsCancel" : MessageLookupByLibrary.simpleMessage("Megrendelés törlése"),
    "makerDetailsCreated" : MessageLookupByLibrary.simpleMessage("Létrehozva"),
    "makerDetailsFor" : MessageLookupByLibrary.simpleMessage("Megkapja"),
    "makerDetailsId" : MessageLookupByLibrary.simpleMessage("Megrendelés azonosítója"),
    "makerDetailsNoSwaps" : MessageLookupByLibrary.simpleMessage("Ez a megbízás nem indított swapot"),
    "makerDetailsPrice" : MessageLookupByLibrary.simpleMessage("Ár"),
    "makerDetailsSell" : MessageLookupByLibrary.simpleMessage("Eladni"),
    "makerDetailsSwaps" : MessageLookupByLibrary.simpleMessage("A megbízás által indított swapok"),
    "makerDetailsTitle" : MessageLookupByLibrary.simpleMessage("Maker megbízás részletei"),
    ...
    "marketsNoAsks" : MessageLookupByLibrary.simpleMessage("Nem találtunk kéréseket"),
    "marketsNoBids" : MessageLookupByLibrary.simpleMessage("Nem találtak ajánlatot"),
    "marketsOrderDetails" : MessageLookupByLibrary.simpleMessage("Megrendelés részletei"),
    "marketsOrderbook" : MessageLookupByLibrary.simpleMessage("MEGRENDELÉS KÖNYV"),
    "marketsPrice" : MessageLookupByLibrary.simpleMessage("ÁRA"),
    "marketsSelectCoins" : MessageLookupByLibrary.simpleMessage("Kérjük, válasszon érméket"),
    "marketsTab" : MessageLookupByLibrary.simpleMessage("Piacok"),
    "marketsTitle" : MessageLookupByLibrary.simpleMessage("MARKETS"),
    "matchExportPass" : MessageLookupByLibrary.simpleMessage("A jelszavaknak meg kell egyezniük"),
    "matchingCamoChange" : MessageLookupByLibrary.simpleMessage("Váltás"),
    "matchingCamoPinError" : MessageLookupByLibrary.simpleMessage("Az általános PIN-kód és az álcázó PIN-kód ugyanaz.\n Az álcázó üzemmód nem lesz elérhető.\n Kérjük, változtassa meg a álcázó PIN-kódot."),
    "matchingCamoTitle" : MessageLookupByLibrary.simpleMessage("Érvénytelen PIN-kód"),
    "max" : MessageLookupByLibrary.simpleMessage("MAX"),
    "maxOrder" : MessageLookupByLibrary.simpleMessage("Maximális rendelési mennyiség:"),
    "media" : MessageLookupByLibrary.simpleMessage("Hírek"),
    "mediaBrowse" : MessageLookupByLibrary.simpleMessage("BÖNGÉSZÉS"),
    "mediaBrowseFeed" : MessageLookupByLibrary.simpleMessage("BÖNGÉSZŐ FEED"),
    "mediaBy" : MessageLookupByLibrary.simpleMessage("Által"),
    "mediaNotSavedDescription" : MessageLookupByLibrary.simpleMessage("Nincsenek mentett cikkeid"),
    ...
    "minValueSell" : m42,
    "minVolumeInput" : m43,
    "minVolumeIsTDH" : MessageLookupByLibrary.simpleMessage("Alacsonyabbnak kell lennie, mint az eladási összeg"),
    "minVolumeTitle" : MessageLookupByLibrary.simpleMessage("Minimális mennyiség szükséges"),
    "minVolumeToggle" : MessageLookupByLibrary.simpleMessage("Egyéni minimális mennyiség használata"),
    "minutes" : MessageLookupByLibrary.simpleMessage("m"),
    "mobileDataWarning" : m44,
    "moreTab" : MessageLookupByLibrary.simpleMessage("További"),
    "multiActivateGas" : m45,
    "multiBaseAmtPlaceholder" : MessageLookupByLibrary.simpleMessage("Összeg"),
    ...
    "multiConfirmConfirm" : MessageLookupByLibrary.simpleMessage("Megerősítés"),
    "multiConfirmTitle" : m46,
    ...
    "multiCreateOrders" : MessageLookupByLibrary.simpleMessage("Megrendelések"),
    "multiEthFee" : MessageLookupByLibrary.simpleMessage("díj"),
    "multiFiatCancel" : MessageLookupByLibrary.simpleMessage("Cancel"),
    "multiFiatDesc" : MessageLookupByLibrary.simpleMessage("Kérjük, adja meg az átvenni kívánt fiat összeget:"),
    "multiFiatFill" : MessageLookupByLibrary.simpleMessage("Autofill"),
    "multiFixErrors" : MessageLookupByLibrary.simpleMessage("Kérjük, a folytatás előtt javítson ki minden hibát"),
    "multiInvalidAmt" : MessageLookupByLibrary.simpleMessage("Érvénytelen összeg"),
    "multiInvalidSellAmt" : MessageLookupByLibrary.simpleMessage("Érvénytelen eladási összeg"),
    "multiLowGas" : m47,
    "multiLowerThanFee" : m48,
    "multiMaxSellAmt" : MessageLookupByLibrary.simpleMessage("Max eladási összeg"),
    "multiMinReceiveAmt" : MessageLookupByLibrary.simpleMessage("A minimális vételi összeg"),
    "multiMinSellAmt" : MessageLookupByLibrary.simpleMessage("Min eladási összeg"),
    ...
    "noArticles" : MessageLookupByLibrary.simpleMessage("Nincsenek hírek - kérjük nézzen vissza később!"),
    "noCoinFound" : MessageLookupByLibrary.simpleMessage("Nem találtunk érmét"),
    "noFunds" : MessageLookupByLibrary.simpleMessage("Nincs alaptőke"),
    "noFundsDetected" : MessageLookupByLibrary.simpleMessage("Alaptőke nem elérhető - kérjük utaljon be."),
    "noInternet" : MessageLookupByLibrary.simpleMessage("Nincs Internet Kapcsolat"),
    "noItemsToExport" : MessageLookupByLibrary.simpleMessage("Nincs kiválasztott tétel"),
    "noItemsToImport" : MessageLookupByLibrary.simpleMessage("Nincs kiválasztott tétel"),
    "noMatchingOrders" : MessageLookupByLibrary.simpleMessage("Nem találtak megfelelő rendelést"),
    "noOrder" : m49,
    "noOrderAvailable" : MessageLookupByLibrary.simpleMessage("Kattintson a megrendelés létrehozásához"),
    "noOrders" : MessageLookupByLibrary.simpleMessage("Nincs rendelés, kérem, menjen a kereskedelembe."),
    "noRewardYet" : MessageLookupByLibrary.simpleMessage("Nincs igényelhető jutalom - próbálkozzon újra 1 óra múlva."),
    "noRewards" : MessageLookupByLibrary.simpleMessage("Nincs igényelhető jutalom"),
    ...
    "nonNumericInput" : MessageLookupByLibrary.simpleMessage("Az értéknek numerikusnak kell lennie"),
    "notEnoughGas" : m50,
    "notEnoughtBalanceForFee" : MessageLookupByLibrary.simpleMessage("Nincs elég egyenlege a jutalékhoz - kereskedjen kisebb mennyiséggel"),
    "noteOnOrder" : MessageLookupByLibrary.simpleMessage("Megjegyzés: A párosított rendelés nem törölhető újra."),
    "notePlaceholder" : MessageLookupByLibrary.simpleMessage("Megjegyzés hozzáadása"),
    "noteTitle" : MessageLookupByLibrary.simpleMessage("Megjegyzés"),
    "nothingFound" : MessageLookupByLibrary.simpleMessage("Semmi sem található"),
    "notifSwapCompletedText" : m51,
    "notifSwapCompletedTitle" : MessageLookupByLibrary.simpleMessage("A csere befejeződött"),
    "notifSwapFailedText" : m52,
    "notifSwapFailedTitle" : MessageLookupByLibrary.simpleMessage("A swap sikertelen"),
    "notifSwapStartedText" : m53,
    "notifSwapStartedTitle" : MessageLookupByLibrary.simpleMessage("Új swap indult"),
    "notifSwapStatusTitle" : MessageLookupByLibrary.simpleMessage("Swap státusz megváltozott"),
    "notifSwapTimeoutText" : m54,
    "notifSwapTimeoutTitle" : MessageLookupByLibrary.simpleMessage("Swap lejárt"),
    "notifTxText" : m55,
    "notifTxTitle" : MessageLookupByLibrary.simpleMessage("Bejövő tranzakció"),
    "numberAssets" : m56,
    ...
    "openMessage" : MessageLookupByLibrary.simpleMessage("Hibaüzenet megnyitása"),
    "orderCancel" : m57,
    "orderCreated" : MessageLookupByLibrary.simpleMessage("Megrendelés létrehozva"),
    "orderCreatedInfo" : MessageLookupByLibrary.simpleMessage("Megrendelés sikeresen létrehozva"),
    ...
    "orderDetailsExpedient" : m58,
    "orderDetailsExpensive" : m59,
    "orderDetailsFor" : MessageLookupByLibrary.simpleMessage("a esetében"),
    "orderDetailsIdentical" : MessageLookupByLibrary.simpleMessage("Azonos a CEX-szel"),
    ...
    "orderDetailsSelect" : MessageLookupByLibrary.simpleMessage("Válassza ki a"),
    "orderDetailsSells" : MessageLookupByLibrary.simpleMessage("Eladja"),
    "orderDetailsSettings" : MessageLookupByLibrary.simpleMessage("Nyissa meg a részleteket egyetlen koppintással, és válassza a Megrendelés hosszú koppintással"),
    "orderDetailsSpend" : MessageLookupByLibrary.simpleMessage("Töltse el a"),
    "orderDetailsTitle" : MessageLookupByLibrary.simpleMessage("Részletek"),
    "orderFilled" : m60,
    "orderMatched" : MessageLookupByLibrary.simpleMessage("Rendelés megegyezett"),
    "orderMatching" : MessageLookupByLibrary.simpleMessage("Rendelés egyeztetés"),
    "orderTypePartial" : MessageLookupByLibrary.simpleMessage("Megrendelés"),
    "orderTypeUnknown" : MessageLookupByLibrary.simpleMessage("Ismeretlen típusú rendelés"),
    ...
    "ordersTableAmount" : m61,
    "ordersTablePrice" : m62,
    "ordersTableTotal" : m63,
    "overwrite" : MessageLookupByLibrary.simpleMessage("Felülírás"),
    "ownOrder" : MessageLookupByLibrary.simpleMessage("Ez a saját megrendelésed!"),
    "paidFromBalance" : MessageLookupByLibrary.simpleMessage("Az egyenlegből fizetett:"),
    "paidFromVolume" : MessageLookupByLibrary.simpleMessage("Kifizetve a kapott mennyiségből:"),
    "paidWith" : MessageLookupByLibrary.simpleMessage("Fizetetve"),
    "passwordRequirement" : MessageLookupByLibrary.simpleMessage("A jelszónak legalább 12 karaktert kell tartalmaznia, egy kisbetűt, egy nagybetűt és egy speciális szimbólumot."),
    "paymentUriDetailsAccept" : MessageLookupByLibrary.simpleMessage("Fizetés"),
    "paymentUriDetailsAcceptQuestion" : MessageLookupByLibrary.simpleMessage("Elfogadja ezt a tranzakciót?"),
    "paymentUriDetailsAddressSpan" : MessageLookupByLibrary.simpleMessage("Címre"),
    "paymentUriDetailsAmountSpan" : MessageLookupByLibrary.simpleMessage("Összeg:"),
    "paymentUriDetailsCoinSpan" : MessageLookupByLibrary.simpleMessage("Érme:"),
    "paymentUriDetailsDeny" : MessageLookupByLibrary.simpleMessage("Cancel"),
    "paymentUriDetailsTitle" : MessageLookupByLibrary.simpleMessage("Kért fizetés"),
    "paymentUriInactiveCoin" : m64,
    "placeOrder" : MessageLookupByLibrary.simpleMessage("Rendelés leadása"),
    "pleaseAddCoin" : MessageLookupByLibrary.simpleMessage("Kérjük, adjon hozzá egy érmét"),
    "pleaseRestart" : MessageLookupByLibrary.simpleMessage("Kérjük, indítsa újra az alkalmazást, vagy nyomja meg az alábbi gombot."),
    "portfolio" : MessageLookupByLibrary.simpleMessage("Portfolió"),
    "poweredOnKmd" : MessageLookupByLibrary.simpleMessage("Komodo által működtetett"),
    ...
    "protectionCtrlConfirmations" : MessageLookupByLibrary.simpleMessage("Megerősítések"),
    "protectionCtrlCustom" : MessageLookupByLibrary.simpleMessage("Egyéni védelmi beállítások használata"),
    "protectionCtrlOff" : MessageLookupByLibrary.simpleMessage("KI"),
    "protectionCtrlOn" : MessageLookupByLibrary.simpleMessage("BE"),
    "protectionCtrlWarning" : MessageLookupByLibrary.simpleMessage("Figyelmeztetés, ez az atomi csere nem dPoW védett."),
    "pubkey" : MessageLookupByLibrary.simpleMessage("Publikációs kulcs"),
    "question_1" : MessageLookupByLibrary.simpleMessage("Tárolja a privát kulcsaimat?"),
    "question_10" : m65,
    "question_2" : m66,
    "question_3" : MessageLookupByLibrary.simpleMessage("Mennyi ideig tart egy-egy atomi swap?"),
    "question_4" : MessageLookupByLibrary.simpleMessage("A csere időtartama alatt online kell lennem?"),
    "question_5" : m67,
    "question_6" : MessageLookupByLibrary.simpleMessage("Biztosítanak felhasználói támogatást?"),
    "question_7" : MessageLookupByLibrary.simpleMessage("Vannak országos korlátozások?"),
    "question_8" : m68,
    "question_9" : m69,
    "receive" : MessageLookupByLibrary.simpleMessage("FOGAD"),
    "receiveLower" : MessageLookupByLibrary.simpleMessage("Fogad"),
    "recommendSeedMessage" : MessageLookupByLibrary.simpleMessage("Azt ajánljuk offline tárolja."),
    ...
    "resetTitle" : MessageLookupByLibrary.simpleMessage("Formanyomtatvány visszaállítása"),
    "restoreWallet" : MessageLookupByLibrary.simpleMessage("VISSZAÁLLÍTÁS"),
    "retryActivating" : MessageLookupByLibrary.simpleMessage("Az összes érme aktiválásának újbóli próbálkozása..."),
    "retryAll" : MessageLookupByLibrary.simpleMessage("Az összes érme aktiválásának újbóli próbálkozása"),
    "rewardsButton" : MessageLookupByLibrary.simpleMessage("Igényelje jutalmát"),
    "rewardsCancel" : MessageLookupByLibrary.simpleMessage("Megszünteti"),
    "rewardsError" : MessageLookupByLibrary.simpleMessage("Valami rosszul sült el. Kérjük, próbáld meg később újra."),
    "rewardsInProgressLong" : MessageLookupByLibrary.simpleMessage("A tranzakció folyamatban van"),
    "rewardsInProgressShort" : MessageLookupByLibrary.simpleMessage("feldolgozás"),
    "rewardsLowAmountLong" : MessageLookupByLibrary.simpleMessage("UTXO összeg kevesebb, mint 10 KMD"),
    "rewardsLowAmountShort" : MessageLookupByLibrary.simpleMessage("<10 KMD"),
    "rewardsOneHourLong" : MessageLookupByLibrary.simpleMessage("Egy óra még nem telt el"),
    "rewardsOneHourShort" : MessageLookupByLibrary.simpleMessage("<1 óra"),
    "rewardsPopupOk" : MessageLookupByLibrary.simpleMessage("Ok"),
    "rewardsPopupTitle" : MessageLookupByLibrary.simpleMessage("Jutalmak állapota:"),
    "rewardsReadMore" : MessageLookupByLibrary.simpleMessage("További információ a KMD aktív felhasználó jutalmakról"),
    "rewardsReceive" : MessageLookupByLibrary.simpleMessage("Kapja meg a címet."),
    "rewardsSuccess" : m70,
    "rewardsTableFiat" : MessageLookupByLibrary.simpleMessage("Utalás"),
    "rewardsTableRewards" : MessageLookupByLibrary.simpleMessage("Jutalmak,\nKMD"),
    ...
    "rewardsTableTitle" : MessageLookupByLibrary.simpleMessage("Jutalom információ:"),
    "rewardsTableUXTO" : MessageLookupByLibrary.simpleMessage("UTXO amt,\nKMD"),
    "rewardsTimeDays" : m71,
    "rewardsTimeHours" : m72,
    "rewardsTimeMin" : m73,
    "rewardsTitle" : MessageLookupByLibrary.simpleMessage("Jutalom információk"),
    ...
    "searchFilterCoin" : MessageLookupByLibrary.simpleMessage("Keressen egy érmét"),
    "searchFilterSubtitleAVX" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes Avax érmét"),
    "searchFilterSubtitleBEP" : MessageLookupByLibrary.simpleMessage("Az összes BEP token kiválasztása"),
    "searchFilterSubtitleERC" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes ERC tokenet"),
    "searchFilterSubtitleETC" : MessageLookupByLibrary.simpleMessage("Az összes ETC token kiválasztása"),
    "searchFilterSubtitleFTM" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes FTM tokenet"),
    "searchFilterSubtitleHCO" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes HCO tokenet"),
    "searchFilterSubtitleHRC" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes HRC tokenet"),
    "searchFilterSubtitleKRC" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes KRC tokenet"),
    "searchFilterSubtitleMVR" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes MVR tokenet"),
    "searchFilterSubtitlePLG" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes PLG tokenet"),
    "searchFilterSubtitleQRC" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes QRC tokenet"),
    "searchFilterSubtitleSBCH" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes SBCH tokenet"),
    "searchFilterSubtitleSmartChain" : MessageLookupByLibrary.simpleMessage("Az összes SmartChains kiválasztása"),
    "searchFilterSubtitleTestCoins" : MessageLookupByLibrary.simpleMessage("Válassza ki az összes teszteszközt"),
    "searchFilterSubtitleUBQ" : MessageLookupByLibrary.simpleMessage("Az összes Ubiq kiválasztása"),
    "searchFilterSubtitleutxo" : MessageLookupByLibrary.simpleMessage("Az összes UTXO kiválasztása"),
    "searchForTicker" : MessageLookupByLibrary.simpleMessage("Keresse meg a Tickert"),
    "seconds" : MessageLookupByLibrary.simpleMessage("s"),
    "security" : MessageLookupByLibrary.simpleMessage("Biztonság"),
    "seeOrders" : m74,
    "seeTxHistory" : MessageLookupByLibrary.simpleMessage("Tranzakciós előzmények megtekintése"),
    ...
    "selectCoinInfo" : MessageLookupByLibrary.simpleMessage("Válassza ki az érmét amit hozzá kíván adni a portfóliójához"),
    "selectCoinTitle" : MessageLookupByLibrary.simpleMessage("Érme aktiválás:"),
    "selectCoinToBuy" : MessageLookupByLibrary.simpleMessage("Válassza ki az érmét amit VÁSÁROLNI szeretne"),
    "selectCoinToSell" : MessageLookupByLibrary.simpleMessage("Válassza ki az érmét amit ELADNI szeretne"),
    "selectFileImport" : MessageLookupByLibrary.simpleMessage("Fájl kiválasztása"),
    "selectLanguage" : MessageLookupByLibrary.simpleMessage("Nyelv kiválasztása"),
    "selectPaymentMethod" : MessageLookupByLibrary.simpleMessage("Válassza ki a fizetési metódust"),
    "selectedOrder" : MessageLookupByLibrary.simpleMessage("Kiválasztott sorrend:"),
    "sell" : MessageLookupByLibrary.simpleMessage("Eladás"),
    "sellTestCoinWarning" : MessageLookupByLibrary.simpleMessage("Figyelmeztetés, Ön hajlandó eladni tesztérméket VALÓDI érték nélkül!"),
    "send" : MessageLookupByLibrary.simpleMessage("KÜLD"),
    "setUpPassword" : MessageLookupByLibrary.simpleMessage("JELSZÓ BEÁLLÍTÁSA"),
    "settingDialogSpan1" : MessageLookupByLibrary.simpleMessage("Biztos benne, hogy törölni szeretné"),
    "settingDialogSpan2" : MessageLookupByLibrary.simpleMessage("pénztárca?"),
    "settingDialogSpan3" : MessageLookupByLibrary.simpleMessage("Ha igen, győződjön meg róla"),
    "settingDialogSpan4" : MessageLookupByLibrary.simpleMessage("rögzítse a SEED-jét."),
    "settingDialogSpan5" : MessageLookupByLibrary.simpleMessage("A pénztárca jövőbeli helyreállítása érdekében."),
    ...
    "shareAddress" : m75,
    "showDetails" : MessageLookupByLibrary.simpleMessage("Részletek megjelenítése"),
    "showMyOrders" : MessageLookupByLibrary.simpleMessage("Mutasd a rendeléseimet"),
    "signInWithPassword" : MessageLookupByLibrary.simpleMessage("Jelentkezzen be jelszóval"),
    "signInWithSeedPhrase" : MessageLookupByLibrary.simpleMessage("Jelentkezzen be SEED-el"),
    "simple" : MessageLookupByLibrary.simpleMessage("Egyszerű"),
    "simpleTradeActivate" : MessageLookupByLibrary.simpleMessage("Aktiválja a címet."),
    "simpleTradeBuyHint" : m76,
    ...
    "simpleTradeMaxActiveCoins" : m77,
    "simpleTradeNotActive" : m78,
    "simpleTradeRecieve" : MessageLookupByLibrary.simpleMessage("Fogadja"),
    "simpleTradeSellHint" : m79,
    ...
    "simpleTradeShowLess" : MessageLookupByLibrary.simpleMessage("Kevesebb mutatása"),
    "simpleTradeShowMore" : MessageLookupByLibrary.simpleMessage("Többet mutasd meg"),
    "simpleTradeUnableActivate" : m80,
    "skip" : MessageLookupByLibrary.simpleMessage("Kihagyás"),
    "snackbarDismiss" : MessageLookupByLibrary.simpleMessage("Dissississ"),
    "soundCantPlayThatMsg" : m81,
    "soundPlayedWhen" : m82,
    "soundSettingsLink" : MessageLookupByLibrary.simpleMessage("Hang"),
    "soundSettingsTitle" : MessageLookupByLibrary.simpleMessage("Hangbeállítások"),
    "soundsDialogTitle" : MessageLookupByLibrary.simpleMessage("Hangok"),
    "soundsDoNotShowAgain" : MessageLookupByLibrary.simpleMessage("Értettem, többé nem jelenítjük meg"),
    "soundsExplanation" : MessageLookupByLibrary.simpleMessage("A cserefolyamat során és akkor hallható hangjelzés, ha aktív készítői megbízásod van.\nAz atomi swap protokoll megköveteli, hogy a résztvevők online legyenek a sikeres kereskedéshez, és a hangos értesítések segítenek ennek elérésében."),
    "soundsNote" : MessageLookupByLibrary.simpleMessage("Ne feledje, hogy az alkalmazás beállításaiban beállíthatja az egyéni hangokat."),
    ...
    "supportLinksDesc" : m83,
    "swap" : MessageLookupByLibrary.simpleMessage("csere"),
    "swapCurrent" : MessageLookupByLibrary.simpleMessage("Aktuális"),
    "swapDetailTitle" : MessageLookupByLibrary.simpleMessage("Erősitse meg a csere részleteit"),
    ...
    "swapGasActivate" : m84,
    "swapGasAmount" : m85,
    "swapGasAmountRequired" : m86,
    "swapOngoing" : MessageLookupByLibrary.simpleMessage("Csere folyamatban"),
    "swapProgress" : MessageLookupByLibrary.simpleMessage("Haladás részletei"),
    ...
    "titleCreatePassword" : MessageLookupByLibrary.simpleMessage("JELSZÓ LÉTREHOZÁSA"),
    "titleCurrentAsk" : MessageLookupByLibrary.simpleMessage("Kiválasztott sorrend"),
    "to" : MessageLookupByLibrary.simpleMessage("Hova"),
    "toAddress" : MessageLookupByLibrary.simpleMessage("Címzett:"),
    "tooManyAssetsEnabledSpan1" : MessageLookupByLibrary.simpleMessage("Van egy"),
    "tooManyAssetsEnabledSpan2" : MessageLookupByLibrary.simpleMessage("eszközöd engedélyezve. Az engedélyezett eszközök maximális korlátja ."),
    "tooManyAssetsEnabledSpan3" : MessageLookupByLibrary.simpleMessage("Kérjük, tiltson le néhányat, mielőtt újakat adna hozzá."),
    "tooManyAssetsEnabledTitle" : MessageLookupByLibrary.simpleMessage("Túl sok eszköz engedélyezve"),
    "totalFees" : MessageLookupByLibrary.simpleMessage("Összes díj:"),
    "trade" : MessageLookupByLibrary.simpleMessage("KERESKEDÉS"),
    "tradeCompleted" : MessageLookupByLibrary.simpleMessage("Csere végrehajtva!"),
    "tradeDetail" : MessageLookupByLibrary.simpleMessage("KERESKEDÉS részletek"),
    "tradePreimageError" : MessageLookupByLibrary.simpleMessage("Nem sikerült kiszámítani a kereskedelmi díjakat"),
    ...
    "tryRestarting" : MessageLookupByLibrary.simpleMessage("Ha még ekkor sem aktiválódik néhány érme, próbálja meg újraindítani az alkalmazást."),
    "turkishLanguage" : MessageLookupByLibrary.simpleMessage("Török"),
    "txBlock" : MessageLookupByLibrary.simpleMessage("Blokk"),
    "txConfirmations" : MessageLookupByLibrary.simpleMessage("Megerősítések"),
    ...
    "txHash" : MessageLookupByLibrary.simpleMessage("Tranzakció azonosítója"),
    "txLimitExceeded" : MessageLookupByLibrary.simpleMessage("Túl sok a kérés.\n Tranzakciótörténeti kérések száma túllépte a limitet.\n Kérjük, próbálja meg később újra."),
    "txNotConfirmed" : MessageLookupByLibrary.simpleMessage("NEM MEGERŐSÍTETT"),
    "txleft" : m87,
    ...
    "updatesAvailable" : MessageLookupByLibrary.simpleMessage("Új verzió elérhető"),
    "updatesChecking" : MessageLookupByLibrary.simpleMessage("Frissítések keresése..."),
    "updatesCurrentVersion" : m89,
    "updatesNotifAvailable" : MessageLookupByLibrary.simpleMessage("Új verzió elérhető. Kérjük, frissítse."),
    "updatesNotifAvailableVersion" : m90,
    "updatesNotifTitle" : MessageLookupByLibrary.simpleMessage("Frissítés elérhető"),
    "updatesSkip" : MessageLookupByLibrary.simpleMessage("Egyelőre kihagyás"),
    "updatesTitle" : m91,
    "updatesUpToDate" : MessageLookupByLibrary.simpleMessage("Már naprakész"),
    "updatesUpdate" : MessageLookupByLibrary.simpleMessage("Frissítés"),
    "uriInsufficientBalanceSpan1" : MessageLookupByLibrary.simpleMessage("Nincs elég egyenleg a beolvasáshoz"),
    "uriInsufficientBalanceSpan2" : MessageLookupByLibrary.simpleMessage("fizetési kérelem."),
    "uriInsufficientBalanceTitle" : MessageLookupByLibrary.simpleMessage("Elégtelen egyenleg"),
    "value" : MessageLookupByLibrary.simpleMessage("Érték:"),
    "version" : MessageLookupByLibrary.simpleMessage("verzió"),
    "viewInExplorerButton" : MessageLookupByLibrary.simpleMessage("Felfedező"),
    "viewSeedAndKeys" : MessageLookupByLibrary.simpleMessage("Magánkulcsok és magánkulcsok"),
    "volumes" : MessageLookupByLibrary.simpleMessage("Volumes"),
    "walletInUse" : MessageLookupByLibrary.simpleMessage("A pénztárca neve már használatban van"),
    "walletMaxChar" : MessageLookupByLibrary.simpleMessage("A pénztárca neve legfeljebb 40 karakter lehet."),
    ...
    "warningShareLogs" : MessageLookupByLibrary.simpleMessage("Figyelmeztetés - különleges esetekben ez a naplóadat érzékeny információkat tartalmaz, amelyek felhasználhatók a sikertelen cserékből származó érmék elköltésére!"),
    "weFailedTo" : m92,
    "weFailedToActivate" : m93,
    "welcomeInfo" : m94,
    "welcomeLetSetUp" : MessageLookupByLibrary.simpleMessage("KÉSZÍTSÜK FEL!"),
    "welcomeTitle" : MessageLookupByLibrary.simpleMessage("Üdvözöljük"),
    "welcomeWallet" : MessageLookupByLibrary.simpleMessage("pénztárca"),
    "willBeRedirected" : MessageLookupByLibrary.simpleMessage("A kitöltés után átirányítjuk a portfólió oldalra."),
    "withdraw" : MessageLookupByLibrary.simpleMessage("Kifizetés"),
    "withdrawCameraAccessText" : m95,
    "withdrawCameraAccessTitle" : MessageLookupByLibrary.simpleMessage("Hozzáférés megtagadva"),
    "withdrawConfirm" : MessageLookupByLibrary.simpleMessage("Kiutalás megerősítése"),
    "withdrawConfirmError" : MessageLookupByLibrary.simpleMessage("Valami rosszul sült el. Próbálja meg később újra."),
    "withdrawValue" : m96,
    "wrongCoinSpan1" : MessageLookupByLibrary.simpleMessage("Ön megpróbál beolvasni egy fizetési QR-kódot a következőhöz"),
    "wrongCoinSpan2" : MessageLookupByLibrary.simpleMessage("de a"),
    "wrongCoinSpan3" : MessageLookupByLibrary.simpleMessage("visszavonási képernyőn van"),
    "wrongCoinTitle" : MessageLookupByLibrary.simpleMessage("Rossz érme"),
    "wrongPassword" : MessageLookupByLibrary.simpleMessage("A jelszavak nem egyeznek. Próbálja újra."),
    "yes" : MessageLookupByLibrary.simpleMessage("Igen"),
    "you have a fresh order that is trying to match with an existing order" : MessageLookupByLibrary.simpleMessage("van egy új megrendelése, amelyet egy meglévő megrendeléssel próbál összevetni."),
    "you have an active swap in progress" : MessageLookupByLibrary.simpleMessage("aktív csere folyamatban van"),
    "you have an order that new orders can match with" : MessageLookupByLibrary.simpleMessage("van egy megbízása, amellyel az új megbízások összeilleszthetők."),
    "youAreSending" : MessageLookupByLibrary.simpleMessage("Ön küld:"),
    "youWillReceiveClaim" : m97,
