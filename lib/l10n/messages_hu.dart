...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "Az ${appName} mobilra Androidon és iPhone-on, asztali számítógépen pedig <a href=\"https://piratechain.com/\">Windows, Mac és Linux operációs rendszeren</a> érhető el.";
  ...
  static m10(appName) =>
      "Az egyes swapok feldolgozási idejét több tényező határozza meg. A kereskedett eszközök blokkolási ideje az egyes hálózatoktól függ (a Bitcoin jellemzően a leglassabb) Ezen kívül a felhasználó testre szabhatja a biztonsági beállításokat. Például kérheti az ${appName}-t, hogy egy ARRR tranzakciót már 3 megerősítés után véglegesnek tekintsen, ami rövidebbé teszi a csereidőt, mintha <a href=\"https://piratechain.com/faq/\">jegyesítésre</a> kellene várni.";
  ...
  static m15(appName) =>
      "Teljesen! További részletekért olvassa el <a href=\"https://piratechain.com/faq/\">fejlesztői dokumentációnkat</a>, vagy forduljon hozzánk partnerségi kérdéseivel. Konkrét technikai kérdése van? A ${appName} fejlesztői közössége mindig készen áll a segítségére!";
