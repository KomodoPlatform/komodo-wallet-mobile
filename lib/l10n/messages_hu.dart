...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m11(appName) => "Abszolút! További részletekért olvassa el <a href=\"https://developers.atomicdex.io/\">fejlesztői dokumentációnkat</a>, vagy vegye fel velünk a kapcsolatot partnerségi kérdéseivel. Konkrét technikai kérdése van? Az ${appName} fejlesztői közösség mindig készen áll a segítségre!";

  static m12(batteryLevelCritical) => "Az akkumulátor töltöttsége kritikus (${batteryLevelCritical}%) a biztonságos cseréhez. Kérjük, töltse fel, és próbálja meg újra.";

  static m13(batteryLevelLow) => "Az akkumulátor töltöttsége alacsonyabb, mint ${batteryLevelLow}%. Kérjük, fontolja meg a telefon töltését.";

  static m14(seconde) => "A rendelés egyeztetése folyamatban van, kérjük várjon ${seconde} másodperceket!";

  static m15(index) => "Írja be a ${index}. szót";

  static m16(index) => "Mi a ${index}. szó a SEED-ben?";

  static m17(name) => "Biztos vagy benne, hogy törölni akarod a ${name} kontaktot?";
  ...
  static m19(abbr) => "Bemenet ${abbr} cím";

  static m20(gas) => "Nincs elég gáz - használjon minimum ${gas} Gwei";
  ...
  static m35(coin) => "Kérelem küldése a ${coin} csaptelephez...";

  static m36(appCompanyShort) => "${appCompanyShort} hírek";

  static m37(coin) => "${coin} díj";

  static m38(coin) => "Kérjük, aktiválja ${coin}.";

  static m39(abbr) => "${abbr} az egyenleg nem elegendő a kereskedési díj kifizetéséhez";
  ...
  static m44(coinName, number) => "Az eladandó minimális összeg ${number} ${coinName}";

  static m45(minValue, coin) => "Nagyobbnak kell lennie, mint ${minValue} ${coin}";

  static m46(appName) => "Kérjük, vegye figyelembe, hogy most mobiladatokat használ, és az ${appName} P2P-hálózatban való részvétel internetforgalmat fogyaszt. Jobb, ha WiFi hálózatot használsz, ha a mobiladat-előfizetésed drága.";

  static m47(coin) => "Aktiválja a ${coin} és töltse fel először az egyenlegét";

  static m48(number) => "Create ${number} Order(s):";

  static m49(coin) => "${coin} egyenleg túl alacsony";

  static m50(coin, fee) => "Nincs elég ${coin} a díjak kifizetéséhez. MIN egyenleg ${fee} ${coin}";

  static m51(coinName) => "Nem érhető el ${coinName} rendelés - próbálja újra később, vagy készítsen egy rendelést.";

  static m52(coin) => "Nincs elég ${coin} a tranzakcióhoz!";

  static m53(sell, buy) => "Az ${sell}/${buy} swap sikeresen befejeződött.";

  static m54(sell, buy) => "${sell}/${buy} csere sikertelen volt";

  static m55(sell, buy) => "${sell}/${buy} swap elindult";

  static m56(sell, buy) => "${sell}/${buy} swap időzítve volt";

  static m57(coin) => "Ön ${coin} tranzakciót kapott!";

  static m58(assets) => "${assets} Aktív";

  static m59(coin) => "Minden ${coin} megrendelés törlésre kerül.";

  static m60(delta) => "Célszerű: CEX +${delta}%";

  static m61(delta) => "Drága: CEX ${delta}%";

  static m62(fill) => "${fill}% betelt";

  static m63(coin) => "Mennyiség. (${coin})";

  static m64(coin) => "Ár (${coin})";

  static m65(coin) => "Összesen (${coin})";

  static m66(abbr) => "${abbr} nem aktív. Kérjük, aktiválja és próbálja újra.";

  static m67(appName) => "Mely eszközökön használhatom az ${appName}-t?";

  static m68(appName) => "Miben különbözik a kereskedés az ${appName}-en a más DEX-eken folytatott kereskedéstől?";

  static m69(appName) => "Hogyan számítják ki a díjakat az ${appName}-nél?";

  static m70(appName) => "Ki áll az ${appName} mögött?";

  static m71(appName) => "Lehetséges saját white-label csereprogramot kialakítani az ${appName} oldalon?";

  static m72(amount) => "Siker! ${amount} KMD kapott.";

  static m73(dd) => "${dd} napok";

  static m74(hh, minutes) => "${hh}h ${minutes}m";

  static m75(mm) => "${mm}min";

  static m76(amount) => "Kattintson a megtekintéshez ${amount} rendelések";

  static m77(coinName, address) => "Az én ${coinName} címem:\n${address}";

  static m78(coin) => "Kérjük, adja meg a ${coin} összeget a vásárláshoz";

  static m79(maxCoins) => "A maximális aktív érmék száma ${maxCoins}. Kérjük, néhányat deaktiváljon.";

  static m80(coin) => "${coin} nem aktív!";

  static m81(coin) => "Kérjük, adja meg az eladni kívánt ${coin} összeget";

  static m82(coin) => "Nem sikerült aktiválni ${coin}";

  static m83(description) => "Válasszon egy mp3 vagy wav fájlt, kérem. Akkor fogjuk lejátszani, amikor ${description}.";

  static m84(description) => "Lejátsszuk, amikor ${description}";

  static m85(appName) => "Ha bármilyen kérdésed van, vagy úgy gondolod, hogy technikai problémát találtál az ${appName} alkalmazással kapcsolatban, akkor jelentheted, és támogatást kaphatsz csapatunktól.";

  static m86(coin) => "Kérjük, először aktiválja ${coin} és töltse fel egyenlegét";

  static m87(coin) => "Az ${coin} egyenleg nem elegendő a tranzakciós díjak kifizetéséhez.";

  static m88(coin, amount) => "${coin} egyenleg nem elegendő a tranzakciós díjak kifizetéséhez. ${coin} ${amount} szükséges.";

  static m89(left) => "Tranzakciók Balra: ${left}";

  static m90(amnt, hash) => "Sikeresen feloldotta a ${amnt} pénzeszközöket - TX: ${hash}";

  static m91(version) => "Ön a ${version} verziót használja.";

  static m92(version) => "A ${version} verzió elérhető. Kérjük, frissítse.";

  static m93(appName) => "${appName} frissítés";

  static m94(coinAbbr) => "Nem sikerült aktiválni a ${coinAbbr}";

  static m95(coinAbbr) => "Nem sikerült aktiválni a ${coinAbbr}.\nKérjük, indítsa újra az alkalmazást, hogy újra megpróbálhassa.";

  static m96(appName) => "${appName} mobil egy következő generációs többérmés pénztárca natív harmadik generációs DEX funkcióval és még sokkal több";

  static m97(appName) => "Ön korábban megtagadta a ${appName} hozzáférést a kamerához.\n Kérjük, a QR-kód beolvasásának folytatásához manuálisan módosítsa a kameraengedélyt a telefon beállításaiban.";

  static m98(amount, coinName) => "KIFIZETÉS ${amount} ${coinName}";

  static m99(amount, coin) => "Kapni fog ${amount} ${coin}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "traditionalChinese" : MessageLookupByLibrary.simpleMessage("Hagyományos"),
