...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "Приложение ${appName} доступно для мобильных устройств на Android и iPhone, а также для компьютеров в <a href=\"https://firo.org/\">операционных системах Windows, Mac и Linux</a>.";

  static m9(appName) =>
      "Другие DEX обычно позволяют торговать только активами, принадлежащими к одному блокчейну, используют прокси-токены и разрешают размещать только один ордер, использующий ваш баланс.\n\n${appName} позволяет вам торговать между разными блокчейнами без использования прокси-токенов. Вы также можете разместить несколько заказов, используя одни и те же средства. Например, вы можете выставить ордера на продажу 0,1 BTC за FIRO, QTUM и VRSC - первый исполненный ордер автоматически отменит все остальные ордера.";

  static m10(appName) =>
      "Есть несколько факторов, определяющих время обработки каждого свопа. Время блокировки торгуемых активов зависит от каждой сети (биткоин блокчейн обычно является самым медленным). Кроме того, пользователь может редактировать параметры безопасности. Например, в ${appName} можно установить количество подтверждений, после которых FIRO транзакция считается успешной, равным 3, что сокращает время обмена по сравнению с транзакциями, ожидающими <a href=\"https://firo.org/\">нотариального заверения</a>.";
  ...
  static m15(appName) =>
      "Абсолютно! Вы можете прочитать нашу <a href=\"https://firo.org/\">документацию для разработчиков</a> для получения более подробной информации или связаться с нами по вопросам партнерства. Есть конкретный технический вопрос? Сообщество разработчиков ${appName} всегда готово помочь!";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "builtFiro": MessageLookupByLibrary.simpleMessage("Построено на Firo"),
        "builtOnKmd": MessageLookupByLibrary.simpleMessage("Построено на Firo"),
        ...
        "dPow": MessageLookupByLibrary.simpleMessage("Защита Firo dPoW"),
        ...
        "poweredOnKmd":
            MessageLookupByLibrary.simpleMessage("Разработано Firo"),
        ...
        "rebrandingAnnouncement": MessageLookupByLibrary.simpleMessage(
            "Это новая эра! Мы официально изменили наше название с «AtomicDEX» на «Firo Wallet»."),
