...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static dynamic _notInlinedMessages(dynamic _) => <String, Function>{
        ...
        "articleFrom":
            MessageLookupByLibrary.simpleMessage("НОВОСТИ atomicDeFi"),
        "availableVolume":
        ...
        "welcomeInfo": MessageLookupByLibrary.simpleMessage(
            "atomicDeFi mobile - это мульти-монетный кошелек с функциональностью DEX третьего поколения и многим другим."),
        "welcomeLetSetUp":
