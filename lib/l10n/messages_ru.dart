...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(appName) => "Нет! Мы никогда не храним конфиденциальные данные, включая ваши приватные ключи, seed ключи или PIN-код. Эти данные хранятся только на устройстве пользователя и никуда не передаются. Вы полностью контролируете свои активы.";

  static m4(appName) => "${appName} доступен для мобильных устройств на Android и iPhone, а также как десктопное приложение на операционных системах Windows, Mac и Linux.";
  ...
  static m8(name, link, appName, appCompanyShort) => "Да! ${appName} предлагает поддержку через <a href=\"${link}\"> ${name} сервер ${appCompanyShort} </a>. Команда и сообщество всегда рады помочь!";

  static m9(appName) => "Нет! ${appName} полностью децентрализована. Ограничить доступ пользователей третьими лицами невозможно.";

  static m10(appName, appCompanyShort) => "${appName} разработан командой ${appCompanyShort}. ${appCompanyShort} - один из наиболее авторитетных блокчейн-проектов, работающих над инновационными решениями, такими как атомарные свопы, delayed Proof of Work и совместимая многоцепочечная архитектура.";

  static m11(appName) => "Конечно! Вы можете обратиться к нашей документации для разработчиков для получения более подробной информации или связаться с нами по вопросам партнерства. У вас есть конкретный технический вопрос? Разработчики сообщества ${appName} всегда готовы помочь!";

  static m12(batteryLevelCritical) => "Критический заряд батареи (${batteryLevelCritical}%) для безопасного выполнения свопа. Пожалуйста поставьте его на зарядку и повторите попытку.";

  static m13(batteryLevelLow) => "Заряд батареи ниже ${batteryLevelLow}%. Пожалуйста подумайте о зарядке телефона.";

  static m14(seconde) => "Поиск сделки в процессе, пожалуйста , подождите ${seconde} секунд!";

  static m15(index) => "Введите ${index} слово";

  static m16(index) => "Какое ${index} слово в вашем seed-ключе?";
  ...
  static m20(gas) => "Не достаточно газа - используйте минимум ${gas} Gwei";
  ...
  static m35(coin) => "Отправка запроса на кран ${coin}";

  static m36(appCompanyShort) => "Новости Комодо";

  static m37(coin) => "${coin} комиссия";

  static m38(coin) => "Пожалуйста активируйте ${coin}";

  static m39(abbr) => "${abbr} недостаточно баланса чтобы оплатить торговую комиссию";

  static m40(coinAbbr) => "${coinAbbr} недоступен :(";

  static m41(coinName, number) => "Минимальная сумма продажи составляет ${number} ${coinName}.";

  static m42(coinName, number) => "Минимальная сумма покупки: ${number} ${coinName}";

  static m43(buyCoin, buyAmount, sellCoin, sellAmount) => "Минимальная сумма ордера ${buyAmount} ${buyCoin}\n(${sellAmount} ${sellCoin})";

  static m44(coinName, number) => "Минимальная сумма на продажу ${number} ${coinName}";

  static m45(minValue, coin) => "Должно быть больше чем ${minValue} ${coin}";

  static m46(appName) => "Обратите внимание, что теперь вы используете сотовые данные, а участие в P2P-сети ${appName} потребляет интернет-трафик. Лучше использовать сеть Wi-Fi, если ваш тарифный план сотовой связи является дорогостоящим.";

  static m47(coin) => "Активируйте ${coin} и пополните баланс";

  static m48(number) => "Создать ${number} ордер(ов):";

  static m49(coin) => "${coin} баланс очень низкий";

  static m50(coin, fee) => "Недостаточно ${coin} чтобы оплатить налог. МИН баланс ${fee} ${coin}";

  static m51(coinName) => "Пожалуйста, введите сумму ${coinName}.";

  static m52(coin) => "Не достаточно ${coin} для транзакции!";

  static m53(sell, buy) => "Своп ${sell}/${buy} успешно завершен";

  static m54(sell, buy) => "Своп ${sell}/${buy} не прошел";

  static m55(sell, buy) => "Своп ${sell}/${buy} начат";

  static m56(sell, buy) => "Превышен тайм-аут свопа ${sell}/${buy}";

  static m57(coin) => "Вы получили ${coin} транзакцию";

  static m58(assets) => "${assets} Активов";

  static m59(coin) => "Все ${coin} ордеры будут отменены.";

  static m60(delta) => "На -${delta}% ниже цен CEX";

  static m61(delta) => "На +${delta}% выше цен CEX";

  static m62(fill) => "${fill}% заполнено";

  static m63(coin) => "Сумма (${coin})";

  static m64(coin) => "Цена (${coin})";

  static m65(coin) => "Всего (${coin})";

  static m66(abbr) => "${abbr} не активен. Пожалуйста активируйте и попробуйте снова.";

  static m67(appName) => "На каких устройствах я могу использовать ${appName}?";

  static m68(appName) => "Чем торговля на ${appName} отличается от торговли на других DEX?";

  static m69(appName) => "Как рассчитываются комиссии на ${appName}?";

  static m70(appName) => "Кто стоит за ${appName}?";

  static m71(appName) => "Можно ли разработать собственную white-label биржу на технологии ${appName}?";

  static m72(amount) => "Получено ${amount} KMD.";

  static m73(dd) => "${dd} дней}";

  static m74(hh, minutes) => "${hh}ч ${minutes}мин";

  static m75(mm) => "мин ${mm}";
  ...
  static m79(maxCoins) => "Максимальное количество активных монет: ${maxCoins}. Пожалуйста деактивируйте некоторые из них.";

  static m80(coin) => "${coin} не активна";

  static m81(coin) => "Пожалуйста введите сумму ${coin} для продажи";

  static m82(coin) => "Не удалось активировать ${coin}";

  static m83(description) => "Выберите файл в формате mp3 или wav. Воспроизводится, когда ${description}.";

  static m84(description) => "Воспроизводится, когда ${description}";

  static m85(appName) => "Если у вас есть какие-либо вопросы или вы считаете, что обнаружили техническую проблему с приложением ${appName}, вы можете сообщить об этом и получить поддержку от нашей команды.";

  static m86(coin) => "Пожалуйста сначала активируйте ${coin} и пополните баланс";

  static m87(coin) => "Баланс ${coin} недостаточен для оплаты комиссии за транзакцию.";

  static m88(coin, amount) => "Баланс ${coin} недостаточен для оплаты комиссии за транзакцию. ${coin} ${amount} требуется.";

  static m89(left) => "Осталось транзакций: ${left}";

  static m90(amnt, hash) => "Успешно разблокировано ${amnt} средств - TX: ${hash}";

  static m91(version) => "Установлена версия ${version}";

  static m92(version) => "Доступна версия ${version}. Пожалуйста, обновитесь.";

  static m93(appName) => "Обновление ${appName}";

  static m94(coinAbbr) => "Ошибка активации ${coinAbbr}";

  static m95(coinAbbr) => "Ошибка активации ${coinAbbr}\nПожалуйста перезапустите приложение и попробуйте снова";

  static m96(appName) => "${appName} mobile - это мульти-монетный кошелек с функциональностью DEX третьего поколения и многим другим.";

  static m97(appName) => "Ранее вы запретили ${appName} доступ к камере.\nВручную измените разрешения для камеры в настройках телефона, чтобы продолжить сканирование QR-кода.";

  static m98(amount, coinName) => "ВЫВЕСТИ ${amount} ${coinName}";

  static m99(amount, coin) => "Вы получите ${amount} ${coin}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "accepttac" : MessageLookupByLibrary.simpleMessage("Принять ПРАВИЛА и УСЛОВИЯ"),
    ...
    "addressBookEmpty" : MessageLookupByLibrary.simpleMessage("Адресная книга пуста"),
    ...
    "batterySavingWarning" : MessageLookupByLibrary.simpleMessage("Ваш телефон находится в режиме экономии заряда батареи. Пожалуйста, отключите этот режим или НЕ переводите приложение в фоновый режим, в противном случае приложение может быть убито операционной системой, и обмен не удастся."),
    ...
    "camoPinBioProtectionConflict" : MessageLookupByLibrary.simpleMessage("Маскировочный PIN и BIO защита не могут быть включены одновременно."),
    "camoPinBioProtectionConflictTitle" : MessageLookupByLibrary.simpleMessage("Конфликт маскировочного и Bio защитных PIN"),
    ...
    "camouflageSetup" : MessageLookupByLibrary.simpleMessage("Установить маскировочный PIN"),
    ...
    "cantDeleteDefaultCoinSpan" : MessageLookupByLibrary.simpleMessage("это монета настроенная по умолчанию. Монеты по умолчанию не могут быть отключены."),
    "cantDeleteDefaultCoinTitle" : MessageLookupByLibrary.simpleMessage("Не возможно отключить"),
    ...
    "checkSeedPhrase" : MessageLookupByLibrary.simpleMessage("Проверьте seed-фразу"),
    ...
    "closeMessage" : MessageLookupByLibrary.simpleMessage("Закрыть сообщение об ошибке"),
    "closePreview" : MessageLookupByLibrary.simpleMessage("Закрыть предпросмотр"),
    ...
    "comparedToCex" : MessageLookupByLibrary.simpleMessage("сравнение с CEX"),
    "configureWallet" : MessageLookupByLibrary.simpleMessage("Настройка кошелька, пожалуйста, подождите"),
    "confirm" : MessageLookupByLibrary.simpleMessage("подтвердить"),
    "confirmCamouflageSetup" : MessageLookupByLibrary.simpleMessage("Подтвердить маскировочный PIN"),
    "confirmCancel" : MessageLookupByLibrary.simpleMessage("Вы уверены, что хотите отменить ордер"),
    ...
    "couldntImportError" : MessageLookupByLibrary.simpleMessage("Не удалось импортировать:"),
    ...
    "deletingWallet" : MessageLookupByLibrary.simpleMessage("Удаляю кошелек"),
    ...
    "dexIsNotAvailable" : MessageLookupByLibrary.simpleMessage("DEX не доступен для этой монеты"),
    "disclaimerAndTos" : MessageLookupByLibrary.simpleMessage("Disclaimer & ToS"),
    "done" : MessageLookupByLibrary.simpleMessage("Готово"),
    "dontAskAgain" : MessageLookupByLibrary.simpleMessage("Не спрашивать снова"),
    ...
    "emptyCoin" : m19,
    "emptyExportPass" : MessageLookupByLibrary.simpleMessage("Зашифрованный пароль не может быть пустым"),
    "emptyImportPass" : MessageLookupByLibrary.simpleMessage("Пароль не может быть пустым"),
    "emptyName" : MessageLookupByLibrary.simpleMessage("Имя контакта не может быть пустым"),
    "emptyWallet" : MessageLookupByLibrary.simpleMessage("Имя кошелька не должно быть пустым"),
    "enableTestCoins" : MessageLookupByLibrary.simpleMessage("Включить тестовые монеты"),
    "enablingTooManyAssetsSpan1" : MessageLookupByLibrary.simpleMessage("У вас есть"),
    "enablingTooManyAssetsSpan2" : MessageLookupByLibrary.simpleMessage("подключенные активы и активы в состоянии подключения"),
    "enablingTooManyAssetsSpan3" : MessageLookupByLibrary.simpleMessage("Максимальный лимит подключенных активов ."),
    "enablingTooManyAssetsSpan4" : MessageLookupByLibrary.simpleMessage("Пожалуйста отключите некоторые чтобы добавить новые."),
    ...
    "enterSellAmount" : MessageLookupByLibrary.simpleMessage("Для начала вы должны ввести сумму на продажу"),
    ...
    "errorTryLater" : MessageLookupByLibrary.simpleMessage("Ошибка, пожалуйста попробуйте позже"),
    ...
    "exchangeExpedient" : MessageLookupByLibrary.simpleMessage("Ниже цен CEX"),
    "exchangeExpensive" : MessageLookupByLibrary.simpleMessage("Выше цен CEX"),
    "exchangeIdentical" : MessageLookupByLibrary.simpleMessage("Идентичен CEX"),
    "exchangeRate" : MessageLookupByLibrary.simpleMessage("Рейтинг обменника"),
    ...
    "exportDesc" : MessageLookupByLibrary.simpleMessage("Пожалуйста выберите элементы для экспорта в зашифрованный файл."),
    ...
    "faucetTimedOut" : MessageLookupByLibrary.simpleMessage("Время запроса истекло"),
    ...
    "filtersClearAll" : MessageLookupByLibrary.simpleMessage("Очистить все фильтры"),
    ...
    "filtersReceive" : MessageLookupByLibrary.simpleMessage("Получить монету"),
    ...
    "hintCreatePassword" : MessageLookupByLibrary.simpleMessage("Создать пароль"),
    ...
    "importDecryptError" : MessageLookupByLibrary.simpleMessage("Неверный пароль или поврежденные данные"),
    "importDesc" : MessageLookupByLibrary.simpleMessage("Элементы к импорту"),
    "importFileNotFound" : MessageLookupByLibrary.simpleMessage("Файл не найден"),
    "importInvalidSwapData" : MessageLookupByLibrary.simpleMessage("Неверные данные своп. Предоставьте действительный JSON-файл состояния своп."),
    "importLink" : MessageLookupByLibrary.simpleMessage("Импорт"),
    "importLoadDesc" : MessageLookupByLibrary.simpleMessage("Пожалуйста выберите зашифрованный файл для импорта."),
    "importLoadSwapDesc" : MessageLookupByLibrary.simpleMessage("Пожалуйста выберите текстовый своп файл для импорта"),
    ...
    "importSingleSwapLink" : MessageLookupByLibrary.simpleMessage("Импортировать одиночный своп файл"),
    "importSingleSwapTitle" : MessageLookupByLibrary.simpleMessage("Импортировать своп файл"),
    "importSomeItemsSkippedWarning" : MessageLookupByLibrary.simpleMessage("Некоторые элементы были пропущены"),
    "importSuccessTitle" : MessageLookupByLibrary.simpleMessage("Элементы которые были успешно импортированы:"),
    "importSwapFailed" : MessageLookupByLibrary.simpleMessage("Ошибка при импорте своп файла"),
    "importSwapJsonDecodingError" : MessageLookupByLibrary.simpleMessage("Ошибка декодирования json файла"),
    ...
    "insufficientText" : MessageLookupByLibrary.simpleMessage("Минимальное количество необходимое для этого ордера составляет"),
    "insufficientTitle" : MessageLookupByLibrary.simpleMessage("Недостаточное количество"),
    "internetRefreshButton" : MessageLookupByLibrary.simpleMessage("Обновить"),
    "internetRestored" : MessageLookupByLibrary.simpleMessage("Соединение с интернетом восстановлено"),
    "invalidSwap" : MessageLookupByLibrary.simpleMessage("Невозможно продолжить своп"),
    ...
    "loadingOrderbook" : MessageLookupByLibrary.simpleMessage("Загрузка книги ордеров..."),
    ...
    "makerDetailsCancel" : MessageLookupByLibrary.simpleMessage("Отменить ордер"),
    "makerDetailsCreated" : MessageLookupByLibrary.simpleMessage("Создано в"),
    ...
    "makerDetailsNoSwaps" : MessageLookupByLibrary.simpleMessage("Свопы по этому ордеру не запускались"),
    "makerDetailsPrice" : MessageLookupByLibrary.simpleMessage("Цена"),
    "makerDetailsSell" : MessageLookupByLibrary.simpleMessage("Продать"),
    "makerDetailsSwaps" : MessageLookupByLibrary.simpleMessage("Свопы начатые по этому ордеру"),
    "makerDetailsTitle" : MessageLookupByLibrary.simpleMessage("Подробности ордера Мейкера"),
    ...
    "matchExportPass" : MessageLookupByLibrary.simpleMessage("Пароли должны совпадать"),
    ...
    "maxOrder" : MessageLookupByLibrary.simpleMessage("Максимальный размер ордера"),
    ...
    "mergedValue" : MessageLookupByLibrary.simpleMessage("Объединенное значение:"),
    "milliseconds" : MessageLookupByLibrary.simpleMessage("мс"),
    "min" : MessageLookupByLibrary.simpleMessage("МИН"),
    "minOrder" : MessageLookupByLibrary.simpleMessage("Минимальные объем ордера"),
    "minValue" : m41,
    "minValueBuy" : m42,
    "minValueOrder" : m43,
    "minValueSell" : m44,
    "minVolumeInput" : m45,
    "minVolumeIsTDH" : MessageLookupByLibrary.simpleMessage("Должно быть меньше чем сумма продажи"),
    "minVolumeTitle" : MessageLookupByLibrary.simpleMessage("Минимальное требуемое количество"),
    "minVolumeToggle" : MessageLookupByLibrary.simpleMessage("Использовать собственное минимальное количество"),
    ...
    "noArticles" : MessageLookupByLibrary.simpleMessage("Нет новостей - пожалуйста проверьте позже!"),
    "noCoinFound" : MessageLookupByLibrary.simpleMessage("Монета не найдена"),
    ...
    "noInternet" : MessageLookupByLibrary.simpleMessage("Отсутствует подключение к Интернет"),
    "noItemsToExport" : MessageLookupByLibrary.simpleMessage("Ничего не выбрано"),
    "noItemsToImport" : MessageLookupByLibrary.simpleMessage("Ничего не выбрано"),
    ...
    "noOrders" : MessageLookupByLibrary.simpleMessage("Нет ордеров, пожалуйста перейдите в торговлю."),
    ...
    "nonNumericInput" : MessageLookupByLibrary.simpleMessage("Значение должно быть указано в цифрах"),
    "notEnoughGas" : m52,
    ...
    "noteOnOrder" : MessageLookupByLibrary.simpleMessage("Замечание: Выбранный ордер не может быть снова отменен"),
    "notePlaceholder" : MessageLookupByLibrary.simpleMessage("Добавить заметку"),
    ...
    "oldLogsUsed" : MessageLookupByLibrary.simpleMessage("Использовано места"),
    "openMessage" : MessageLookupByLibrary.simpleMessage("Открыть сообщение об ошибке"),
    "orderCancel" : m59,
    ...
    "orderTypeUnknown" : MessageLookupByLibrary.simpleMessage("Неизвестный тип ордера"),
    ...
    "paidFromBalance" : MessageLookupByLibrary.simpleMessage("Оплачено с баланса:"),
    "paidFromVolume" : MessageLookupByLibrary.simpleMessage("Оплачено с полученного объема:"),
    "paidWith" : MessageLookupByLibrary.simpleMessage("Оплачено c"),
    "passwordRequirement" : MessageLookupByLibrary.simpleMessage("Пароль должен содержать не менее 12 символов, включая один строчный, один заглавный и один специальный символ."),
    "paymentUriDetailsAccept" : MessageLookupByLibrary.simpleMessage("Оплата"),
    "paymentUriDetailsAcceptQuestion" : MessageLookupByLibrary.simpleMessage("Вы подтверждаете эту транзакцию?"),
    "paymentUriDetailsAddressSpan" : MessageLookupByLibrary.simpleMessage("На Адрес"),
    "paymentUriDetailsAmountSpan" : MessageLookupByLibrary.simpleMessage("Остаток:"),
    "paymentUriDetailsCoinSpan" : MessageLookupByLibrary.simpleMessage("Монета:"),
    "paymentUriDetailsDeny" : MessageLookupByLibrary.simpleMessage("Отмена:"),
    "paymentUriDetailsTitle" : MessageLookupByLibrary.simpleMessage("Оплата запрошена"),
    "paymentUriInactiveCoin" : m66,
    "placeOrder" : MessageLookupByLibrary.simpleMessage("Разместить ордер"),
    "pleaseAddCoin" : MessageLookupByLibrary.simpleMessage("Пожалуйста добавьте монету"),
    "pleaseRestart" : MessageLookupByLibrary.simpleMessage("Пожалуйста перезапустите приложение чтобы попробовать снова или нажмите на кнопку ниже."),
    "portfolio" : MessageLookupByLibrary.simpleMessage("Портфолио"),
    "poweredOnKmd" : MessageLookupByLibrary.simpleMessage("Разработано Komodo"),
    ...
    "retryActivating" : MessageLookupByLibrary.simpleMessage("Попытка активации всех монет..."),
    "retryAll" : MessageLookupByLibrary.simpleMessage("Попытка активации всего"),
    "rewardsButton" : MessageLookupByLibrary.simpleMessage("Забрать вашу награду"),
    ...
    "saveMerged" : MessageLookupByLibrary.simpleMessage("Сохранить объединенные"),
    "searchFilterCoin" : MessageLookupByLibrary.simpleMessage("Поиск монеты"),
    "searchFilterSubtitleAVX" : MessageLookupByLibrary.simpleMessage("Выбрать все Avax токены"),
    "searchFilterSubtitleBEP" : MessageLookupByLibrary.simpleMessage("Выбрать все BEP токены"),
    "searchFilterSubtitleERC" : MessageLookupByLibrary.simpleMessage("Выбрать все ERC токены"),
    "searchFilterSubtitleETC" : MessageLookupByLibrary.simpleMessage("Выбрать все ETC токены"),
    "searchFilterSubtitleFTM" : MessageLookupByLibrary.simpleMessage("Выбрать все Fantom токены"),
    "searchFilterSubtitleHCO" : MessageLookupByLibrary.simpleMessage("Выбрать все HecoChain токены"),
    "searchFilterSubtitleHRC" : MessageLookupByLibrary.simpleMessage("Выбрать все Harmony токены"),
    "searchFilterSubtitleKRC" : MessageLookupByLibrary.simpleMessage("Выбрать все Kucoin токены"),
    "searchFilterSubtitleMVR" : MessageLookupByLibrary.simpleMessage("Выбрать все Moonriver токены"),
    "searchFilterSubtitlePLG" : MessageLookupByLibrary.simpleMessage("Выбрать все Polygon токены"),
    "searchFilterSubtitleQRC" : MessageLookupByLibrary.simpleMessage("Выбрать все QRC токены"),
    "searchFilterSubtitleSBCH" : MessageLookupByLibrary.simpleMessage("Выбрать все SmartBCH токены"),
    "searchFilterSubtitleSmartChain" : MessageLookupByLibrary.simpleMessage("Выбрать все Smartchain"),
    "searchFilterSubtitleTestCoins" : MessageLookupByLibrary.simpleMessage("Выбрать все Тестовые Активы"),
    "searchFilterSubtitleUBQ" : MessageLookupByLibrary.simpleMessage("Выбрать все Ubiq монеты"),
    ...
    "seeOrders" : m76,
    "seeTxHistory" : MessageLookupByLibrary.simpleMessage("Показать историю транзакций"),
    ...
    "selectFileImport" : MessageLookupByLibrary.simpleMessage("Выбрать файл"),
    ...
    "selectedOrder" : MessageLookupByLibrary.simpleMessage("Выбранный ордер:"),
    "sell" : MessageLookupByLibrary.simpleMessage("Продать"),
    "sellTestCoinWarning" : MessageLookupByLibrary.simpleMessage("Внимание, вы пытаетесь продать тестовые монеты БЕЗ РЕАЛЬНОЙ стоимости."),
    ...
    "simpleTradeActivate" : MessageLookupByLibrary.simpleMessage("Активировать"),
    ...
    "simpleTradeShowMore" : MessageLookupByLibrary.simpleMessage("Показать больше"),
    ...
    "soundSettingsTitle" : MessageLookupByLibrary.simpleMessage("Настройки звука"),
    "soundsDialogTitle" : MessageLookupByLibrary.simpleMessage("Звуки"),
    "soundsDoNotShowAgain" : MessageLookupByLibrary.simpleMessage("Я понимаю, больше это не показывать"),
    "soundsExplanation" : MessageLookupByLibrary.simpleMessage("Вы будете слышать звуковые уведомления во время процесса обмена и при размещении активного ордера.\nДля успешной торговли, протокол Atomic swaps требует чтобы участники были онлайн и звуковые уведомления помогают достичь этого."),
    "soundsNote" : MessageLookupByLibrary.simpleMessage("Обратите внимание что вы можете установить свои собственные звуки в настройках приложения."),
    ...
    "swapProgress" : MessageLookupByLibrary.simpleMessage("Детали прогресса"),
    ...
    "tooManyAssetsEnabledSpan1" : MessageLookupByLibrary.simpleMessage("У вас имеются"),
    "tooManyAssetsEnabledSpan2" : MessageLookupByLibrary.simpleMessage("включенные активы. Максимальный предел включенных активов"),
    "tooManyAssetsEnabledSpan3" : MessageLookupByLibrary.simpleMessage(". Пожалуйста, отключите некоторые из них перед добавлением новых."),
    "tooManyAssetsEnabledTitle" : MessageLookupByLibrary.simpleMessage("Подключено слишком много активов"),
    ...
    "tradePreimageError" : MessageLookupByLibrary.simpleMessage("Ошибка при расчете торговой комиссии"),
    ...
    "tryRestarting" : MessageLookupByLibrary.simpleMessage("даже если после этого некоторые монеты все еще не активированы, попробуйте перезапустить приложение."),
    ...
    "unlockSuccess" : m90,
    "unspendable" : MessageLookupByLibrary.simpleMessage("неизрасходованный"),
    ...
    "uriInsufficientBalanceSpan1" : MessageLookupByLibrary.simpleMessage("Недостаточно баланса для отсканированного"),
    "uriInsufficientBalanceSpan2" : MessageLookupByLibrary.simpleMessage("платежного запроса."),
    "uriInsufficientBalanceTitle" : MessageLookupByLibrary.simpleMessage("Недостаточный баланс"),
    "value" : MessageLookupByLibrary.simpleMessage("Стоимость:"),
    "version" : MessageLookupByLibrary.simpleMessage("версия"),
    "viewInExplorerButton" : MessageLookupByLibrary.simpleMessage("Обозреватель"),
    "viewSeedAndKeys" : MessageLookupByLibrary.simpleMessage("Seed & Приватные ключи"),
    "volumes" : MessageLookupByLibrary.simpleMessage("Объемы"),
    "walletInUse" : MessageLookupByLibrary.simpleMessage("Имя кошелька уже используется"),
    "walletMaxChar" : MessageLookupByLibrary.simpleMessage("Имя кошелька не должно превышать 40 символов"),
    ...
    "willBeRedirected" : MessageLookupByLibrary.simpleMessage("По завершении вы будете перенаправлены на страницу портфолио."),
    "withdraw" : MessageLookupByLibrary.simpleMessage("Вывести"),
    "withdrawCameraAccessText" : m97,
    "withdrawCameraAccessTitle" : MessageLookupByLibrary.simpleMessage("Доступ запрещен"),
    "withdrawConfirm" : MessageLookupByLibrary.simpleMessage("Подтвердите вывод"),
    "withdrawConfirmError" : MessageLookupByLibrary.simpleMessage("Что-то пошло не так. Попробуйте позже."),
    "withdrawValue" : m98,
    "wrongCoinSpan1" : MessageLookupByLibrary.simpleMessage("Вы пытаетесь сканировать QR code для оплаты"),
    "wrongCoinSpan2" : MessageLookupByLibrary.simpleMessage("но вы сейчас находитесь"),
    "wrongCoinSpan3" : MessageLookupByLibrary.simpleMessage("на экране вывода"),
    "wrongCoinTitle" : MessageLookupByLibrary.simpleMessage("Некорректная монета"),
    "wrongPassword" : MessageLookupByLibrary.simpleMessage("Пароли не совпадают. Пожалуйста, попробуйте еще раз."),
    "yes" : MessageLookupByLibrary.simpleMessage("Да"),
    "you have a fresh order that is trying to match with an existing order" : MessageLookupByLibrary.simpleMessage("есть новый ордер, который совпадает с вашим размещенным ордером"),
    "you have an active swap in progress" : MessageLookupByLibrary.simpleMessage("у вас уже есть активный своп в процессе"),
