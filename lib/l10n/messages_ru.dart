...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m88(coin, amount) => "Баланс ${coin} недостаточен для оплаты комиссии за транзакцию. ${coin} {сумма} требуется.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "makerDetailsFor" : MessageLookupByLibrary.simpleMessage("Получено"),
    ...
    "noOrders" : MessageLookupByLibrary.simpleMessage("Нет ордерова, пожалуйста перейдите в торговлю."),
