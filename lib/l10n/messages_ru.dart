...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m9(seconde) => "Поиск сделки в процессе, пожалуйста , подождите ${seconde} секунд!";

  static m1(index) => "Введите ${index} слово";

  static m2(index) => "Какое ${index} слово в вашей seed-фразе?";
  ...
  static m3(coinName) => "Пожалуйста, введите сумму ${coinName}.";

  static m4(assets) => "${assets} Активов";

  static m5(amount) => "Нажмите, чтобы увидеть ${amount} ордеров";

  static m6(coinName, address) => "Мой ${coinName} адрес: ${address}";

  static m7(amount, coinName) => "ВЫВЕСТИ ${amount} ${coinName}";

  static m8(amount, coin) => "Вы получите ${amount} ${coin}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "allowCustomSeed" : MessageLookupByLibrary.simpleMessage("Разрешить произвольную seed-фразу"),
    ...
    "availableVolume" : MessageLookupByLibrary.simpleMessage("максимальный объем"),
    ...
    "checkSeedPhraseInfo" : MessageLookupByLibrary.simpleMessage("Ваша seed-фраза необходима для доступа к кошельку - поэтому мы хотим убедиться, что она правильная. Мы зададим вам три разных вопроса о вашей seed-фразе, чтобы убедиться, что вы сможете легко восстановить свой кошелек, когда захотите."),
    "checkSeedPhraseSubtile" : m2,
    "checkSeedPhraseTitle" : MessageLookupByLibrary.simpleMessage("ДАВАЙТЕ ПЕРЕПРОВЕРИМ ВАШУ SEED-ФРАЗУ"),
    ...
    "clipboard" : MessageLookupByLibrary.simpleMessage("Скопировано в буфер обмена"),
    "clipboardCopy" : MessageLookupByLibrary.simpleMessage("Скопировать в буфер обмена"),
    ...
    "confirmSeed" : MessageLookupByLibrary.simpleMessage("Подтвердите seed-фразу"),
    "confirmeula" : MessageLookupByLibrary.simpleMessage("Нажимая кнопки ниже, вы подтверждаете, что прочитали «EULA» и «Условия и положения» и принимаете их"),
    ...
    "errorNotAValidAddress" : MessageLookupByLibrary.simpleMessage("Неверный адрес"),
    ...
    "hintEnterSeedPhrase" : MessageLookupByLibrary.simpleMessage("Введите свою seed-фразу"),
    ...
    "seeOrders" : m5,
    "seedPhraseTitle" : MessageLookupByLibrary.simpleMessage("Ваша новая seed-фраза"),
    ...
    "settingDialogSpan4" : MessageLookupByLibrary.simpleMessage(" записали свою seed-фразу."),
    ...
    "signInWithSeedPhrase" : MessageLookupByLibrary.simpleMessage("Войти с помощью seed-фразы"),
    ...
    "viewSeed" : MessageLookupByLibrary.simpleMessage("Посмотреть seed-фразу"),
