...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName}은(는) Android 및 iPhone의 모바일과 <a href=\"https://piratechain.com/\">Windows, Mac 및 Linux 운영 체제</a>의 데스크톱에서 사용할 수 있습니다.";
  ...
  static m10(appName) =>
      "각 스왑의 처리 시간은 몇 가지 요인에 의해 결정됩니다. 거래되는 자산의 블록 시간은 네트워크마다 다릅니다(보통 비트코인이 가장 느립니다). 게다가 사용자는 보안 설정을 커스터마이징 할 수 있습니다. 예를 들어 3번의 확인 후 ${appName}에게 ARRR 트랜잭션을 최종적으로 고려하도록 요구할 수 있습니다, 이는 <a href=\"https://piratechain.com/faq/\">공증</a>을 기다리는 것보다 스와프 시간이 짧아집니다.";
  ...
  static m15(appName) =>
      "전적으로! 자세한 내용은 <a href=\"https://piratechain.com/faq/\">개발자 문서</a>를 참조하거나 파트너십 문의 사항이 있는 경우 문의해 주세요. 특정 기술 질문이 있습니까? ${appName} 개발자 커뮤니티는 항상 도울 준비가 되어 있습니다!";
