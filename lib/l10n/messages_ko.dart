...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m10(appName) =>
      "각 스왑의 처리 시간은 몇 가지 요인에 의해 결정됩니다. 거래되는 자산의 블록 시간은 네트워크마다 다릅니다(보통 비트코인이 가장 느립니다). 게다가 사용자는 보안 설정을 커스터마이징 할 수 있습니다. 예를 들어 3번의 확인 후 ${appName}에게 KMD 트랜잭션을 최종적으로 고려하도록 요구할 수 있습니다, 이는 <a href=\"https://piratechain.com/faq/\">공증</a>을 기다리는 것보다 스와프 시간이 짧아집니다.";
