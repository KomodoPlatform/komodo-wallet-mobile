...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m11(appName) =>
      "당연합니다! 당신은 <a href=\"https://developers.atomicdex.io/\">개발자 문서</a>를 읽어서 더욱 더 많은 정보를 얻고 저희에게 파트너십에 대해서 문의를 할 수 있습니다. 특정 기술적 질문이 있으신가요? ${appName}의 개발자 커뮤니티는 항상 도움을 줄 준비가 되어있습니다!";
