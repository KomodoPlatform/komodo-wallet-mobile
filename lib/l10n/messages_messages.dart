...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(name) => "Activated ${name} successfully !";
  ...
  static m4(appName) => "${appName} is available for mobile on both Android and iPhone, and for desktop on Windows, Mac, and Linux operating systems.";

  static m5(appName) => "Other DEXs generally only allow you to trade assets that are based on a single blockchain network, use proxy tokens, and only allow placing a single order with the same funds.\n\n${appName} enables you to natively trade across two different blockchain networks without proxy tokens. You can also place multiple orders with the same funds. For example, you can sell 0.1 BTC for KMD, QTUM, or VRSC — the first order that fills automatically cancels all other orders.";

  static m6(appName) => "Several factors determine the processing time for each swap. The block time of the traded assets depends on each network (Bitcoin typically being the slowest) Additionally, the user can customize security preferences. For example, you can ask ${appName} to consider a KMD transaction as final after just 3 confirmations which makes the swap time shorter compared to waiting for a <a href=\"https://komodoplatform.com/security-delayed-proof-of-work-dpow/\">notarization</a>.";

  static m7(appName) => "There are two fee categories to consider when trading on ${appName}.\n\n1. ${appName} charges approximately 0.13% (1/777 of trading volume but not lower than 0.0001) as the trading fee for taker orders, and maker orders have zero fees.\n\n2. Both makers and takers will need to pay normal network fees to the involved blockchains when making atomic swap transactions.\n\nNetwork fees can vary greatly depending on your selected trading pair.";

  static m8(name, link, appName, appCompanyShort) => "Yes! ${appName} offers support through the <a href=\"${link}\">${appCompanyShort} ${name}</a>. The team and the community are always happy to help!";

  static m9(appName) => "No! ${appName} is fully decentralized. It is not possible to limit user access by any third party.";

  static m10(appName, appCompanyShort) => "${appName} is developed by the ${appCompanyShort} team. ${appCompanyShort} is one of the most established blockchain projects working on innovative solutions like atomic swaps, Delayed Proof of Work, and an interoperable multi-chain architecture.";
  ...
  static m15(index) => "Enter the ${index} word";

  static m16(index) => "What is the ${index} word in your seed phrase?";

  static m17(name) => "Are you sure you want to delete contact ${name}?";

  static m18(iUnderstand) => "Custom seed phrases might be less secure and easier to crack than a generated BIP39 compliant seed phrase or private key (WIF). To confirm you understand the risk and know what you are doing, type \"${iUnderstand}\" in the box below.";

  static m19(abbr) => "Input ${abbr} address";

  static m20(gas) => "Not enough gas - use at least ${gas} Gwei";
  ...
  static m35(coin) => "Sending request to ${coin} faucet...";

  static m36(appCompanyShort) => "${appCompanyShort} news";

  static m37(coin) => "${coin} fee";

  static m38(coin) => "Please activate ${coin}.";

  static m39(abbr) => "${abbr} balance not sufficient to pay trading fee";

  static m40(coinAbbr) => "${coinAbbr} is unavailable :(";

  static m41(coinName, number) => "The minimum amount to sell is ${number} ${coinName}";

  static m42(coinName, number) => "The minimum amount to buy is ${number} ${coinName}";

  static m43(buyCoin, buyAmount, sellCoin, sellAmount) => "Order minimum amount is ${buyAmount} ${buyCoin}\n(${sellAmount} ${sellCoin})";

  static m44(coinName, number) => "The minimum amount to sell is ${number} ${coinName}";
  ...
  static m49(coin) => "${coin} balance is too low";

  static m50(coin, fee) => "Not enough ${coin} to pay fees. MIN balance is ${fee} ${coin}";

  static m51(coinName) => "Please enter the ${coinName} amount.";

  static m52(coin) => "Not enough ${coin} for transaction!";

  static m53(sell, buy) => "${sell}/${buy} swap was completed successfully";

  static m54(sell, buy) => "${sell}/${buy} swap failed";

  static m55(sell, buy) => "${sell}/${buy} swap started";
  ...
  static m59(coin) => "All ${coin} orders will be canceled.";

  static m60(delta) => "Expedient: CEX +${delta}%";

  static m61(delta) => "Expensive: CEX ${delta}%";

  static m62(fill) => "${fill}% filled";

  static m63(coin) => "Amt. (${coin})";

  static m64(coin) => "Price (${coin})";

  static m65(coin) => "Total (${coin})";

  static m66(abbr) => "${abbr} is not active. Please activate and try again.";

  static m67(appName) => "Which devices can I use ${appName} on?";

  static m68(appName) => "How is trading on ${appName} different from trading on other DEXs?";

  static m69(appName) => "How are the fees on ${appName} calculated?";

  static m70(appName) => "Who is behind ${appName}?";

  static m71(appName) => "Is it possible to develop my own white-label exchange on ${appName}?";

  static m72(amount) => "Success! ${amount} KMD received.";

  static m73(dd) => "${dd} day(s)";

  static m74(hh, minutes) => "${hh}h ${minutes}m";

  static m75(mm) => "${mm}min";

  static m76(amount) => "Click to see ${amount} orders";

  static m77(coinName, address) => "My ${coinName} address: \n${address}";

  static m78(coin) => "Please enter ${coin} amount to buy";

  static m79(maxCoins) => "Max active coins number is ${maxCoins}. Please deactivate some.";

  static m80(coin) => "${coin} is not active!";

  static m81(coin) => "Please enter ${coin} amount to sell";

  static m82(coin) => "Unable to activate ${coin}";

  static m83(description) => "Pick an mp3 or wav file please. We\'ll play it when ${description}.";
  ...
  static m87(coin) => "${coin} balance not sufficient to pay transaction fees.";

  static m88(coin, amount) => "${coin} balance not sufficient to pay transaction fees. ${coin} ${amount} required.";

  static m89(left) => "Transactions Left: ${left}";

  static m90(amnt, hash) => "Successfully unlocked ${amnt} funds - TX: ${hash}";

  static m91(version) => "You are using version ${version}";

  static m92(version) => "Version ${version} available. Please update.";

  static m93(appName) => "${appName} update";

  static m94(coinAbbr) => "We failed to activate ${coinAbbr}";

  static m95(coinAbbr) => "We failed to activate ${coinAbbr}.\nPlease restart the app to try again.";

  static m96(appName) => "${appName} mobile is a next generation multi-coin wallet with native third generation DEX functionality and more.";

  static m97(appName) => "You have previously denied ${appName} access to the camera.\nPlease manually change camera permission in your phone settings to proceed with the QR code scan.";

  static m98(amount, coinName) => "WITHDRAW ${amount} ${coinName}";

  static m99(amount, coin) => "You will receive ${amount} ${coin}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    "Active" : MessageLookupByLibrary.simpleMessage("Active"),
    "Applause" : MessageLookupByLibrary.simpleMessage("Applause"),
    "Can\'t play that" : MessageLookupByLibrary.simpleMessage("Can\'t play that"),
    "Failed" : MessageLookupByLibrary.simpleMessage("Failed"),
    "Maker" : MessageLookupByLibrary.simpleMessage("Maker"),
    "Play at full volume" : MessageLookupByLibrary.simpleMessage("Play at full volume"),
    ...
    "a swap runs to completion" : MessageLookupByLibrary.simpleMessage("a swap runs to completion"),
    "accepteula" : MessageLookupByLibrary.simpleMessage("Accept EULA"),
    "accepttac" : MessageLookupByLibrary.simpleMessage("Accept TERMS and CONDITIONS"),
    "activateAccessBiometric" : MessageLookupByLibrary.simpleMessage("Activate Biometric protection"),
    "activateAccessPin" : MessageLookupByLibrary.simpleMessage("Activate PIN protection"),
    ...
    "addressBookEmpty" : MessageLookupByLibrary.simpleMessage("Address book is empty"),
    "addressBookFilter" : m1,
    "addressBookTitle" : MessageLookupByLibrary.simpleMessage("Address Book"),
    "addressCoinInactive" : m2,
    "addressNotFound" : MessageLookupByLibrary.simpleMessage("Nothing found"),
    "addressSelectCoin" : MessageLookupByLibrary.simpleMessage("Select Coin"),
    "addressSend" : MessageLookupByLibrary.simpleMessage("Recipients address"),
    "advanced" : MessageLookupByLibrary.simpleMessage("Advanced"),
    "all" : MessageLookupByLibrary.simpleMessage("All"),
    "allowCustomSeed" : MessageLookupByLibrary.simpleMessage("Allow custom seed"),
    ...
    "automaticRedirected" : MessageLookupByLibrary.simpleMessage("You will be automatically redirected to portfolio page when the retry activation process completes."),
    ...
    "camoPinSaved" : MessageLookupByLibrary.simpleMessage("Camouflage PIN saved"),
    "camoPinTitle" : MessageLookupByLibrary.simpleMessage("Camouflage PIN"),
    "camoSetupSubtitle" : MessageLookupByLibrary.simpleMessage("Enter new Camouflage PIN"),
    "camoSetupTitle" : MessageLookupByLibrary.simpleMessage("Camouflage PIN Setup"),
    "camouflageSetup" : MessageLookupByLibrary.simpleMessage("Camouflage PIN Setup"),
    "cancel" : MessageLookupByLibrary.simpleMessage("Cancel"),
    "cancelButton" : MessageLookupByLibrary.simpleMessage("Cancel"),
    "cancelOrder" : MessageLookupByLibrary.simpleMessage("Cancel Order"),
    "candleChartError" : MessageLookupByLibrary.simpleMessage("Something went wrong. Try again later."),
    "cantDeleteDefaultCoinOk" : MessageLookupByLibrary.simpleMessage("Ok"),
    "cantDeleteDefaultCoinSpan" : MessageLookupByLibrary.simpleMessage(" is a default coin. Default coins can\'t be disabled."),
    "cantDeleteDefaultCoinTitle" : MessageLookupByLibrary.simpleMessage("Can\'t disable "),
    ...
    "checkSeedPhrase" : MessageLookupByLibrary.simpleMessage("Check seed phrase"),
    "checkSeedPhraseButton1" : MessageLookupByLibrary.simpleMessage("CONTINUE"),
    "checkSeedPhraseButton2" : MessageLookupByLibrary.simpleMessage("GO BACK AND CHECK AGAIN"),
    "checkSeedPhraseHint" : m15,
    "checkSeedPhraseInfo" : MessageLookupByLibrary.simpleMessage("Your seed phrase is important - that\'s why we like to make sure it\'s correct. We\'ll ask you three different questions about your seed phrase to make sure you\'ll be able to easily restore your wallet whenever you want."),
    "checkSeedPhraseSubtile" : m16,
    "checkSeedPhraseTitle" : MessageLookupByLibrary.simpleMessage("LET\'S DOUBLE CHECK YOUR SEED PHRASE"),
    "chineseLanguage" : MessageLookupByLibrary.simpleMessage("Chinese"),
    "claim" : MessageLookupByLibrary.simpleMessage("claim"),
    "claimTitle" : MessageLookupByLibrary.simpleMessage("Claim your KMD reward?"),
    "clickToSee" : MessageLookupByLibrary.simpleMessage("Click to see "),
    "clipboard" : MessageLookupByLibrary.simpleMessage("Copied to the clipboard"),
    "clipboardCopy" : MessageLookupByLibrary.simpleMessage("Copy to clipboard"),
    "close" : MessageLookupByLibrary.simpleMessage("Close"),
    "closeMessage" : MessageLookupByLibrary.simpleMessage("Close Error Message"),
    ...
    "coinSelectNotFound" : MessageLookupByLibrary.simpleMessage("No active coins"),
    "coinSelectTitle" : MessageLookupByLibrary.simpleMessage("Select Coin"),
    "comingSoon" : MessageLookupByLibrary.simpleMessage("Coming soon..."),
    "commingsoon" : MessageLookupByLibrary.simpleMessage("TX details coming soon!"),
    "commingsoonGeneral" : MessageLookupByLibrary.simpleMessage("Details coming soon!"),
    "commissionFee" : MessageLookupByLibrary.simpleMessage("commission fee"),
    "comparedToCex" : MessageLookupByLibrary.simpleMessage("compared to CEX"),
    "configureWallet" : MessageLookupByLibrary.simpleMessage("Configuring your wallet, please wait..."),
    "confirm" : MessageLookupByLibrary.simpleMessage("Confirm"),
    "confirmCamouflageSetup" : MessageLookupByLibrary.simpleMessage("Confirm Camouflage PIN"),
    "confirmCancel" : MessageLookupByLibrary.simpleMessage("Are you sure you want to cancel the order"),
    ...
    "contactExitWarning" : MessageLookupByLibrary.simpleMessage("Discard your changes?"),
    "contactNotFound" : MessageLookupByLibrary.simpleMessage("No contacts found"),
    ...
    "couldntImportError" : MessageLookupByLibrary.simpleMessage("Couldn\'t import: "),
    "create" : MessageLookupByLibrary.simpleMessage("trade"),
    "createAWallet" : MessageLookupByLibrary.simpleMessage("CREATE A WALLET"),
    ...
    "customFeeWarning" : MessageLookupByLibrary.simpleMessage("Only use custom fees if you know what you are doing!"),
    "customSeedWarning" : m18,
    "dPow" : MessageLookupByLibrary.simpleMessage("Komodo dPoW security"),
    "date" : MessageLookupByLibrary.simpleMessage("Date"),
    "decryptingWallet" : MessageLookupByLibrary.simpleMessage("Decrypting wallet"),
    "delete" : MessageLookupByLibrary.simpleMessage("Delete"),
    "deleteConfirm" : MessageLookupByLibrary.simpleMessage("Confirm deactivation"),
    "deleteSpan1" : MessageLookupByLibrary.simpleMessage("Do you want to remove "),
    "deleteSpan2" : MessageLookupByLibrary.simpleMessage(" from your portfolio? All unmatched orders will be canceled."),
    ...
    "dexIsNotAvailable" : MessageLookupByLibrary.simpleMessage("DEX is not available for this coin"),
    ...
    "dontWantPassword" : MessageLookupByLibrary.simpleMessage("I don\'t want a password"),
    "duration" : MessageLookupByLibrary.simpleMessage("Duration"),
    "editContact" : MessageLookupByLibrary.simpleMessage("Edit Contact"),
    "emptyCoin" : m19,
    "emptyExportPass" : MessageLookupByLibrary.simpleMessage("Encryption password can\'t be empty"),
    "emptyImportPass" : MessageLookupByLibrary.simpleMessage("Password can\'t be empty"),
    "emptyName" : MessageLookupByLibrary.simpleMessage("Contact name cannot be empty"),
    ...
    "enterNewPinCode" : MessageLookupByLibrary.simpleMessage("Enter your new PIN"),
    "enterOldPinCode" : MessageLookupByLibrary.simpleMessage("Enter your old PIN"),
    ...
    "enterSellAmount" : MessageLookupByLibrary.simpleMessage("You must enter Sell Amount first"),
    "enterpassword" : MessageLookupByLibrary.simpleMessage("Please enter your password to continue."),
    "errorAmountBalance" : MessageLookupByLibrary.simpleMessage("Not enough balance"),
    "errorNotAValidAddress" : MessageLookupByLibrary.simpleMessage("Not a valid address"),
    "errorNotAValidAddressSegWit" : MessageLookupByLibrary.simpleMessage("Segwit addresses are not supported (yet)"),
    ...
    "errorValueNotEmpty" : MessageLookupByLibrary.simpleMessage("Please input data"),
    ...
    "exampleHintSeed" : MessageLookupByLibrary.simpleMessage("Example: build case level ..."),
    ...
    "exchangeIdentical" : MessageLookupByLibrary.simpleMessage("Identical to CEX"),
    ...
    "fakeBalanceAmt" : MessageLookupByLibrary.simpleMessage("Fake balance amount:"),
    ...
    "faucetTimedOut" : MessageLookupByLibrary.simpleMessage("Request timed out"),
    ...
    "feedUnableToProceed" : MessageLookupByLibrary.simpleMessage("Unable to proceed news update"),
    "feedUnableToUpdate" : MessageLookupByLibrary.simpleMessage("Unable to get news update"),
    "feedUpToDate" : MessageLookupByLibrary.simpleMessage("Already up to date"),
    "feedUpdated" : MessageLookupByLibrary.simpleMessage("News feed updated"),
    ...
    "filtersClearAll" : MessageLookupByLibrary.simpleMessage("Clear all filters"),
    ...
    "getBackupPhrase" : MessageLookupByLibrary.simpleMessage("Important: Back up your seed phrase before proceeding!"),
    ...
    "hintConfirmPassword" : MessageLookupByLibrary.simpleMessage("Confirm Password"),
    "hintCreatePassword" : MessageLookupByLibrary.simpleMessage("Create Password"),
    "hintCurrentPassword" : MessageLookupByLibrary.simpleMessage("Current password"),
    "hintEnterPassword" : MessageLookupByLibrary.simpleMessage("Enter your password"),
    "hintEnterSeedPhrase" : MessageLookupByLibrary.simpleMessage("Enter your seed phrase"),
    "hintNameYourWallet" : MessageLookupByLibrary.simpleMessage("Name your wallet"),
    ...
    "importDecryptError" : MessageLookupByLibrary.simpleMessage("Invalid password or corrupted data"),
    "importDesc" : MessageLookupByLibrary.simpleMessage("Items to be imported:"),
    ...
    "importSingleSwapLink" : MessageLookupByLibrary.simpleMessage("Import Single Swap"),
    "importSingleSwapTitle" : MessageLookupByLibrary.simpleMessage("Import Swap"),
    "importSomeItemsSkippedWarning" : MessageLookupByLibrary.simpleMessage("Some items have been skipped"),
    "importSuccessTitle" : MessageLookupByLibrary.simpleMessage("Items have been successfully imported:"),
    "importSwapFailed" : MessageLookupByLibrary.simpleMessage("Failed to import swap"),
    "importSwapJsonDecodingError" : MessageLookupByLibrary.simpleMessage("Error decoding json file"),
    ...
    "latestTxs" : MessageLookupByLibrary.simpleMessage("Latest Transactions"),
    "legalTitle" : MessageLookupByLibrary.simpleMessage("Legal"),
    "less" : MessageLookupByLibrary.simpleMessage("Less"),
    "loading" : MessageLookupByLibrary.simpleMessage("Loading..."),
    "loadingOrderbook" : MessageLookupByLibrary.simpleMessage("Loading orderbook..."),
    "lockScreen" : MessageLookupByLibrary.simpleMessage("Screen is locked"),
    "lockScreenAuth" : MessageLookupByLibrary.simpleMessage("Please authenticate!"),
    "login" : MessageLookupByLibrary.simpleMessage("login"),
    "logout" : MessageLookupByLibrary.simpleMessage("Log Out"),
    "logoutOnExit" : MessageLookupByLibrary.simpleMessage("Log Out on Exit"),
    "logoutWarning" : MessageLookupByLibrary.simpleMessage("Are you sure you want to logout now?"),
    "logoutsettings" : MessageLookupByLibrary.simpleMessage("Log Out Settings"),
    "longMinutes" : MessageLookupByLibrary.simpleMessage("minutes"),
    "makeAorder" : MessageLookupByLibrary.simpleMessage("make an order"),
    "makerDetailsCancel" : MessageLookupByLibrary.simpleMessage("Cancel order"),
    ...
    "makerDetailsTitle" : MessageLookupByLibrary.simpleMessage("Maker Order details"),
    ...
    "marketsOrderDetails" : MessageLookupByLibrary.simpleMessage("Order Details"),
    "marketsOrderbook" : MessageLookupByLibrary.simpleMessage("ORDER BOOK"),
    "marketsPrice" : MessageLookupByLibrary.simpleMessage("PRICE"),
    "marketsSelectCoins" : MessageLookupByLibrary.simpleMessage("Please select coins"),
    "marketsTab" : MessageLookupByLibrary.simpleMessage("Markets"),
    "marketsTitle" : MessageLookupByLibrary.simpleMessage("MARKETS"),
    "matchExportPass" : MessageLookupByLibrary.simpleMessage("Passwords must match"),
    "matchingCamoChange" : MessageLookupByLibrary.simpleMessage("Change"),
    "matchingCamoPinError" : MessageLookupByLibrary.simpleMessage("Your general PIN and Camouflage PIN are the same.\nCamouflage mode will not be available.\nPlease change Camouflage PIN."),
    "matchingCamoTitle" : MessageLookupByLibrary.simpleMessage("Invalid PIN"),
    ...
    "mediaNotSavedDescription" : MessageLookupByLibrary.simpleMessage("YOU HAVE NO SAVED ARTICLES"),
    ...
    "minValueSell" : m44,
    "minVolumeInput" : m45,
    "minVolumeIsTDH" : MessageLookupByLibrary.simpleMessage("Must be lower than sell amount"),
    "minVolumeTitle" : MessageLookupByLibrary.simpleMessage("Min volume required"),
    "minVolumeToggle" : MessageLookupByLibrary.simpleMessage("Use custom min volume"),
    ...
    "multiBaseAmtPlaceholder" : MessageLookupByLibrary.simpleMessage("Amount"),
    ...
    "multiFiatDesc" : MessageLookupByLibrary.simpleMessage("Please enter fiat amount to receive:"),
    "multiFiatFill" : MessageLookupByLibrary.simpleMessage("Autofill"),
    "multiFixErrors" : MessageLookupByLibrary.simpleMessage("Please fix all errors before continuing"),
    "multiInvalidAmt" : MessageLookupByLibrary.simpleMessage("Invalid amount"),
    "multiInvalidSellAmt" : MessageLookupByLibrary.simpleMessage("Invalid sell amount"),
    "multiLowGas" : m49,
    "multiLowerThanFee" : m50,
    "multiMaxSellAmt" : MessageLookupByLibrary.simpleMessage("Max sell amount is"),
    "multiMinReceiveAmt" : MessageLookupByLibrary.simpleMessage("Min receive amount is"),
    "multiMinSellAmt" : MessageLookupByLibrary.simpleMessage("Min sell amount is"),
    ...
    "noArticles" : MessageLookupByLibrary.simpleMessage("No news - please check back later!"),
    "noCoinFound" : MessageLookupByLibrary.simpleMessage("No coin found"),
    "noFunds" : MessageLookupByLibrary.simpleMessage("No funds"),
    "noFundsDetected" : MessageLookupByLibrary.simpleMessage("No funds available - please deposit."),
    "noInternet" : MessageLookupByLibrary.simpleMessage("No Internet Connection"),
    "noItemsToExport" : MessageLookupByLibrary.simpleMessage("No items selected"),
    "noItemsToImport" : MessageLookupByLibrary.simpleMessage("No items selected"),
    "noMatchingOrders" : MessageLookupByLibrary.simpleMessage("No matching orders found"),
    "noOrder" : m51,
    "noOrderAvailable" : MessageLookupByLibrary.simpleMessage("Click to create an order"),
    "noOrders" : MessageLookupByLibrary.simpleMessage("No orders, please go to trade."),
    "noRewardYet" : MessageLookupByLibrary.simpleMessage("No reward claimable - please try again in 1h."),
    "noRewards" : MessageLookupByLibrary.simpleMessage("No claimable rewards"),
    ...
    "nonNumericInput" : MessageLookupByLibrary.simpleMessage("The value must be numeric"),
    "notEnoughGas" : m52,
    "notEnoughtBalanceForFee" : MessageLookupByLibrary.simpleMessage("Not enough balance for fees - trade a smaller amount"),
    "noteOnOrder" : MessageLookupByLibrary.simpleMessage("Note: Matched order cannot be cancelled again"),
    ...
    "notifSwapCompletedTitle" : MessageLookupByLibrary.simpleMessage("Swap completed"),
    "notifSwapFailedText" : m54,
    "notifSwapFailedTitle" : MessageLookupByLibrary.simpleMessage("Swap failed"),
    "notifSwapStartedText" : m55,
    "notifSwapStartedTitle" : MessageLookupByLibrary.simpleMessage("New swap started"),
    "notifSwapStatusTitle" : MessageLookupByLibrary.simpleMessage("Swap status changed"),
    "notifSwapTimeoutText" : m56,
    "notifSwapTimeoutTitle" : MessageLookupByLibrary.simpleMessage("Swap timed out"),
    "notifTxText" : m57,
    "notifTxTitle" : MessageLookupByLibrary.simpleMessage("Incoming transaction"),
    "numberAssets" : m58,
    ...
    "openMessage" : MessageLookupByLibrary.simpleMessage("Open Error Message"),
    "orderCancel" : m59,
    "orderCreated" : MessageLookupByLibrary.simpleMessage("Order created"),
    "orderCreatedInfo" : MessageLookupByLibrary.simpleMessage("Order successfully created"),
    ...
    "orderDetailsIdentical" : MessageLookupByLibrary.simpleMessage("Identical to CEX"),
    ...
    "orderDetailsSettings" : MessageLookupByLibrary.simpleMessage("Open Details on single tap and select Order by long tap"),
    ...
    "orderTypeUnknown" : MessageLookupByLibrary.simpleMessage("Unknown Type Order"),
    ...
    "ownOrder" : MessageLookupByLibrary.simpleMessage(" This is your own order!"),
    "paidFromBalance" : MessageLookupByLibrary.simpleMessage("Paid from balance:"),
    "paidFromVolume" : MessageLookupByLibrary.simpleMessage("Paid from received volume:"),
    "paidWith" : MessageLookupByLibrary.simpleMessage("Paid with "),
    "passwordRequirement" : MessageLookupByLibrary.simpleMessage("Password must contain at least 12 characters, with one lower-case, one upper-case and one special symbol."),
    "paymentUriDetailsAccept" : MessageLookupByLibrary.simpleMessage("Pay"),
    "paymentUriDetailsAcceptQuestion" : MessageLookupByLibrary.simpleMessage("Do you accept this transaction?"),
    "paymentUriDetailsAddressSpan" : MessageLookupByLibrary.simpleMessage("To Address "),
    "paymentUriDetailsAmountSpan" : MessageLookupByLibrary.simpleMessage("Amount: "),
    ...
    "paymentUriDetailsTitle" : MessageLookupByLibrary.simpleMessage("Payment Requested"),
    "paymentUriInactiveCoin" : m66,
    "placeOrder" : MessageLookupByLibrary.simpleMessage("Place your order"),
    "pleaseAddCoin" : MessageLookupByLibrary.simpleMessage("Please Add A Coin"),
    "pleaseRestart" : MessageLookupByLibrary.simpleMessage("Please restart the app to try again, or press the button below."),
    ...
    "protectionCtrlCustom" : MessageLookupByLibrary.simpleMessage("Use custom protection settings"),
    "protectionCtrlOff" : MessageLookupByLibrary.simpleMessage("OFF"),
    "protectionCtrlOn" : MessageLookupByLibrary.simpleMessage("ON"),
    "protectionCtrlWarning" : MessageLookupByLibrary.simpleMessage("Warning, this atomic swap is not dPoW protected. "),
    "pubkey" : MessageLookupByLibrary.simpleMessage("Pubkey"),
    "question_1" : MessageLookupByLibrary.simpleMessage("Do you store my private keys?"),
    "question_10" : m67,
    "question_2" : m68,
    "question_3" : MessageLookupByLibrary.simpleMessage("How long does each atomic swap take?"),
    "question_4" : MessageLookupByLibrary.simpleMessage("Do I need to be online for the duration of the swap?"),
    "question_5" : m69,
    "question_6" : MessageLookupByLibrary.simpleMessage("Do you provide user support?"),
    "question_7" : MessageLookupByLibrary.simpleMessage("Do you have country restrictions?"),
    "question_8" : m70,
    "question_9" : m71,
    ...
    "requestedTrade" : MessageLookupByLibrary.simpleMessage("Requested Trade"),
    ...
    "retryActivating" : MessageLookupByLibrary.simpleMessage("Retrying activating all coins..."),
    "retryAll" : MessageLookupByLibrary.simpleMessage("Retry activating all"),
    "rewardsButton" : MessageLookupByLibrary.simpleMessage("Claim your rewards"),
    "rewardsCancel" : MessageLookupByLibrary.simpleMessage("Cancel"),
    "rewardsError" : MessageLookupByLibrary.simpleMessage("Something went wrong. Please try again later."),
    "rewardsInProgressLong" : MessageLookupByLibrary.simpleMessage("Transaction is in progress"),
    "rewardsInProgressShort" : MessageLookupByLibrary.simpleMessage("processing"),
    "rewardsLowAmountLong" : MessageLookupByLibrary.simpleMessage("UTXO amount less than 10 KMD"),
    "rewardsLowAmountShort" : MessageLookupByLibrary.simpleMessage("<10 KMD"),
    "rewardsOneHourLong" : MessageLookupByLibrary.simpleMessage("One hour not passed yet"),
    "rewardsOneHourShort" : MessageLookupByLibrary.simpleMessage("<1 hour"),
    "rewardsPopupOk" : MessageLookupByLibrary.simpleMessage("Ok"),
    "rewardsPopupTitle" : MessageLookupByLibrary.simpleMessage("Rewards status:"),
    "rewardsReadMore" : MessageLookupByLibrary.simpleMessage("Read more about KMD active user rewards"),
    "rewardsReceive" : MessageLookupByLibrary.simpleMessage("Receive"),
    "rewardsSuccess" : m72,
    "rewardsTableFiat" : MessageLookupByLibrary.simpleMessage("Fiat"),
    "rewardsTableRewards" : MessageLookupByLibrary.simpleMessage("Rewards,\nKMD"),
    ...
    "rewardsTableTitle" : MessageLookupByLibrary.simpleMessage("Rewards information:"),
    "rewardsTableUXTO" : MessageLookupByLibrary.simpleMessage("UTXO amt,\nKMD"),
    "rewardsTimeDays" : m73,
    "rewardsTimeHours" : m74,
    "rewardsTimeMin" : m75,
    "rewardsTitle" : MessageLookupByLibrary.simpleMessage("Rewards information"),
    "russianLanguage" : MessageLookupByLibrary.simpleMessage("Russian"),
    "saveMerged" : MessageLookupByLibrary.simpleMessage("Save merged"),
    "searchFilterCoin" : MessageLookupByLibrary.simpleMessage("Search a coin"),
    "searchFilterSubtitleAVX" : MessageLookupByLibrary.simpleMessage("Select all Avax tokens"),
    "searchFilterSubtitleBEP" : MessageLookupByLibrary.simpleMessage("Select all BEP tokens"),
    "searchFilterSubtitleERC" : MessageLookupByLibrary.simpleMessage("Select all ERC tokens"),
    "searchFilterSubtitleETC" : MessageLookupByLibrary.simpleMessage("Select all ETC tokens"),
    "searchFilterSubtitleFTM" : MessageLookupByLibrary.simpleMessage("Select all Fantom tokens"),
    "searchFilterSubtitleHCO" : MessageLookupByLibrary.simpleMessage("Select all HecoChain tokens"),
    "searchFilterSubtitleHRC" : MessageLookupByLibrary.simpleMessage("Select all Harmony tokens"),
    "searchFilterSubtitleKRC" : MessageLookupByLibrary.simpleMessage("Select all Kucoin tokens"),
    "searchFilterSubtitleMVR" : MessageLookupByLibrary.simpleMessage("Select all Moonriver tokens"),
    "searchFilterSubtitlePLG" : MessageLookupByLibrary.simpleMessage("Select all Polygon tokens"),
    "searchFilterSubtitleQRC" : MessageLookupByLibrary.simpleMessage("Select all QRC tokens"),
    "searchFilterSubtitleSBCH" : MessageLookupByLibrary.simpleMessage("Select all SmartBCH tokens"),
    "searchFilterSubtitleSmartChain" : MessageLookupByLibrary.simpleMessage("Select all SmartChains"),
    "searchFilterSubtitleTestCoins" : MessageLookupByLibrary.simpleMessage("Select all Test Assets"),
    "searchFilterSubtitleUBQ" : MessageLookupByLibrary.simpleMessage("Select all Ubiq coins"),
    "searchFilterSubtitleutxo" : MessageLookupByLibrary.simpleMessage("Select all UTXO coins"),
    "searchForTicker" : MessageLookupByLibrary.simpleMessage("Search for Ticker"),
    "seconds" : MessageLookupByLibrary.simpleMessage("s"),
    "security" : MessageLookupByLibrary.simpleMessage("Security"),
    "seeOrders" : m76,
    "seeTxHistory" : MessageLookupByLibrary.simpleMessage("View Transaction History"),
    "seedPhrase" : MessageLookupByLibrary.simpleMessage("Seed Phrase"),
    "seedPhraseTitle" : MessageLookupByLibrary.simpleMessage("Your new Seed Phrase"),
    "selectCoin" : MessageLookupByLibrary.simpleMessage("Select coin"),
    "selectCoinInfo" : MessageLookupByLibrary.simpleMessage("Select the coins you want to add to your portfolio."),
    "selectCoinTitle" : MessageLookupByLibrary.simpleMessage("Activate coins:"),
    ...
    "signInWithSeedPhrase" : MessageLookupByLibrary.simpleMessage("Forgot the password? Restore wallet from seed"),
    ...
    "simpleTradeShowLess" : MessageLookupByLibrary.simpleMessage("Show less"),
    "simpleTradeShowMore" : MessageLookupByLibrary.simpleMessage("Show more"),
    ...
    "soundSettingsTitle" : MessageLookupByLibrary.simpleMessage("Sound settings"),
    "soundsDialogTitle" : MessageLookupByLibrary.simpleMessage("Sounds"),
    "soundsDoNotShowAgain" : MessageLookupByLibrary.simpleMessage("Understood, don\'t show it anymore"),
    "soundsExplanation" : MessageLookupByLibrary.simpleMessage("You\'ll hear sound notifications during the swap process and when you have an active maker order placed.\nAtomic swaps protocol requires participants to be online for a successful trade, and sound notifications help to achieve that."),
    "soundsNote" : MessageLookupByLibrary.simpleMessage("Note that you can set your custom sounds in application settings."),
    ...
    "swapDetailTitle" : MessageLookupByLibrary.simpleMessage("CONFIRM EXCHANGE DETAILS"),
    ...
    "swapProgress" : MessageLookupByLibrary.simpleMessage("Progress details"),
    ...
    "titleCreatePassword" : MessageLookupByLibrary.simpleMessage("CREATE A PASSWORD"),
    "titleCurrentAsk" : MessageLookupByLibrary.simpleMessage("Order selected"),
    "to" : MessageLookupByLibrary.simpleMessage("To"),
    "toAddress" : MessageLookupByLibrary.simpleMessage("To address:"),
    "tooManyAssetsEnabledSpan1" : MessageLookupByLibrary.simpleMessage("You have "),
    "tooManyAssetsEnabledSpan2" : MessageLookupByLibrary.simpleMessage(" assets enabled. Enabled assets max limit is "),
    "tooManyAssetsEnabledSpan3" : MessageLookupByLibrary.simpleMessage(". Please disable some before new ones adding."),
    "tooManyAssetsEnabledTitle" : MessageLookupByLibrary.simpleMessage("Too many assets enabled"),
    "totalFees" : MessageLookupByLibrary.simpleMessage("Total Fees:"),
    "trade" : MessageLookupByLibrary.simpleMessage("TRADE"),
    "tradeCompleted" : MessageLookupByLibrary.simpleMessage("SWAP COMPLETED!"),
    ...
    "traditionalChinese" : MessageLookupByLibrary.simpleMessage("traditional"),
    ...
    "txLimitExceeded" : MessageLookupByLibrary.simpleMessage("Too many requests.\nTransactions history requests limit exceeded.\nPlease try again later."),
    ...
    "updatesAvailable" : MessageLookupByLibrary.simpleMessage("New version available"),
    "updatesChecking" : MessageLookupByLibrary.simpleMessage("Checking for updates..."),
    "updatesCurrentVersion" : m91,
    "updatesNotifAvailable" : MessageLookupByLibrary.simpleMessage("New version available. Please update."),
    "updatesNotifAvailableVersion" : m92,
    "updatesNotifTitle" : MessageLookupByLibrary.simpleMessage("Update available"),
    "updatesSkip" : MessageLookupByLibrary.simpleMessage("Skip for now"),
    "updatesTitle" : m93,
    "updatesUpToDate" : MessageLookupByLibrary.simpleMessage("Already up to date"),
    "updatesUpdate" : MessageLookupByLibrary.simpleMessage("Update"),
    "uriInsufficientBalanceSpan1" : MessageLookupByLibrary.simpleMessage("Not enough balance for scanned "),
    "uriInsufficientBalanceSpan2" : MessageLookupByLibrary.simpleMessage(" payment request."),
    "uriInsufficientBalanceTitle" : MessageLookupByLibrary.simpleMessage("Insufficient balance"),
    "value" : MessageLookupByLibrary.simpleMessage("Value: "),
    "version" : MessageLookupByLibrary.simpleMessage("version"),
    "viewInExplorerButton" : MessageLookupByLibrary.simpleMessage("Explorer"),
    "viewSeedAndKeys" : MessageLookupByLibrary.simpleMessage("Seed & Private Keys"),
    "volumes" : MessageLookupByLibrary.simpleMessage("Volumes"),
    "walletInUse" : MessageLookupByLibrary.simpleMessage("Wallet name is already in use"),
    "walletMaxChar" : MessageLookupByLibrary.simpleMessage("Wallet name must have a max of 40 characters"),
    ...
    "warningShareLogs" : MessageLookupByLibrary.simpleMessage("Warning - in special cases this log data contains sensitive information that can be used to spend coins from failed swaps!"),
    "weFailedTo" : m94,
    "weFailedToActivate" : m95,
    "welcomeInfo" : m96,
    "welcomeLetSetUp" : MessageLookupByLibrary.simpleMessage("LET\'S GET SET UP!"),
    "welcomeTitle" : MessageLookupByLibrary.simpleMessage("WELCOME"),
    "welcomeWallet" : MessageLookupByLibrary.simpleMessage("wallet"),
    "willBeRedirected" : MessageLookupByLibrary.simpleMessage("You will be redirected to portfolio page on completion."),
    "withdraw" : MessageLookupByLibrary.simpleMessage("Withdraw"),
    "withdrawCameraAccessText" : m97,
    "withdrawCameraAccessTitle" : MessageLookupByLibrary.simpleMessage("Access Denied"),
    "withdrawConfirm" : MessageLookupByLibrary.simpleMessage("Confirm Withdrawal"),
    "withdrawConfirmError" : MessageLookupByLibrary.simpleMessage("Something went wrong. Try again later."),
    "withdrawValue" : m98,
    "wrongCoinSpan1" : MessageLookupByLibrary.simpleMessage("You are trying to scan a payment QR code for "),
    "wrongCoinSpan2" : MessageLookupByLibrary.simpleMessage(" but you are on the "),
    "wrongCoinSpan3" : MessageLookupByLibrary.simpleMessage(" withdraw screen"),
    "wrongCoinTitle" : MessageLookupByLibrary.simpleMessage("Wrong coin"),
    "wrongPassword" : MessageLookupByLibrary.simpleMessage("The passwords do not match. Please try again."),
    "yes" : MessageLookupByLibrary.simpleMessage("Yes"),
    "you have a fresh order that is trying to match with an existing order" : MessageLookupByLibrary.simpleMessage("you have a fresh order that is trying to match with an existing order"),
    "you have an active swap in progress" : MessageLookupByLibrary.simpleMessage("you have an active swap in progress"),
    "you have an order that new orders can match with" : MessageLookupByLibrary.simpleMessage("you have an order that new orders can match with"),
