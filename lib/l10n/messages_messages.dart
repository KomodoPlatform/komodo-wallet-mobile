...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} is available for mobile on both Android and iPhone, and for desktop on <a href=\"https://firo.org/\">Windows, Mac, and Linux operating systems</a>.";

  static m9(appName) =>
      "Other DEXs generally only allow you to trade assets that are based on a single blockchain network, use proxy tokens, and only allow placing a single order with the same funds.\n\n${appName} enables you to natively trade across two different blockchain networks without proxy tokens. You can also place multiple orders with the same funds. For example, you can sell 0.1 BTC for FIRO, QTUM, or VRSC — the first order that fills automatically cancels all other orders.";

  static m10(appName) =>
      "Several factors determine the processing time for each swap. The block time of the traded assets depends on each network (Bitcoin typically being the slowest) Additionally, the user can customize security preferences. For example, you can ask ${appName} to consider a FIRO transaction as final after just 3 confirmations which makes the swap time shorter compared to waiting for a <a href=\"https://firo.org/\">notarization</a>.";
  ...
  static m15(appName) =>
      "Absolutely! You can read our <a href=\"https://firo.org/\">developer documentation</a> for more details or contact us with your partnership inquiries. Have a specific technical question? The ${appName} developer community is always ready to help!";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "rebrandingAnnouncement": MessageLookupByLibrary.simpleMessage(
            "It\'s a new era! We have officially rebranded from \'AtomicDEX\' to \'Firo Wallet\'"),
