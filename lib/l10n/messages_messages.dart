...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} is available for mobile on both Android and iPhone, and for desktop on <a href=\"https://piratechain.com/\">Windows, Mac, and Linux operating systems</a>.";
  ...
  static m10(appName) =>
      "Several factors determine the processing time for each swap. The block time of the traded assets depends on each network (Bitcoin typically being the slowest) Additionally, the user can customize security preferences. For example, you can ask ${appName} to consider a ARRR transaction as final after just 3 confirmations which makes the swap time shorter compared to waiting for a <a href=\"https://piratechain.com/faq/\">notarization</a>.";
