...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static dynamic m1(dynamic seconde) => 'Ordermatch ongoing, please wait ${seconde} seconds!';

  static dynamic m2(dynamic index) => 'Enter the ${index}. word';

  static dynamic m3(dynamic index) => 'What is the ${index}. word in your seed phrase?';

  static dynamic m4(dynamic coinName, dynamic number) => 'The minimun amount to sell is ${number} ${coinName}';

  static dynamic m5(dynamic coinName, dynamic number) => 'The minimun amount to buy is ${number} ${coinName}';

  static dynamic m6(dynamic coinName) => 'No ${coinName} orders available - please try again later, or create an order.';

  static dynamic m7(dynamic assets) => '${assets} Assets';

  static dynamic m8(dynamic amount) => 'Click to see ${amount} orders';

  static dynamic m9(dynamic coinName, dynamic address) => 'My ${coinName} address: \n${address}';

  static dynamic m10(dynamic amount, dynamic coinName) => 'WITHDRAW ${amount} ${coinName}';

  static dynamic m11(dynamic amount, dynamic coin) => 'You will receive ${amount} ${coin}';
  ...
  static dynamic _notInlinedMessages(dynamic _) => <String, Function>{
    ...
    'bestAvailableRate' : MessageLookupByLibrary.simpleMessage('Best available rate'),
    ...
    'ethNotActive' : MessageLookupByLibrary.simpleMessage('Please activate ETH.'),
    ...
    'infoPasswordDialog' : MessageLookupByLibrary.simpleMessage('If you do not enter a password, you will need to enter your seed phrase every time you want to access your wallet.'),
    'infoTrade1' : MessageLookupByLibrary.simpleMessage('The swap request can not be undone and is a final event!'),
    'infoTrade2' : MessageLookupByLibrary.simpleMessage('This transaction can take up to 10 mins - DONT close this application!'),
    'infoWalletPassword' : MessageLookupByLibrary.simpleMessage('You can choose to encrypt your wallet with a password. If you choose not to use a password, you will need to enter your seed every time you want to access your wallet.'),
    ...
    'notEnoughEth' : MessageLookupByLibrary.simpleMessage('Not enough ETH for transaction!'),
    ...
    'orderCreatedInfo' : MessageLookupByLibrary.simpleMessage('Order succsessfully created'),
    ...
    'signInWithSeedPhrase' : MessageLookupByLibrary.simpleMessage('Sign in with seed phrase'),
    ...
    'welcomeInfo' : MessageLookupByLibrary.simpleMessage('AtomicDEX mobile is a next generation multi-coin wallet with native third generation DEX functionality and more.'),
