...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m73(seconde) => "订单匹配中, 请稍等 ${seconde}秒!";

  static m1(index) => "请输入第 ${index}. 个字";

  static m2(index) => "您助记词的第 ${index}. 个字是什么？";
  ...
  static m41(coinName, number) => "最低可卖出数量 ${number} ${coinName}";

  static m42(coinName, number) => "最低可买入数量 ${number} ${coinName}";

  static m17(coinName) => "当前无 ${coinName} 匹配订单 - 请稍后再试, 或建立订单。";

  static m18(assets) => "${assets}资产";

  static m19(amount) => "点击查看${amount}订单";

  static m20(coinName, address) => "我的 ${coinName}地址: \\n${address}";

  static m21(appName) => "ATOMIC DEX 是次世代多币别钱包, 具有原生第三代的DEX功能等等。";

  static m22(amount, coinName) => "提领 ${amount} ${coinName}";

  static m23(amount, coin) => "您将收到${amount} ${coin}";
