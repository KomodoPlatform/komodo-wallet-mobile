...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static dynamic m10(dynamic coinName, dynamic number) => "売却最小額は ${number} ${coinName} です。";

  static dynamic m11(dynamic coinName, dynamic number) => "購入最小額は ${number} ${coinName}です。\n";

  static dynamic m3(dynamic coinName) => "利用可能な${coinName}の注文がありません - 暫く経ってから再度試すか注文を作成して下さい。";

  static dynamic m4(dynamic assets) => "${assets} アセット";

  static dynamic m5(dynamic amount) => "クリックして ${amount} オーダーを確認します";

  static dynamic m6(dynamic coinName, dynamic address) => "私の ${coinName} アドレス: ${address}";

  static dynamic m7(dynamic amount, dynamic coinName) => "出金 ${amount} ${coinName}";

  static dynamic m8(dynamic amount, dynamic coin) => "あなたは${amount} ${coin}受け取ります";
  ...
  static dynamic _notInlinedMessages(dynamic _) => <String, Function>{
    ...
    "activateAccessBiometric" : MessageLookupByLibrary.simpleMessage("生体認証有効化"),
    ...
    "bestAvailableRate" : MessageLookupByLibrary.simpleMessage("ベスト・アベイラブル・レート"),
    "buy" : MessageLookupByLibrary.simpleMessage("購入"),
    "buySuccessWaiting" : MessageLookupByLibrary.simpleMessage("スワップが発行されました、しばらくお待ちください。"),
    ...
    "checkSeedPhraseButton2" : MessageLookupByLibrary.simpleMessage("戻って再度チェック"),
    "checkSeedPhraseHint" : m1,
    "checkSeedPhraseInfo" : MessageLookupByLibrary.simpleMessage("パスフレーズは重要です - 間違いないように確認を行います。必要な時にウォレットをいつでも復元できる様に、パスフレーズに関して三つの質問を行います。"),
    "checkSeedPhraseSubtile" : m2,
    "checkSeedPhraseTitle" : MessageLookupByLibrary.simpleMessage("パスフレーズを再確認しましょう"),
    ...
    "confirmeula" : MessageLookupByLibrary.simpleMessage("下記ボタンをクリックすると、本ソフトウェアライセンス使用許諾契約および利用規約を既読し同意したものと見なされます。"),
    ...
    "enterpassword" : MessageLookupByLibrary.simpleMessage("継続するにはパスワードを入力して下さい。"),
    "errorAmountBalance" : MessageLookupByLibrary.simpleMessage("残高不足"),
    "errorNotAValidAddress" : MessageLookupByLibrary.simpleMessage("無効なアドレス"),
    ...
    "errorValueEmpty" : MessageLookupByLibrary.simpleMessage("値が高すぎ、または低すぎます"),
    "errorValueNotEmpty" : MessageLookupByLibrary.simpleMessage("データを入力して下さい"),
    ...
    "eulaParagraphe17" : MessageLookupByLibrary.simpleMessage("本規約は、Komodo Platformによって終了されるまで有効です。終了した場合、お客様はアプリケーションへのアクセスを許可されなくなりますが、お客様に課せられたすべての制限および本規約に定められた免責事項と責任の制限は終了後も存続します。そのような解約は、解約日までにKomodo Platformに対してお客様に対して生じた法的権利に影響を与えません。 Komodo Platformは、アプリケーション全体またはアプリケーションのセクションまたは機能をいつでも削除することもできます。"),
    "eulaParagraphe18" : MessageLookupByLibrary.simpleMessage("前の段落の規定は、Komodo Platformおよびその役員、取締役、従業員、代理店、ライセンサー、サプライヤー、およびアプリケーションの第三者情報プロバイダーの利益のためです。これらの個人または団体のそれぞれは、自分自身に代わってこれらの条項を直接あなたに対して主張および実施する権利を有します。"),
    ...
    "getBackupPhrase" : MessageLookupByLibrary.simpleMessage("重要 : 続行する前にパスフレーズのバックアップを行なってください!"),
    ...
    "hintNameYourWallet" : MessageLookupByLibrary.simpleMessage("ウォレットの名前を決めて下さい"),
    "hintPassword" : MessageLookupByLibrary.simpleMessage("パスワード"),
    "history" : MessageLookupByLibrary.simpleMessage("履歴"),
    "infoPasswordDialog" : MessageLookupByLibrary.simpleMessage("パスワードを入力しない場合、ウォレットにアクセスする度にパスフレーズの入力が必要になります。"),
    "infoTrade1" : MessageLookupByLibrary.simpleMessage("スワップ要求は取り消し不可能です"),
    "infoTrade2" : MessageLookupByLibrary.simpleMessage("この取引には10分程度かかります - アプリを閉じないで下さい!"),
    "infoWalletPassword" : MessageLookupByLibrary.simpleMessage("パスワードでウォレットを暗号化する事が出来ます。パスワードを利用しない場合、ウォレットにアクセスする度にパスフレーズの入力が必要になります。"),
    "legalTitle" : MessageLookupByLibrary.simpleMessage("規則"),
    "loading" : MessageLookupByLibrary.simpleMessage("ロード中"),
    "loadingOrderbook" : MessageLookupByLibrary.simpleMessage("オーダーブックロード中..."),
    ...
    "mediaNotSavedDescription" : MessageLookupByLibrary.simpleMessage("保存された記事はありません"),
    ...
    "noArticles" : MessageLookupByLibrary.simpleMessage("新着ニュース無し - 後で又チェックして下さい"),
    "noFunds" : MessageLookupByLibrary.simpleMessage("資金がありません"),
    "noFundsDetected" : MessageLookupByLibrary.simpleMessage("資金がありません -入金して下さい"),
    "noInternet" : MessageLookupByLibrary.simpleMessage("インターネットへ繋がりません"),
    "noOrder" : m3,
    "noOrderAvailable" : MessageLookupByLibrary.simpleMessage("クリックしてオーダーを発注"),
    "noRewardYet" : MessageLookupByLibrary.simpleMessage("請求出来る報酬はありません。1時間後にもう一度試して下さい。"),
    "noSwaps" : MessageLookupByLibrary.simpleMessage("履歴無し"),
    "noTxs" : MessageLookupByLibrary.simpleMessage("取引無し"),
    "notEnoughEth" : MessageLookupByLibrary.simpleMessage("取引のためのETHが不足しています!"),
    "notEnoughtBalanceForFee" : MessageLookupByLibrary.simpleMessage("手数料支払いの残高が足りません - 少額でトレードして下さい"),
    "numberAssets" : m4,
    ...
    "recommendSeedMessage" : MessageLookupByLibrary.simpleMessage("オフラインに保存する事を推奨します。"),
    ...
    "selectCoinInfo" : MessageLookupByLibrary.simpleMessage("ポートフォリオに追加するコインを選んでください。"),
    ...
    "settingDialogSpan3" : MessageLookupByLibrary.simpleMessage("本当なら、次のことを確認して下さい"),
    "settingDialogSpan4" : MessageLookupByLibrary.simpleMessage("パスフレーズを保存"),
    "settingDialogSpan5" : MessageLookupByLibrary.simpleMessage("将来ウォレットを復元する為に。"),
    ...
    "signInWithSeedPhrase" : MessageLookupByLibrary.simpleMessage("パスフレーズでサインイン"),
    ...
    "welcomeInfo" : MessageLookupByLibrary.simpleMessage("AtomicDEXモバイルは第三世代のDEX機能を搭載した次世代型のマルチコインウォレットです。"),
    ...
    "withdrawValue" : m7,
    "wrongPassword" : MessageLookupByLibrary.simpleMessage("パスワードが一致しません、もう一度試して下さい。"),
