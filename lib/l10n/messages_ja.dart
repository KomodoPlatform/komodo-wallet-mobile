...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m24(seconde) => "オーダーマッチ中、あと${seconde} 秒お待ち下さい。\n\n";
  ...
  static m25(coinName, number) => "売却最小額は ${number} ${coinName} です。";

  static m26(coinName, number) => "購入最小額は ${number} ${coinName}です。\n";
