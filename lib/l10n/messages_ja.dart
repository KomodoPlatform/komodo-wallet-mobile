...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} は、モバイルでは Android と iPhone の両方で利用でき、デスクトップでは <a href=\"https://firo.org/\">Windows、Mac、Linux オペレーティング システム</a> で利用できます。";

  static m9(appName) =>
      "他の DEX では通常、単一のブロックチェーン ネットワークに基づく資産の取引のみが許可され、プロキシ トークンが使用され、同じ資金で単一の注文のみが許可されます。 ${appName} を使用すると、プロキシ トークンを使用せずに、2 つの異なるブロックチェーン ネットワーク間でネイティブに取引できます。同じ資金で複数の注文を出すこともできます。たとえば、FIRO、QTUM、または VRSC で 0.1 BTC を販売できます。最初に約定した注文は、他のすべての注文を自動的にキャンセルします。";

  static m10(appName) =>
      "各スワップの処理時間は、いくつかの要因によって決まります。取引された資産のブロック時間は、各ネットワークによって異なります (通常、ビットコインが最も遅いです)。さらに、ユーザーはセキュリティ設定をカスタマイズできます。たとえば、${appName} に、わずか 3 回の確認後に FIRO トランザクションを最終と見なすように依頼できます。これにより、<a href=\"https://firo.org/\">公証</a>。";
  ...
  static m15(appName) =>
      "絶対！詳細については、<a href=\"https://firo.org/\">開発者向けドキュメント</a>をご覧いただくか、パートナーシップに関するお問い合わせでご連絡ください。特定の技術的な質問がありますか? ${appName} 開発者コミュニティはいつでもお手伝いいたします。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "builtFiro": MessageLookupByLibrary.simpleMessage("コモドに建てられた"),
        ...
        "dPow": MessageLookupByLibrary.simpleMessage("Firo dPoW セキュリティ"),
        ...
        "rebrandingAnnouncement": MessageLookupByLibrary.simpleMessage(
            "新しい時代です！ 「AtomicDEX」から「Firo Wallet」に正式に名前を変更しました"),
