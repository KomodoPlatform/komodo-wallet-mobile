...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} est disponible pour mobile sur Android et iPhone, et pour ordinateur sur <a href=\"https://piratechain.com/\">systèmes d\'exploitation Windows, Mac et Linux</a>.";
  ...
  static m15(appName) =>
      "Absolument! Vous pouvez lire notre <a href=\"https://piratechain.com/faq/\">documentation pour les développeurs</a> pour plus de détails ou nous contacter pour vos demandes de partenariat. Vous avez une question technique spécifique ? La communauté de développeurs ${appName} est toujours prête à vous aider !";
