...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(name) => "${name} activé avec succès !";

  static m1(title) => "Seules les adresses ${title} sont affichées";

  static m2(abbr) => "Impossible d\'envoyer les fonds sur l\'adresse ${abbr} car elle n\'est pas activée. Veuillez ouvrir le portfolio.";

  static m3(appName) => "Non ! ${appName} est non-custodial. Aucune donnée sensible n\'est sauvegardé, ni votre clé privé, ni votre passphrases, ni votre PIN. Toutes ces données sont stockées sur votre appareil et ne sont jamais transmises.";

  static m4(appName) => "${appName} est disponible sur mobile Android et iPhone, et pour PC sur les sytèmes d\'exploitations Windows, Mac, et Linux.";

  static m5(appName) => "Les autres DEX ne vous permettent généralement que d\'échanger des actifs basés sur un seul réseau de blockchain, d\'utiliser des jetons proxy et de ne permettre de passer qu\'une seule commande avec les mêmes fonds.\n\n${appName} vous permet d\'échanger nativement sur deux réseaux blockchain différents sans jetons proxy. Vous pouvez également passer plusieurs commandes avec les mêmes fonds. Par exemple, vous pouvez vendre 0,1 BTC pour KMD, QTUM ou VRSC — la première commande exécutée annule automatiquement toutes les autres commandes.";

  static m6(appName) => "Plusieurs facteurs déterminent le temps de traitement de chaque échange. Le temps de blocage des actifs échangés dépend de chaque réseau (Bitcoin étant généralement le plus lent). De plus, l\'utilisateur peut personnaliser les préférences de sécurité. Par exemple, vous pouvez demander à ${appName} de considérer une transaction KMD comme finale après seulement 3 confirmations, ce qui raccourcit le temps d\'échange par rapport à l\'attente d\'une <a href=\"https://komodoplatform.com/security-delayed-proof-of-work-dpow/\">notarisation</a>.";

  static m7(appName) => "Il existe deux catégories de frais à prendre en compte lors de la négociation sur ${appName}.\n\n1. ${appName} facture environ 0,13 % (1/777 du volume de négociation mais pas moins de 0,0001) comme frais de négociation pour les ordres preneurs, et les ordres fabricant n\'ont aucun frais.\n\n2. Les fabricants et les preneurs devront payer des frais de réseau normaux aux chaînes de blocs impliquées lors des transactions d\'échange atomique.\n\nLes frais de réseau peuvent varier considérablement en fonction de la paire de négociation que vous avez sélectionnée.";

  static m8(name, link, appName, appCompanyShort) => "Oui! ${appName} propose une assistance via le <a href=\"${link}\">${appCompanyShort} ${name}</a>. L\'équipe et la communauté sont toujours ravies de vous aider !";

  static m9(appName) => "Non! ${appName} est entièrement décentralisé. Il n\'est pas possible de limiter l\'accès des utilisateurs par un tiers.";
  ...
  static m15(index) => "Entrez le ${index} mot";

  static m16(index) => "Quel est le ${index} mot dans votre passphrase?";
  ...
  static m20(gas) => "Pas assez de gas - veuillez utiliser au moins ${gas} Gwei";
  ...
  static m35(coin) => "Envoi de la demande au robinet ${coin} ...";

  static m36(appCompanyShort) => "${appCompanyShort} actualités";

  static m37(coin) => "${coin} commission";

  static m38(coin) => "Veuillez activer ${coin}.";

  static m39(abbr) => "${abbr} balance insuffisante pour payer les frais de courtage";

  static m40(coinAbbr) => "${coinAbbr} est indisponible :(";

  static m41(coinName, number) => "Le montant minimum à vendre est ${number} ${coinName}";

  static m42(coinName, number) => "Le montant minimum à acheter est ${number} ${coinName}";

  static m43(buyCoin, buyAmount, sellCoin, sellAmount) => "Le montant minimum de la commande est de ${buyAmount}${buyCoin}(${sellAmount}${sellCoin})";

  static m44(coinName, number) => "Le montant minimum à vendre est de ${number}${coinName}";

  static m45(minValue, coin) => "Doit être supérieur à ${minValue} ${coin}";

  static m46(appName) => "Veuillez noter que vous utilisez maintenant des données cellulaires et que votre participation au réseau ${appName} P2P consomme du trafic Internet. Il est préférable d\'utiliser un réseau WiFi si votre forfait de données cellulaires est coûteux.";

  static m47(coin) => "Activez ${coin} et rechargez d\'abord le solde";

  static m48(number) => "Créer ${number} Ordre(s):";

  static m49(coin) => "La balance ${coin} est trop faible";

  static m50(coin, fee) => "Pas assez de ${coin} pour payer les frais. Balance MIN necessaire ${fee} ${coin}";

  static m51(coinName) => "Aucun ordre ${coinName} disponible - réessayez ultérieurement ou créez un ordre.";
  ...
  static m55(sell, buy) => "${sell}/${buy} échange démarré";
  ...
  static m63(coin) => "Mnt. (${coin})";

  static m64(coin) => "Prix (${coin})";

  static m65(coin) => "Total (${coin})";

  static m66(abbr) => "${abbr} n\'est pas actif. Veuillez activer et réessayer.";
  ...
  static m79(maxCoins) => "Le nombre maximum de pièces actives est de ${maxCoins}. Veuillez en désactiver certains.";

  static m80(coin) => "${coin} pas activé!";

  static m81(coin) => "Veuillez entrer le montant de ${coin} à vendre";

  static m82(coin) => "Impossible d\'activer ${coin}";

  static m83(description) => "Choisissez un fichier mp3 ou wav s\'il vous plaît. Nous y jouerons quand ${description}.";

  static m84(description) => "Joué quand ${description}";

  static m85(appName) => "Si vous avez des questions ou si vous pensez avoir rencontré un problème technique avec l\'application ${appName} , vous pouvez le signaler et obtenir de l\'aide de notre équipe.";
  ...
  static m92(version) => "Version ${version} disponible. Veuillez mettre à jour.";

  static m93(appName) => "Mise à jour ${appName}";

  static m94(coinAbbr) => "Activation ${coinAbbr} échoué";

  static m95(coinAbbr) => "Activation ${coinAbbr} échoué.\nVeuillez redémarrer l\'application et réessayer.";

  static m96(appName) => "AtomicDEX mobile est un portefeuille multi crypto-monnaies de nouvelle génération doté de la fonctionnalité DEX native de troisième génération et encore bien plus.";

  static m97(appName) => "Vous avez précédemment refusé à ${appName} l\'accès à la caméra.\nVeuillez modifier manuellement l\'autorisation de l\'appareil photo dans les paramètres de votre téléphone pour procéder à l\'analyse du code QR.";

  static m98(amount, coinName) => "ENVOYER ${amount} ${coinName}";

  static m99(amount, coin) => "Vous recevrez ${amount} ${coin}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    "Active" : MessageLookupByLibrary.simpleMessage("Active"),
    "Applause" : MessageLookupByLibrary.simpleMessage("Applause"),
    "Can\'t play that" : MessageLookupByLibrary.simpleMessage("Lecture impossible"),
    ...
    "a swap fails" : MessageLookupByLibrary.simpleMessage("un échange a échoué"),
    "a swap runs to completion" : MessageLookupByLibrary.simpleMessage("un échange est en cours"),
    "accepteula" : MessageLookupByLibrary.simpleMessage("Accepter les conditions générales de ventes"),
    "accepttac" : MessageLookupByLibrary.simpleMessage("Accepter les conditions générales d\'utilisations"),
    "activateAccessBiometric" : MessageLookupByLibrary.simpleMessage("Activer la protection Biométrique"),
    "activateAccessPin" : MessageLookupByLibrary.simpleMessage("Activer la protection PIN"),
    "addCoin" : MessageLookupByLibrary.simpleMessage("Activer la crypto-monnaie"),
    ...
    "addressBookEmpty" : MessageLookupByLibrary.simpleMessage("Répertoire vide"),
    "addressBookFilter" : m1,
    "addressBookTitle" : MessageLookupByLibrary.simpleMessage("Répertoire"),
    "addressCoinInactive" : m2,
    "addressNotFound" : MessageLookupByLibrary.simpleMessage("Pas de résultats"),
    "addressSelectCoin" : MessageLookupByLibrary.simpleMessage("Choisir Crypto-monnaie"),
    "addressSend" : MessageLookupByLibrary.simpleMessage("Adresse du destinataire"),
    "advanced" : MessageLookupByLibrary.simpleMessage("Avancé"),
    "all" : MessageLookupByLibrary.simpleMessage("Tout"),
    "allowCustomSeed" : MessageLookupByLibrary.simpleMessage("Autoriser les passphrases personnalisées"),
    "alreadyExists" : MessageLookupByLibrary.simpleMessage("Doublon existant"),
    "amount" : MessageLookupByLibrary.simpleMessage("Montant"),
    "amountToSell" : MessageLookupByLibrary.simpleMessage("Montant à vendre"),
    "answer_1" : m3,
    "answer_10" : m4,
    "answer_2" : m5,
    "answer_3" : m6,
    ...
    "authenticate" : MessageLookupByLibrary.simpleMessage("authentification"),
    "automaticRedirected" : MessageLookupByLibrary.simpleMessage("Vous serez automatiquement redirigé vers la page du portfolio une fois le processus de réactivation terminé."),
    ...
    "batterySavingWarning" : MessageLookupByLibrary.simpleMessage("Votre téléphone est en mode d\'économie de batterie. Veuillez désactiver ce mode ou ne PAS mettre l\'application en arrière-plan, sinon l\'application pourrait être tuée par le système d\'exploitation et l\'échange échouerait."),
    "bestAvailableRate" : MessageLookupByLibrary.simpleMessage("Meilleur tarif disponible"),
    ...
    "camoPinCreate" : MessageLookupByLibrary.simpleMessage("Créer Masque PIN"),
    "camoPinDesc" : MessageLookupByLibrary.simpleMessage("Si vous déverrouillez l\'application avec le code PIN de camouflage, un faux solde FAIBLE sera affiché et l\'option de configuration du code PIN de camouflage ne sera PAS visible dans les paramètres."),
    "camoPinInvalid" : MessageLookupByLibrary.simpleMessage("Masque PIN incorrect"),
    "camoPinLink" : MessageLookupByLibrary.simpleMessage("Masque PIN"),
    "camoPinNotFound" : MessageLookupByLibrary.simpleMessage("Masque PIN introuvable"),
    "camoPinOff" : MessageLookupByLibrary.simpleMessage("Off"),
    "camoPinOn" : MessageLookupByLibrary.simpleMessage("On"),
    "camoPinSaved" : MessageLookupByLibrary.simpleMessage("Masque PIN sauvegardé"),
    "camoPinTitle" : MessageLookupByLibrary.simpleMessage("Masque PIN"),
    "camoSetupSubtitle" : MessageLookupByLibrary.simpleMessage("Entrer un nouveau Masque PIN"),
    "camoSetupTitle" : MessageLookupByLibrary.simpleMessage("Configuration Masque PIN"),
    "camouflageSetup" : MessageLookupByLibrary.simpleMessage("Configuration Masque PIN"),
    ...
    "candleChartError" : MessageLookupByLibrary.simpleMessage("Un problème est survenu. Réessayez plus tard."),
    "cantDeleteDefaultCoinOk" : MessageLookupByLibrary.simpleMessage("Ok"),
    "cantDeleteDefaultCoinSpan" : MessageLookupByLibrary.simpleMessage(" est une pièce par défaut. Les pièces par défaut ne peuvent pas être désactivées."),
    "cantDeleteDefaultCoinTitle" : MessageLookupByLibrary.simpleMessage("Désactivation impossible"),
    "cex" : MessageLookupByLibrary.simpleMessage("CEX"),
    "cexChangeRate" : MessageLookupByLibrary.simpleMessage("Taux de change CEX"),
    "cexData" : MessageLookupByLibrary.simpleMessage("Données CEX"),
    "cexDataDesc" : MessageLookupByLibrary.simpleMessage("Les données de marché (prix, graphiques, etc.) marquées de cette icône proviennent de sources tierces (<a href=\"https://www.coingecko.com/\">coingecko.com</a>, <a href=\"https://openrates.io/\">openrates.io</a>)."),
    "changePin" : MessageLookupByLibrary.simpleMessage("Changer code PIN"),
    "checkForUpdates" : MessageLookupByLibrary.simpleMessage("Vérifier les mises à jours"),
    "checkOut" : MessageLookupByLibrary.simpleMessage("Check-out"),
    "checkSeedPhrase" : MessageLookupByLibrary.simpleMessage("Vérifier la passphrase"),
    "checkSeedPhraseButton1" : MessageLookupByLibrary.simpleMessage("CONTINUER"),
    "checkSeedPhraseButton2" : MessageLookupByLibrary.simpleMessage("RETOURNEZ ET VÉRIFIEZ À NOUVEAU"),
    "checkSeedPhraseHint" : m15,
    "checkSeedPhraseInfo" : MessageLookupByLibrary.simpleMessage("Votre passphrase est importante - c\'est pourquoi nous voulons nous assurer qu\'elle est correcte. Nous vous poserons trois questions différentes sur votre passphrase pour vous assurer que vous pourrez facilement restaurer votre portefeuille à tout moment."),
    "checkSeedPhraseSubtile" : m16,
    "checkSeedPhraseTitle" : MessageLookupByLibrary.simpleMessage("VERIFIONS UNE NOUVELLE FOIS VOTRE PASSPHRASE"),
    "chineseLanguage" : MessageLookupByLibrary.simpleMessage("Chinois"),
    "claim" : MessageLookupByLibrary.simpleMessage("réclamer"),
    "claimTitle" : MessageLookupByLibrary.simpleMessage("Réclamer votre récompense KMD?"),
    "clickToSee" : MessageLookupByLibrary.simpleMessage("Cliquez pour voir"),
    "clipboard" : MessageLookupByLibrary.simpleMessage("Copié dans le presse-papiers"),
    "clipboardCopy" : MessageLookupByLibrary.simpleMessage("Copier dans le presse-papiers"),
    "close" : MessageLookupByLibrary.simpleMessage("Fermer"),
    "closeMessage" : MessageLookupByLibrary.simpleMessage("Fermer Message d\'Erreur"),
    ...
    "coinSelectNotFound" : MessageLookupByLibrary.simpleMessage("Aucune crypto-monnaie active"),
    "coinSelectTitle" : MessageLookupByLibrary.simpleMessage("Choisir crypto-monnaie"),
    "comingSoon" : MessageLookupByLibrary.simpleMessage("A venir..."),
    "commingsoon" : MessageLookupByLibrary.simpleMessage("TX détails à venir!"),
    "commingsoonGeneral" : MessageLookupByLibrary.simpleMessage("Détails à venir!"),
    "commissionFee" : MessageLookupByLibrary.simpleMessage("frais de commission"),
    "comparedToCex" : MessageLookupByLibrary.simpleMessage("comparé au CEX"),
    "configureWallet" : MessageLookupByLibrary.simpleMessage("Portefeuille en cours de configuration, veuillez patienter..."),
    "confirm" : MessageLookupByLibrary.simpleMessage("Confirmer"),
    "confirmCamouflageSetup" : MessageLookupByLibrary.simpleMessage("Confirmer Masque PIN"),
    "confirmCancel" : MessageLookupByLibrary.simpleMessage("Êtes-vous sûr d\'annuler l\'odre"),
    "confirmPassword" : MessageLookupByLibrary.simpleMessage("Confirmez le mot de passe"),
    "confirmPin" : MessageLookupByLibrary.simpleMessage("Confirmer le code PIN"),
    "confirmSeed" : MessageLookupByLibrary.simpleMessage("Confirmer la passphrase"),
    "confirmeula" : MessageLookupByLibrary.simpleMessage("En cliquant sur le bouton ci-dessous vous confrimez avec lu et accepté les CGV et CGU"),
    "connecting" : MessageLookupByLibrary.simpleMessage("Connexion…"),
    "contactCancel" : MessageLookupByLibrary.simpleMessage("Annuler"),
    "contactDelete" : MessageLookupByLibrary.simpleMessage("Supprimer Contact"),
    ...
    "contactExitWarning" : MessageLookupByLibrary.simpleMessage("Annuler vos modifications ?"),
    "contactNotFound" : MessageLookupByLibrary.simpleMessage("Aucun contact trouvé"),
    ...
    "couldntImportError" : MessageLookupByLibrary.simpleMessage("Import impossible:"),
    "create" : MessageLookupByLibrary.simpleMessage("Échange"),
    "createAWallet" : MessageLookupByLibrary.simpleMessage("CRÉER UN PORTEFEUILLE"),
    ...
    "customFee" : MessageLookupByLibrary.simpleMessage("Frais personnalisés"),
    "customFeeWarning" : MessageLookupByLibrary.simpleMessage("N\'utiliser les frais personnalisés que si vous savez ce que vous faite!"),
    "customSeedWarning" : m18,
    "dPow" : MessageLookupByLibrary.simpleMessage("Komodo sécurité dPoW"),
    "date" : MessageLookupByLibrary.simpleMessage("Date"),
    "decryptingWallet" : MessageLookupByLibrary.simpleMessage("Décryptage du portefeuille..."),
    ...
    "dexIsNotAvailable" : MessageLookupByLibrary.simpleMessage("Cette crypto-monnaie n\'est pas supporté par DEX"),
    "disclaimerAndTos" : MessageLookupByLibrary.simpleMessage("Avertissement et Conditions d\'utilisation"),
    "done" : MessageLookupByLibrary.simpleMessage("Terminé"),
    "dontAskAgain" : MessageLookupByLibrary.simpleMessage("Ne plus demander"),
    "dontWantPassword" : MessageLookupByLibrary.simpleMessage("Je ne veux pas de mot de passe"),
    "duration" : MessageLookupByLibrary.simpleMessage("Durée"),
    "editContact" : MessageLookupByLibrary.simpleMessage("Editer contact"),
    "emptyCoin" : m19,
    "emptyExportPass" : MessageLookupByLibrary.simpleMessage("Le mot de passe chiffré ne peut être nul"),
    "emptyImportPass" : MessageLookupByLibrary.simpleMessage("Le mot de passe ne peut être nul"),
    "emptyName" : MessageLookupByLibrary.simpleMessage("Le nom du contact ne peut être nul"),
    "emptyWallet" : MessageLookupByLibrary.simpleMessage("Le nom du portefeuille ne peut être nul"),
    "enableTestCoins" : MessageLookupByLibrary.simpleMessage("Activer les crypto-monnaies de Test"),
    "enablingTooManyAssetsSpan1" : MessageLookupByLibrary.simpleMessage("Vous avez"),
    "enablingTooManyAssetsSpan2" : MessageLookupByLibrary.simpleMessage(" actifs activés et tentative d\'activation"),
    "enablingTooManyAssetsSpan3" : MessageLookupByLibrary.simpleMessage(" Suite. La limite maximale des éléments activés est"),
    "enablingTooManyAssetsSpan4" : MessageLookupByLibrary.simpleMessage(". Veuillez en désactiver certains avant d\'en ajouter de nouveaux."),
    "enablingTooManyAssetsTitle" : MessageLookupByLibrary.simpleMessage("Tentative d\'activation d\'un trop grand nombre d\'éléments"),
    "encryptingWallet" : MessageLookupByLibrary.simpleMessage("Chiffrement du portefeuille..."),
    "englishLanguage" : MessageLookupByLibrary.simpleMessage("Anglais"),
    "enter" : MessageLookupByLibrary.simpleMessage("Valider"),
    "enterNewPinCode" : MessageLookupByLibrary.simpleMessage("Enter votre nouveau PIN"),
    "enterOldPinCode" : MessageLookupByLibrary.simpleMessage("Entrer votre ancien PIN"),
    "enterPinCode" : MessageLookupByLibrary.simpleMessage("Entrez votre code PIN"),
    "enterSeedPhrase" : MessageLookupByLibrary.simpleMessage("Entrez votre passphrase"),
    "enterSellAmount" : MessageLookupByLibrary.simpleMessage("Vous devez d\'abord entrer le prix de vente"),
    "enterpassword" : MessageLookupByLibrary.simpleMessage("Veuillez entrer votre mot de passe pour continuer."),
    "errorAmountBalance" : MessageLookupByLibrary.simpleMessage("Solde insuffisant"),
    "errorNotAValidAddress" : MessageLookupByLibrary.simpleMessage("Adresse non valide"),
    "errorNotAValidAddressSegWit" : MessageLookupByLibrary.simpleMessage("Adresses Segwit non supportées (pour le moment)"),
    "errorNotEnoughGas" : m20,
    "errorTryAgain" : MessageLookupByLibrary.simpleMessage("Erreur, veuillez réessayer"),
    "errorTryLater" : MessageLookupByLibrary.simpleMessage("Erreur, merci d\'essayer plus tard"),
    "errorValueEmpty" : MessageLookupByLibrary.simpleMessage("La valeur est trop élevée ou trop basse"),
    "errorValueNotEmpty" : MessageLookupByLibrary.simpleMessage("S\'il vous plaît entrer des données"),
    "estimateValue" : MessageLookupByLibrary.simpleMessage("Valeur totale estimée"),
    "eulaParagraphe1" : m21,
    ...
    "exampleHintSeed" : MessageLookupByLibrary.simpleMessage("Exemple: build case level ..."),
    ...
    "exchangeIdentical" : MessageLookupByLibrary.simpleMessage("Identique au CEX"),
    ...
    "exportDesc" : MessageLookupByLibrary.simpleMessage("Veuillez selectionner les objets à exporter dans le fichier chiffré."),
    ...
    "faucetTimedOut" : MessageLookupByLibrary.simpleMessage("La demande a expiré"),
    ...
    "feedUnableToProceed" : MessageLookupByLibrary.simpleMessage("Impossible de mettre à jour le fil d\'actu"),
    "feedUnableToUpdate" : MessageLookupByLibrary.simpleMessage("Impossible de recevoir les mises à jour du fil d\'actu"),
    "feedUpToDate" : MessageLookupByLibrary.simpleMessage("Déjà à jour"),
    "feedUpdated" : MessageLookupByLibrary.simpleMessage("Fil d\'actualité mis à jour"),
    "feedback" : MessageLookupByLibrary.simpleMessage("Envoyer des commentaires"),
    "filtersAll" : MessageLookupByLibrary.simpleMessage("Tout"),
    "filtersButton" : MessageLookupByLibrary.simpleMessage("Filtrer"),
    "filtersClearAll" : MessageLookupByLibrary.simpleMessage("Effacer tous les filtres"),
    ...
    "filtersReceive" : MessageLookupByLibrary.simpleMessage("Recevoir crypto-monnaie"),
    "filtersSell" : MessageLookupByLibrary.simpleMessage("Vendre crypto-monnaie"),
    ...
    "fingerprint" : MessageLookupByLibrary.simpleMessage("Empreinte digitale"),
    ...
    "generalPinNotActive" : MessageLookupByLibrary.simpleMessage("Protection PIN pas activé.\nCamouflage PIN non disponible.\nVeuillez activer la protection PIN."),
    "getBackupPhrase" : MessageLookupByLibrary.simpleMessage("Important: sauvegardez votre passphrase avant de continuer!"),
    "goToPorfolio" : MessageLookupByLibrary.simpleMessage("Ouvrir portfolio"),
    ...
    "hintConfirmPassword" : MessageLookupByLibrary.simpleMessage("Confirmez le Mot de passe"),
    "hintCreatePassword" : MessageLookupByLibrary.simpleMessage("Créer Mot de passe"),
    "hintCurrentPassword" : MessageLookupByLibrary.simpleMessage("Mot de passe actuel"),
    "hintEnterPassword" : MessageLookupByLibrary.simpleMessage("Tapez votre Mot de passe"),
    "hintEnterSeedPhrase" : MessageLookupByLibrary.simpleMessage("Entrez votre passphrase"),
    "hintNameYourWallet" : MessageLookupByLibrary.simpleMessage("Nommez votre portefeuille"),
    ...
    "importDecryptError" : MessageLookupByLibrary.simpleMessage("Données corrompues ou Mot de passe incorrect"),
    "importDesc" : MessageLookupByLibrary.simpleMessage("données à importer:"),
    "importFileNotFound" : MessageLookupByLibrary.simpleMessage("Fichier non trouvé"),
    "importInvalidSwapData" : MessageLookupByLibrary.simpleMessage("Données d\'échange non valides. Veuillez fournir un fichier JSON d\'état d\'échange valide."),
    "importLink" : MessageLookupByLibrary.simpleMessage("Importer"),
    "importLoadDesc" : MessageLookupByLibrary.simpleMessage("Veuillez selectionner le chiffré à importer."),
    "importLoadSwapDesc" : MessageLookupByLibrary.simpleMessage("Veuillez selectionner le fichier texte d\'échange à importer."),
    ...
    "importSingleSwapLink" : MessageLookupByLibrary.simpleMessage("Importer Échange Simple"),
    "importSingleSwapTitle" : MessageLookupByLibrary.simpleMessage("Importer Échange"),
    "importSomeItemsSkippedWarning" : MessageLookupByLibrary.simpleMessage("Des données ont été ignorées"),
    "importSuccessTitle" : MessageLookupByLibrary.simpleMessage("Données importé avec succès:"),
    "importSwapFailed" : MessageLookupByLibrary.simpleMessage("Impossible d\'importer l\'échange"),
    "importSwapJsonDecodingError" : MessageLookupByLibrary.simpleMessage("Erreur décodage fichier json"),
    "importTitle" : MessageLookupByLibrary.simpleMessage("Importer"),
    "infoPasswordDialog" : MessageLookupByLibrary.simpleMessage("Si vous n\'entrez pas de mot de passe, vous devrez entrer votre passphrase chaque fois que vous souhaitez accéder à votre portefeuille."),
    "infoTrade1" : MessageLookupByLibrary.simpleMessage("La demande d\'échange ne peut pas être annulée et constitue un événement final!"),
    "infoTrade2" : MessageLookupByLibrary.simpleMessage("Cette transaction peut prendre jusqu\'à 10 minutes. NE FERMEZ PAS cette application!"),
    "infoWalletPassword" : MessageLookupByLibrary.simpleMessage("Vous pouvez choisir de chiffrer votre portefeuille avec un mot de passe. Si vous choisissez de ne pas utiliser de mot de passe, vous devrez entrer votre passphrase chaque fois que vous souhaitez accéder à votre portefeuille."),
    "insufficientBalanceToPay" : m39,
    "insufficientText" : MessageLookupByLibrary.simpleMessage("Le volume minimum requis pour cet ordre est"),
    "insufficientTitle" : MessageLookupByLibrary.simpleMessage("Volume insuffisant"),
    "internetRefreshButton" : MessageLookupByLibrary.simpleMessage("Rafraichir"),
    "internetRestored" : MessageLookupByLibrary.simpleMessage("Connexion Internet Restauré"),
    "invalidSwap" : MessageLookupByLibrary.simpleMessage("Échange impossible"),
    "invalidSwapDetailsLink" : MessageLookupByLibrary.simpleMessage("Détails"),
    "isUnavailable" : m40,
    ...
    "latestTxs" : MessageLookupByLibrary.simpleMessage("Dernières Transactions"),
    "legalTitle" : MessageLookupByLibrary.simpleMessage("Légal"),
    "less" : MessageLookupByLibrary.simpleMessage("Moins"),
    "loading" : MessageLookupByLibrary.simpleMessage("Chargement..."),
    "loadingOrderbook" : MessageLookupByLibrary.simpleMessage("Chargement des ordres ..."),
    "lockScreen" : MessageLookupByLibrary.simpleMessage("L\'écran est verrouillé"),
    "lockScreenAuth" : MessageLookupByLibrary.simpleMessage("S\'il vous plaît authentifiez vous!"),
    "login" : MessageLookupByLibrary.simpleMessage("se connecter"),
    "logout" : MessageLookupByLibrary.simpleMessage("Se Déconnecter"),
    "logoutOnExit" : MessageLookupByLibrary.simpleMessage("Déconnexion à la sortie"),
    "logoutWarning" : MessageLookupByLibrary.simpleMessage("Êtes-vous sur de vouloir quitter?"),
    "logoutsettings" : MessageLookupByLibrary.simpleMessage("Paramètres de déconnexion"),
    "longMinutes" : MessageLookupByLibrary.simpleMessage("minutes"),
    "makeAorder" : MessageLookupByLibrary.simpleMessage("creer un ordre"),
    "makerDetailsCancel" : MessageLookupByLibrary.simpleMessage("Annuler ordre"),
    ...
    "makerDetailsNoSwaps" : MessageLookupByLibrary.simpleMessage("Aucun échange démarré par cet ordre"),
    "makerDetailsPrice" : MessageLookupByLibrary.simpleMessage("Prix"),
    "makerDetailsSell" : MessageLookupByLibrary.simpleMessage("Vendre"),
    "makerDetailsSwaps" : MessageLookupByLibrary.simpleMessage("Échange démarré par cet ordre"),
    "makerDetailsTitle" : MessageLookupByLibrary.simpleMessage("Détails ordre des Maker"),
    ...
    "marketsNoAsks" : MessageLookupByLibrary.simpleMessage("aucune demande trouvée"),
    "marketsNoBids" : MessageLookupByLibrary.simpleMessage("Aucune offre trouvée"),
    "marketsOrderDetails" : MessageLookupByLibrary.simpleMessage("Détail Ordre"),
    "marketsOrderbook" : MessageLookupByLibrary.simpleMessage("CARNET d\'ORDRES"),
    "marketsPrice" : MessageLookupByLibrary.simpleMessage("PRIX"),
    "marketsSelectCoins" : MessageLookupByLibrary.simpleMessage("Veuillez selectionner crypto-monnaies"),
    "marketsTab" : MessageLookupByLibrary.simpleMessage("Marchés"),
    "marketsTitle" : MessageLookupByLibrary.simpleMessage("MARCHÉS"),
    "matchExportPass" : MessageLookupByLibrary.simpleMessage("Les mots de passes doivent être identiques"),
    "matchingCamoChange" : MessageLookupByLibrary.simpleMessage("Change"),
    "matchingCamoPinError" : MessageLookupByLibrary.simpleMessage("Votre PIN et masque PIN sont identiques.\nLe mode Masquage ne sera pas activé.\nVeuillez changer le Masque PIN."),
    "matchingCamoTitle" : MessageLookupByLibrary.simpleMessage("PIN Incorrect"),
    ...
    "minValueSell" : m44,
    "minVolumeInput" : m45,
    "minVolumeIsTDH" : MessageLookupByLibrary.simpleMessage("Doit être inférieur au montant de la vente"),
    "minVolumeTitle" : MessageLookupByLibrary.simpleMessage("Volume Min requis"),
    "minVolumeToggle" : MessageLookupByLibrary.simpleMessage("Utiliser le volume minimal personnalisé"),
    ...
    "multiBaseAmtPlaceholder" : MessageLookupByLibrary.simpleMessage("Montant"),
    "multiBasePlaceholder" : MessageLookupByLibrary.simpleMessage("Crypto-monnaie"),
    ...
    "multiConfirmConfirm" : MessageLookupByLibrary.simpleMessage("Confirmer"),
    ...
    "multiFiatDesc" : MessageLookupByLibrary.simpleMessage("Veuillez entrer le montant fiat à recevoir:"),
    "multiFiatFill" : MessageLookupByLibrary.simpleMessage("Replissage auto"),
    "multiFixErrors" : MessageLookupByLibrary.simpleMessage("Veuillez corriger toutes les erreurs avant de continuer"),
    "multiInvalidAmt" : MessageLookupByLibrary.simpleMessage("Montant invalide"),
    "multiInvalidSellAmt" : MessageLookupByLibrary.simpleMessage("Montant de vente invalide"),
    "multiLowGas" : m49,
    "multiLowerThanFee" : m50,
    "multiMaxSellAmt" : MessageLookupByLibrary.simpleMessage("Montant de vente Max est"),
    "multiMinReceiveAmt" : MessageLookupByLibrary.simpleMessage("Montant de reception Min est"),
    "multiMinSellAmt" : MessageLookupByLibrary.simpleMessage("Montant de vente Min est"),
    ...
    "newAccountUpper" : MessageLookupByLibrary.simpleMessage("Nouveau compte"),
    ...
    "noArticles" : MessageLookupByLibrary.simpleMessage("Pas d\'articles - s\'il vous plaît revenez plus tard!"),
    "noCoinFound" : MessageLookupByLibrary.simpleMessage("Pas de crypto-monnaie trouvé"),
    "noFunds" : MessageLookupByLibrary.simpleMessage("Pas de fonds"),
    "noFundsDetected" : MessageLookupByLibrary.simpleMessage("Pas de fonds disponibles - faire un dépot s\'il vous plaît."),
    "noInternet" : MessageLookupByLibrary.simpleMessage("Pas de connexion Internet"),
    "noItemsToExport" : MessageLookupByLibrary.simpleMessage("Pas d\'articles sélectionnés"),
    "noItemsToImport" : MessageLookupByLibrary.simpleMessage("Pas d\'articles sélectionnés"),
    "noMatchingOrders" : MessageLookupByLibrary.simpleMessage("Pas d\'ordres compatibles trouvés"),
    "noOrder" : m51,
    "noOrderAvailable" : MessageLookupByLibrary.simpleMessage("Cliquez pour créer un ordre"),
    "noOrders" : MessageLookupByLibrary.simpleMessage("Pas d\'ordres, veuillez ouvrir menu échange."),
    "noRewardYet" : MessageLookupByLibrary.simpleMessage("Aucune récompense ne peut être demandée - veuillez réessayer dans 1h."),
    "noRewards" : MessageLookupByLibrary.simpleMessage("Pas de bonus disponible"),
    "noSuchCoin" : MessageLookupByLibrary.simpleMessage("Pas une telle pièce"),
    ...
    "notifSwapCompletedTitle" : MessageLookupByLibrary.simpleMessage("Échange terminé"),
    "notifSwapFailedText" : m54,
    "notifSwapFailedTitle" : MessageLookupByLibrary.simpleMessage("Échange échoué"),
    "notifSwapStartedText" : m55,
    "notifSwapStartedTitle" : MessageLookupByLibrary.simpleMessage("Nouvel échange démarré"),
    "notifSwapStatusTitle" : MessageLookupByLibrary.simpleMessage("Statut de l\'échange modifié"),
    "notifSwapTimeoutText" : m56,
    "notifSwapTimeoutTitle" : MessageLookupByLibrary.simpleMessage("Délais d\'échange dépassé"),
    "notifTxText" : m57,
    "notifTxTitle" : MessageLookupByLibrary.simpleMessage("Transaction entrante"),
    "numberAssets" : m58,
    ...
    "openMessage" : MessageLookupByLibrary.simpleMessage("Ouvrir Message d\'Erreur"),
    "orderCancel" : m59,
    "orderCreated" : MessageLookupByLibrary.simpleMessage("Ordre créée"),
    "orderCreatedInfo" : MessageLookupByLibrary.simpleMessage("Ordre créée avec succès"),
    ...
    "orderDetailsIdentical" : MessageLookupByLibrary.simpleMessage("Identique au CEX"),
    ...
    "orderDetailsSelect" : MessageLookupByLibrary.simpleMessage("Selectionner"),
    "orderDetailsSells" : MessageLookupByLibrary.simpleMessage("Ventes"),
    "orderDetailsSettings" : MessageLookupByLibrary.simpleMessage("Ouvrez les détails en un seul clic et sélectionnez Commander en appuyant longuement"),
    ...
    "orderMatching" : MessageLookupByLibrary.simpleMessage("Recherche d\'ordre"),
    "orderTypePartial" : MessageLookupByLibrary.simpleMessage("Ordre"),
    "orderTypeUnknown" : MessageLookupByLibrary.simpleMessage("Type d\'odre inconnu"),
    ...
    "paymentUriDetailsAcceptQuestion" : MessageLookupByLibrary.simpleMessage("Acceptez-vous cette transaction?"),
    "paymentUriDetailsAddressSpan" : MessageLookupByLibrary.simpleMessage("Adresser"),
    "paymentUriDetailsAmountSpan" : MessageLookupByLibrary.simpleMessage("Montant:"),
    "paymentUriDetailsCoinSpan" : MessageLookupByLibrary.simpleMessage("Crypto-monnaie:"),
    "paymentUriDetailsDeny" : MessageLookupByLibrary.simpleMessage("Annuler"),
    "paymentUriDetailsTitle" : MessageLookupByLibrary.simpleMessage("Paiement demandé"),
    "paymentUriInactiveCoin" : m66,
    "placeOrder" : MessageLookupByLibrary.simpleMessage("Passer votre ordre"),
    "pleaseAddCoin" : MessageLookupByLibrary.simpleMessage("Veuillez ajouter une Crypto-monnaie"),
    "pleaseRestart" : MessageLookupByLibrary.simpleMessage("Veuillez redémarrer l\'application pour réessayer, ou appuyer sur le bouton ci-dessous."),
    "portfolio" : MessageLookupByLibrary.simpleMessage("Portfolio"),
    "poweredOnKmd" : MessageLookupByLibrary.simpleMessage("Propulsé par Komodo"),
    ...
    "protectionCtrlConfirmations" : MessageLookupByLibrary.simpleMessage("Confirmations"),
    "protectionCtrlCustom" : MessageLookupByLibrary.simpleMessage("Utiliser les paramètres de protection personnalisés"),
    "protectionCtrlOff" : MessageLookupByLibrary.simpleMessage("OFF"),
    "protectionCtrlOn" : MessageLookupByLibrary.simpleMessage("ON"),
    "protectionCtrlWarning" : MessageLookupByLibrary.simpleMessage("Attention, cet \"atomic swap\" n\'est pas protégé par dPoW."),
    ...
    "recommendSeedMessage" : MessageLookupByLibrary.simpleMessage("Nous vous recommandons de la stocker hors ligne."),
    "remove" : MessageLookupByLibrary.simpleMessage("Désactivé"),
    "requestedTrade" : MessageLookupByLibrary.simpleMessage("Commerce demandé"),
    "reset" : MessageLookupByLibrary.simpleMessage("EFFACER"),
    "resetTitle" : MessageLookupByLibrary.simpleMessage("Réinitialiser le formulaire"),
    "restoreWallet" : MessageLookupByLibrary.simpleMessage("RESTAURER"),
    "retryActivating" : MessageLookupByLibrary.simpleMessage("Nouvelle tentative d\'activation de toutes les pièces..."),
    "retryAll" : MessageLookupByLibrary.simpleMessage("Réessayez d\'activer tout"),
    "rewardsButton" : MessageLookupByLibrary.simpleMessage("Réclamer votre récompense"),
    "rewardsCancel" : MessageLookupByLibrary.simpleMessage("Annuler"),
    "rewardsError" : MessageLookupByLibrary.simpleMessage("Quelque chose s\'est mal passé. Veuillez réessayer plus tard."),
    "rewardsInProgressLong" : MessageLookupByLibrary.simpleMessage("La transaction est en cours"),
    "rewardsInProgressShort" : MessageLookupByLibrary.simpleMessage("En traitement"),
    "rewardsLowAmountLong" : MessageLookupByLibrary.simpleMessage("Montant UTXO inférieur à 10 KMD"),
    "rewardsLowAmountShort" : MessageLookupByLibrary.simpleMessage("<10 KMD"),
    "rewardsOneHourLong" : MessageLookupByLibrary.simpleMessage("Une heure pas encore passée"),
    "rewardsOneHourShort" : MessageLookupByLibrary.simpleMessage("<1 hour"),
    "rewardsPopupOk" : MessageLookupByLibrary.simpleMessage("Ok"),
    "rewardsPopupTitle" : MessageLookupByLibrary.simpleMessage("Statut récompense:"),
    "rewardsReadMore" : MessageLookupByLibrary.simpleMessage("En savoir plus sur les récompenses des utilisateurs actifs KMD"),
    "rewardsReceive" : MessageLookupByLibrary.simpleMessage("Recevoir"),
    "rewardsSuccess" : m72,
    "rewardsTableFiat" : MessageLookupByLibrary.simpleMessage("Fiat"),
    "rewardsTableRewards" : MessageLookupByLibrary.simpleMessage("Récompense,\nKMD"),
    "rewardsTableStatus" : MessageLookupByLibrary.simpleMessage("Statut"),
    "rewardsTableTime" : MessageLookupByLibrary.simpleMessage("Temps restant"),
    "rewardsTableTitle" : MessageLookupByLibrary.simpleMessage("Information récompense:"),
    "rewardsTableUXTO" : MessageLookupByLibrary.simpleMessage("mnt UTXO,\nKMD"),
    "rewardsTimeDays" : m73,
    "rewardsTimeHours" : m74,
    "rewardsTimeMin" : m75,
    "rewardsTitle" : MessageLookupByLibrary.simpleMessage("Information récompense"),
    "russianLanguage" : MessageLookupByLibrary.simpleMessage("Russe"),
    "saveMerged" : MessageLookupByLibrary.simpleMessage("Enregistrer fusionné"),
    "searchFilterCoin" : MessageLookupByLibrary.simpleMessage("Rechercher une crypto-monnaie"),
    "searchFilterSubtitleAVX" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens Avax"),
    "searchFilterSubtitleBEP" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens BEP"),
    "searchFilterSubtitleERC" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens ERC"),
    "searchFilterSubtitleETC" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens ETC"),
    "searchFilterSubtitleFTM" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens Fantom"),
    "searchFilterSubtitleHCO" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens HecoChain"),
    "searchFilterSubtitleHRC" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens Harmony"),
    "searchFilterSubtitleKRC" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens Kucoin"),
    "searchFilterSubtitleMVR" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens Moonriver"),
    "searchFilterSubtitlePLG" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens Polygon"),
    "searchFilterSubtitleQRC" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens QRC"),
    "searchFilterSubtitleSBCH" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens SmartBCH"),
    "searchFilterSubtitleSmartChain" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens SmartChains"),
    "searchFilterSubtitleTestCoins" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens Test Assets"),
    "searchFilterSubtitleUBQ" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens Ubiq"),
    "searchFilterSubtitleutxo" : MessageLookupByLibrary.simpleMessage("Sélectionner tous les tokens UTXO"),
    "searchForTicker" : MessageLookupByLibrary.simpleMessage("Rechercher un téléscripteur"),
    "seconds" : MessageLookupByLibrary.simpleMessage("s"),
    "security" : MessageLookupByLibrary.simpleMessage("Sécurité"),
    "seeOrders" : m76,
    "seeTxHistory" : MessageLookupByLibrary.simpleMessage("Voir l\'historique de transaction"),
    "seedPhrase" : MessageLookupByLibrary.simpleMessage("Passphrases"),
    "seedPhraseTitle" : MessageLookupByLibrary.simpleMessage("Votre nouvelle passphrase"),
    "selectCoin" : MessageLookupByLibrary.simpleMessage("Choisir crypto-monnaie"),
    "selectCoinInfo" : MessageLookupByLibrary.simpleMessage("Sélectionnez les crypto-monnaie que vous souhaitez ajouter à votre portefeuille."),
    "selectCoinTitle" : MessageLookupByLibrary.simpleMessage("Activer les crypto-monnaie:"),
    "selectCoinToBuy" : MessageLookupByLibrary.simpleMessage("Sélectionnez la crypto-monnaie que vous souhaitez acheter"),
    "selectCoinToSell" : MessageLookupByLibrary.simpleMessage("Sélectionnez la crypto-monnaie que vous souhaitez vendre"),
    "selectFileImport" : MessageLookupByLibrary.simpleMessage("Selectionner fichier"),
    "selectLanguage" : MessageLookupByLibrary.simpleMessage("Selectionner langue"),
    ...
    "settingDialogSpan2" : MessageLookupByLibrary.simpleMessage("portefeuille?"),
    "settingDialogSpan3" : MessageLookupByLibrary.simpleMessage("Si oui, assurez-vous de"),
    "settingDialogSpan4" : MessageLookupByLibrary.simpleMessage("enregistrez votre passphrase."),
    "settingDialogSpan5" : MessageLookupByLibrary.simpleMessage("Afin de restaurer votre portefeuille à l\'avenir."),
    ...
    "showMyOrders" : MessageLookupByLibrary.simpleMessage("MONTRER MES COMMANDES"),
    "signInWithPassword" : MessageLookupByLibrary.simpleMessage("Se connecter avec mot de passe"),
    "signInWithSeedPhrase" : MessageLookupByLibrary.simpleMessage("Connectez-vous avec la passphrase"),
    ...
    "simpleTradeShowLess" : MessageLookupByLibrary.simpleMessage("Afficher moins"),
    "simpleTradeShowMore" : MessageLookupByLibrary.simpleMessage("Afficher plus"),
    ...
    "soundSettingsTitle" : MessageLookupByLibrary.simpleMessage("Paramètres son"),
    "soundsDialogTitle" : MessageLookupByLibrary.simpleMessage("Sons"),
    "soundsDoNotShowAgain" : MessageLookupByLibrary.simpleMessage("Compris, ne plus afficher"),
    "soundsExplanation" : MessageLookupByLibrary.simpleMessage("Vous entendrez des notifications sonores pendant le processus d\'échange et lorsqu\'une commande de fabricant active sera passée.\nLe protocole d\'échange atomique exige que les participants soient en ligne pour un échange réussi, et des notifications sonores aident à y parvenir."),
    "soundsNote" : MessageLookupByLibrary.simpleMessage("Notez que vous pouvez définir vos sons personnalisés dans les paramètres de l\'application."),
    ...
    "swapDetailTitle" : MessageLookupByLibrary.simpleMessage("CONFIRMEZ LES DÉTAILS DE L’ÉCHANGE"),
    "swapEstimated" : MessageLookupByLibrary.simpleMessage("Estimation"),
    "swapFailed" : MessageLookupByLibrary.simpleMessage("L\'échange a échoué"),
    "swapGasActivate" : m86,
    "swapGasAmount" : m87,
    "swapGasAmountRequired" : m88,
    "swapOngoing" : MessageLookupByLibrary.simpleMessage("Echange en cours"),
    "swapProgress" : MessageLookupByLibrary.simpleMessage("Détails de la progression"),
    ...
    "titleCreatePassword" : MessageLookupByLibrary.simpleMessage("CRÉER UN MOT DE PASSE"),
    "titleCurrentAsk" : MessageLookupByLibrary.simpleMessage("Ordre sélectionnés"),
    "to" : MessageLookupByLibrary.simpleMessage("À"),
    "toAddress" : MessageLookupByLibrary.simpleMessage("Adresse de destination:"),
    "tooManyAssetsEnabledSpan1" : MessageLookupByLibrary.simpleMessage("Vous avez"),
    "tooManyAssetsEnabledSpan2" : MessageLookupByLibrary.simpleMessage(" actifs activés. La limite maximale des éléments activés est"),
    "tooManyAssetsEnabledSpan3" : MessageLookupByLibrary.simpleMessage(". Veuillez en désactiver certains avant d\'en ajouter de nouveaux."),
    "tooManyAssetsEnabledTitle" : MessageLookupByLibrary.simpleMessage("Trop d\'éléments activés"),
    ...
    "txFeeTitle" : MessageLookupByLibrary.simpleMessage("frais transactions:"),
    "txHash" : MessageLookupByLibrary.simpleMessage("Identifiant de transaction"),
    "txLimitExceeded" : MessageLookupByLibrary.simpleMessage("Trop de demandes.\nLimite de demandes d\'historique des transactions dépassée.\nVeuillez réessayer plus tard."),
    ...
    "updatesAvailable" : MessageLookupByLibrary.simpleMessage("Nouvelle version disponible"),
    "updatesChecking" : MessageLookupByLibrary.simpleMessage("Recherche de mise à jour..."),
    "updatesCurrentVersion" : m91,
    "updatesNotifAvailable" : MessageLookupByLibrary.simpleMessage("Nouvelle version disponible. Veuillez mettre à jour."),
    "updatesNotifAvailableVersion" : m92,
    "updatesNotifTitle" : MessageLookupByLibrary.simpleMessage("Mise à jour disponible"),
    "updatesSkip" : MessageLookupByLibrary.simpleMessage("Ignorer pour l\'instant"),
    "updatesTitle" : m93,
    ...
    "uriInsufficientBalanceSpan1" : MessageLookupByLibrary.simpleMessage("Pas assez de solde pour numériser"),
    "uriInsufficientBalanceSpan2" : MessageLookupByLibrary.simpleMessage("demander paiement."),
    "uriInsufficientBalanceTitle" : MessageLookupByLibrary.simpleMessage("Balance insuffisante"),
    ...
    "viewSeedAndKeys" : MessageLookupByLibrary.simpleMessage("Passphrases et Clés Privées"),
    "volumes" : MessageLookupByLibrary.simpleMessage("Les volumes"),
    "walletInUse" : MessageLookupByLibrary.simpleMessage("Le nom du Portefeuille existe déjà"),
    "walletMaxChar" : MessageLookupByLibrary.simpleMessage("Le nom du Portefeuille ne doit pas dépasser 40 charactères"),
    ...
    "willBeRedirected" : MessageLookupByLibrary.simpleMessage("Vous serez redirigé vers la page du portfolio à la fin."),
    "withdraw" : MessageLookupByLibrary.simpleMessage("Envoyer"),
    "withdrawCameraAccessText" : m97,
    "withdrawCameraAccessTitle" : MessageLookupByLibrary.simpleMessage("Accès refusé"),
    "withdrawConfirm" : MessageLookupByLibrary.simpleMessage("Confirmer le retrait"),
    "withdrawConfirmError" : MessageLookupByLibrary.simpleMessage("Un problème est survenu. Réessayez plus tard."),
    "withdrawValue" : m98,
    "wrongCoinSpan1" : MessageLookupByLibrary.simpleMessage("Vous essayez de scanner un code QR de paiement pour"),
    "wrongCoinSpan2" : MessageLookupByLibrary.simpleMessage(" mais tu es sur"),
    "wrongCoinSpan3" : MessageLookupByLibrary.simpleMessage(" retirer l\'écran"),
    "wrongCoinTitle" : MessageLookupByLibrary.simpleMessage("Mauvaise crypto-monnaie"),
    "wrongPassword" : MessageLookupByLibrary.simpleMessage("Le mot de passe ne correspond pas. Veuillez réessayer."),
    "yes" : MessageLookupByLibrary.simpleMessage("Oui"),
    "you have a fresh order that is trying to match with an existing order" : MessageLookupByLibrary.simpleMessage("vous avez une nouvelle commande qui essaie de correspondre à une commande existante"),
    "you have an active swap in progress" : MessageLookupByLibrary.simpleMessage("vous avez un échange actif en cours"),
    "you have an order that new orders can match with" : MessageLookupByLibrary.simpleMessage("vous avez une commande avec laquelle de nouvelles commandes peuvent correspondre"),
    "youAreSending" : MessageLookupByLibrary.simpleMessage("Vous envoyez:"),
    "youWillReceiveClaim" : m99,
    "youWillReceived" : MessageLookupByLibrary.simpleMessage("Vous allez recevoir:"),
