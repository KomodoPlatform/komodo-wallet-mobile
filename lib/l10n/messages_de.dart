...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(index) => "Wie lautet das ${index} . Wort";

  static m2(index) => "Was ist das ${index} . Wort in Ihrem Seed?";
  ...
  static m16(appName) =>
      "Endbenutzer-Lizenzvertrag (EULA) von atomicDEX mobile:\n\n";
  ...
  static m19(amount) => "Klicken Sie hier, um ${amount} Orders zu sehen";

  static m20(coinName, address) => "Meine ${coinName} Adresse: ${address}";

  static m21(appName) =>
      "AtomicDEX mobile ist eine digitale Geldbörse mit nativer DEX-Funktion der dritten Generation und vielem mehr.";

  static m22(amount, coinName) => "SENDEN ${amount} ${coinName}";

  static m23(amount, coin) => "Sie erhalten ${amount} ${coin}";
