...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(abbr) => "Sie können kein Guthaben an die ${abbr} Adresse senden, da ${abbr} nicht aktiviert ist. Bitte gehen Sie zum Portfolio.";

  static m3(appName) => "Nein! ${appName} hat keine Vormundschaft. Wir speichern niemals sensible Daten, einschließlich Ihrer privaten Schlüssel, Seed-Phrasen oder PINs. Diese Daten werden nur auf dem Gerät des Benutzers gespeichert und verlassen es nie. Sie haben die volle Kontrolle über Ihr Vermögen.";

  static m4(appName) => "${appName} ist auf Mobilgeräten für Android und iPhone sowie auf dem Desktop für Windows, Mac und Linux Betriebssystemen erhältlich.";

  static m5(appName) => "Bei anderen DEXs können Sie im Allgemeinen nur Assets handeln, die auf einem einzigen Blockchain-Netzwerk basieren, Proxy-Token verwenden und nur einen einzigen Auftrag mit denselben Geldmitteln aufgeben.\n\n${appName} ermöglicht Ihnen den nativen Handel über zwei verschiedene Blockchain-Netzwerke ohne Proxy-Tokens. Sie können auch mehrere Aufträge mit demselben Guthaben platzieren. Sie können zum Beispiel 0,1 BTC für KMD, QTUM oder VRSC verkaufen - der erste Auftrag, der ausgeführt wird, storniert automatisch alle anderen Aufträge.";

  static m6(appName) => "Mehrere Faktoren bestimmen die Bearbeitungszeit für einen Swap. Die Blockzeit der gehandelten Assets hängt vom jeweiligen Netzwerk ab (Bitcoin ist normalerweise das langsamste). Außerdem kann der Benutzer die Sicherheitseinstellungen anpassen. Zum Beispiel (können Sie ${appName} bitten, eine KMD-Transaktion nach nur 3 Bestätigungen als endgültig zu betrachten, wodurch die Swap-Zeit kürzer wird als beim Warten auf eine <a href=\"https://komodoplatform.com/security-delayed-proof-of-work-dpow/\">Beglaubigung</a>";

  static m7(appName) => "Beim Handel auf ${appName} sind zwei Gebührenkategorien zu berücksichtigen.\n\n1. ${appName} berechnet ungefähr 0,13 % (1/777 des Handelsvolumens, aber nicht weniger als 0,0001) als Handelsgebühr für Taker-Aufträge, Maker-Aufträge haben keine Gebühren.\n\n2. Sowohl Maker als auch Taker müssen normale Netzwerkgebühren an die beteiligten Blockchains zahlen, wenn sie Atomic-Swap-Transaktionen durchführen.\n\nDie Netzwerkgebühren können je nach ausgewähltem Handelspaar stark variieren.";

  static m8(name, link, appName, appCompanyShort) => "Ja! ${appName} bietet Support über den <a href=\"${link}\">${appCompanyShort} ${name}</a>. Das Team und die Community helfen Euch gerne weiter!\n";

  static m9(appName) => "Nein! ${appName} ist vollständig dezentralisiert. Es ist nicht möglich, den Benutzerzugang durch Dritte zu beschränken.";

  static m10(appName, appCompanyShort) => "${appName} wird vom ${appCompanyShort}-Team entwickelt. ${appCompanyShort} ist eines der etabliertesten Blockchain-Projekte, das an innovativen Lösungen wie Atomic Swaps, Delayed Proof of Work und einer interoperablen Multi-Chain-Architektur arbeitet.";

  static m11(appName) => "Auf jeden Fall! Sie können unsere <a href=\"https://developers.atomicdex.io/\">Entwicklerdokumentation</a> für weitere Details lesen oder uns mit Ihren Partnerschaftsanfragen kontaktieren. Haben Sie eine spezielle technische Frage? Die ${appName}-Entwicklercommunity ist immer bereit zu helfen!";

  static m12(batteryLevelCritical) => "Der Akkustand ist kritisch (${batteryLevelCritical}%) um einen Swap sicher auszuführen. Bitte laden Sie ihr Handy auf und versuchen es später noch einmal.";

  static m13(batteryLevelLow) => "Ihre Akkuladung ist niedriger als ${batteryLevelLow} %. Bitte denken Sie an das Aufladen des Telefons.";

  static m14(seconde) => "Auftragsvermittlung läuft, bitte warten Sie ${seconde} Sekunden!";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "Can\'t play that" : MessageLookupByLibrary.simpleMessage("Kann nicht abgespielt werden"),
    "Failed" : MessageLookupByLibrary.simpleMessage("Fehlgeschlagen"),
    "Maker" : MessageLookupByLibrary.simpleMessage("Maker"),
    "Play at full volume" : MessageLookupByLibrary.simpleMessage("In voller Lautstärke abspielen"),
    "Sound" : MessageLookupByLibrary.simpleMessage("Sound"),
    "Taker" : MessageLookupByLibrary.simpleMessage("Taker"),
    "a swap fails" : MessageLookupByLibrary.simpleMessage("ein Swap ist fehlgeschlagen"),
    "a swap runs to completion" : MessageLookupByLibrary.simpleMessage("ein Swap läuft bis zur Fertigstellung"),
    "accepteula" : MessageLookupByLibrary.simpleMessage("EULA akzeptieren"),
    "accepttac" : MessageLookupByLibrary.simpleMessage("Allgemeine Geschäftsbedingungen akzeptieren"),
    "activateAccessBiometric" : MessageLookupByLibrary.simpleMessage("Biometrischen Schutz aktivieren"),
    ...
    "addressAdd" : MessageLookupByLibrary.simpleMessage("Adresse hinzufügen"),
    "addressBook" : MessageLookupByLibrary.simpleMessage("Adressbuch"),
    "addressBookEmpty" : MessageLookupByLibrary.simpleMessage("Adressbuch ist leer"),
    "addressBookFilter" : m1,
    "addressBookTitle" : MessageLookupByLibrary.simpleMessage("Adressbuch"),
    "addressCoinInactive" : m2,
    "addressNotFound" : MessageLookupByLibrary.simpleMessage("Nichts gefunden"),
    "addressSelectCoin" : MessageLookupByLibrary.simpleMessage("Coin auswählen"),
    ...
    "allowCustomSeed" : MessageLookupByLibrary.simpleMessage("Benutzerdefinierten Seed erlauben"),
    "alreadyExists" : MessageLookupByLibrary.simpleMessage("Ist bereits vorhanden"),
    "amount" : MessageLookupByLibrary.simpleMessage("Menge"),
    "amountToSell" : MessageLookupByLibrary.simpleMessage("Zu verkaufende Menge"),
    "answer_1" : m3,
    "answer_10" : m4,
    "answer_2" : m5,
    "answer_3" : m6,
    ...
    "automaticRedirected" : MessageLookupByLibrary.simpleMessage("Sie werden automatisch zur Portfolio-Seite weitergeleitet, wenn der erneute Aktivierungsprozess abgeschlossen ist."),
    ...
    "batterySavingWarning" : MessageLookupByLibrary.simpleMessage("Ihr  Handy ist im Energissparmodus. Bitte deaktivieren Sie diesen Modus oder gehen Sie mit der App NICHT im Hintergrundmodus. Andernfalls könnte die App durch das Betriebssystem beendet werden und der Swap schlägt fehl."),
    "bestAvailableRate" : MessageLookupByLibrary.simpleMessage("Wechselkurs"),
    "builtKomodo" : MessageLookupByLibrary.simpleMessage("Auf Komodo aufgebaut"),
    "builtOnKmd" : MessageLookupByLibrary.simpleMessage("Auf Komodo aufgebaut"),
    "buy" : MessageLookupByLibrary.simpleMessage("Kaufen"),
    "buyOrderType" : MessageLookupByLibrary.simpleMessage("In Maker-Auftrag umwandeln, wenn kein match stattgefunden hat"),
    "buySuccessWaiting" : MessageLookupByLibrary.simpleMessage("Swap gestartet, bitte warten!"),
    "buySuccessWaitingError" : m14,
    "buyTestCoinWarning" : MessageLookupByLibrary.simpleMessage("Warnung, Sie möchten Test-Coins ohne tatsächlichen Wert kaufen!"),
    "camoPinBioProtectionConflict" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN und Bio-Schutz können nicht gleichzeitig aktiviert werden."),
    "camoPinBioProtectionConflictTitle" : MessageLookupByLibrary.simpleMessage("Konflikt zwischen Carmo-PIN und Bio-Schutz."),
    "camoPinChange" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN ändern"),
    "camoPinCreate" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN erstellen"),
    "camoPinDesc" : MessageLookupByLibrary.simpleMessage("Wenn Sie die App mit der Tarnungs-PIN entsperren, wird ein gefälschtes NIEDRIGERES Guthaben angezeigt und die Konfigurationsoption Tarnungs-PIN ist in den Einstellungen NICHT sichtbar."),
    "camoPinInvalid" : MessageLookupByLibrary.simpleMessage("ungültiger Tarnungs-PIN"),
    "camoPinLink" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN"),
    "camoPinNotFound" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN nicht gefunden"),
    "camoPinOff" : MessageLookupByLibrary.simpleMessage("Aus"),
    "camoPinOn" : MessageLookupByLibrary.simpleMessage("An"),
    "camoPinSaved" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN gespeichert"),
    "camoPinTitle" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN"),
    "camoSetupSubtitle" : MessageLookupByLibrary.simpleMessage("Neuen Tarnungs-PIN eingeben"),
    "camoSetupTitle" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN Einrichtung"),
    "camouflageSetup" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN Einrichtung"),
    "cancel" : MessageLookupByLibrary.simpleMessage("stornieren"),
    "cancelButton" : MessageLookupByLibrary.simpleMessage("stornieren"),
    "cancelOrder" : MessageLookupByLibrary.simpleMessage("Auftrag stornieren"),
    "candleChartError" : MessageLookupByLibrary.simpleMessage("Es ist ein Fehler aufgetreten. Bitte versuchen Sie es später noch einmal."),
    "cantDeleteDefaultCoinOk" : MessageLookupByLibrary.simpleMessage("Ok"),
    "cantDeleteDefaultCoinSpan" : MessageLookupByLibrary.simpleMessage("ist ein Standard-Coin. Standard-Coins können nicht deaktiviert werden."),
    "cantDeleteDefaultCoinTitle" : MessageLookupByLibrary.simpleMessage("Kann nicht deaktiviert werden"),
    ...
    "cexDataDesc" : MessageLookupByLibrary.simpleMessage("Die mit diesem Symbol gekennzeichneten Marktdaten (Kurse, Charts usw.) stammen aus Drittquellen (<a href=\"https://www.coingecko.com/\">coingecko.com</a>, <a href=\"https://openrates.io/\">openrates.io</a>)."),
    "changePin" : MessageLookupByLibrary.simpleMessage("PIN-Code ändern"),
    "checkForUpdates" : MessageLookupByLibrary.simpleMessage("Nach Updates suchen"),
    "checkOut" : MessageLookupByLibrary.simpleMessage("Abmelden"),
    "checkSeedPhrase" : MessageLookupByLibrary.simpleMessage("Seed-Phrase überprüfen"),
    "checkSeedPhraseButton1" : MessageLookupByLibrary.simpleMessage("WEITER"),
    "checkSeedPhraseButton2" : MessageLookupByLibrary.simpleMessage("ZURÜCK UND ERNEUT ÜBERPRÜFEN"),
    ...
    "closeMessage" : MessageLookupByLibrary.simpleMessage("Fehlermeldung schließen"),
    "closePreview" : MessageLookupByLibrary.simpleMessage("Vorschau schließen"),
    "code" : MessageLookupByLibrary.simpleMessage("Code:"),
    "coinSelectClear" : MessageLookupByLibrary.simpleMessage("Löschen"),
    "coinSelectNotFound" : MessageLookupByLibrary.simpleMessage("keine aktivierten Coins"),
    "coinSelectTitle" : MessageLookupByLibrary.simpleMessage("Coin auswählen"),
    ...
    "comparedToCex" : MessageLookupByLibrary.simpleMessage("im Vergleich zu CEX"),
    "configureWallet" : MessageLookupByLibrary.simpleMessage("Bitte warten, ihre Wallet wird konfiguriert..."),
    "confirm" : MessageLookupByLibrary.simpleMessage("Bestätigen"),
    "confirmCamouflageSetup" : MessageLookupByLibrary.simpleMessage("Tarnungs-PIN bestätigen"),
    "confirmCancel" : MessageLookupByLibrary.simpleMessage("Wollen Sie die Order wirklich stornieren?"),
    "confirmPassword" : MessageLookupByLibrary.simpleMessage("Kennwort bestätigen"),
    ...
    "contactDelete" : MessageLookupByLibrary.simpleMessage("Kontakt löschen"),
    ...
    "contactExitWarning" : MessageLookupByLibrary.simpleMessage("Änderungen verwerfen?"),
    "contactNotFound" : MessageLookupByLibrary.simpleMessage("Keine Kontakte gefunden"),
    ...
    "couldntImportError" : MessageLookupByLibrary.simpleMessage("Konnte nicht importiert werden:"),
    "create" : MessageLookupByLibrary.simpleMessage("Handeln"),
    "createAWallet" : MessageLookupByLibrary.simpleMessage("Wallet erstellen"),
    "createContact" : MessageLookupByLibrary.simpleMessage("Kontakt erstellen"),
    ...
    "customFee" : MessageLookupByLibrary.simpleMessage("Individuelle Gebühr"),
    "customFeeWarning" : MessageLookupByLibrary.simpleMessage("Individuelle Gebühr nur nutzen, wenn Sie wissen was darunter zu verstehen ist!"),
    ...
    "deleteConfirm" : MessageLookupByLibrary.simpleMessage("Deaktivierung bestätigen"),
    "deleteSpan1" : MessageLookupByLibrary.simpleMessage("Möchten Sie"),
    "deleteSpan2" : MessageLookupByLibrary.simpleMessage("von ihrem Portfolio entfernen? Alle offenen Aufträge werden storniert."),
    "deleteWallet" : MessageLookupByLibrary.simpleMessage("Wallet löschen"),
    "deletingWallet" : MessageLookupByLibrary.simpleMessage("Wallet wird gelöscht..."),
    ...
    "dexIsNotAvailable" : MessageLookupByLibrary.simpleMessage("DEX ist für diesen Coin nicht verfügbar"),
    ...
    "dontAskAgain" : MessageLookupByLibrary.simpleMessage("Nicht mehr nachfragen"),
    "dontWantPassword" : MessageLookupByLibrary.simpleMessage("Ich möchte kein Kennwort"),
    "duration" : MessageLookupByLibrary.simpleMessage("Dauer"),
    "editContact" : MessageLookupByLibrary.simpleMessage("Kontakt bearbeiten"),
    "emptyCoin" : m19,
    "emptyExportPass" : MessageLookupByLibrary.simpleMessage("Verschlüsselungskennwort darf nicht leer sein"),
    "emptyImportPass" : MessageLookupByLibrary.simpleMessage("Kennwort darf nicht leer sein"),
    "emptyName" : MessageLookupByLibrary.simpleMessage("Kontakt-Name darf nicht leer sein"),
    "emptyWallet" : MessageLookupByLibrary.simpleMessage("Wallet-Name darf nicht leer sein"),
    "enableTestCoins" : MessageLookupByLibrary.simpleMessage("Test-Coins aktivieren"),
    "enablingTooManyAssetsSpan1" : MessageLookupByLibrary.simpleMessage("Sie haben"),
    "enablingTooManyAssetsSpan2" : MessageLookupByLibrary.simpleMessage("Assets aktivert und versuchen"),
    "enablingTooManyAssetsSpan3" : MessageLookupByLibrary.simpleMessage("weitere zu aktivieren. Das Maximallimit beträgt"),
    "enablingTooManyAssetsSpan4" : MessageLookupByLibrary.simpleMessage(". Bitte deaktivieren sie welche, bevor neue aktiviert werden."),
    "enablingTooManyAssetsTitle" : MessageLookupByLibrary.simpleMessage("Es wurde versucht, zu viele Assets zu aktivieren"),
    ...
    "enterNewPinCode" : MessageLookupByLibrary.simpleMessage("Geben Sie ihren neuen PIN ein"),
    "enterOldPinCode" : MessageLookupByLibrary.simpleMessage("Geben Sie ihren alten PIN ein"),
    "enterPinCode" : MessageLookupByLibrary.simpleMessage("Geben Sie Ihren PIN-Code ein"),
    "enterSeedPhrase" : MessageLookupByLibrary.simpleMessage("Geben Sie Ihre Seed-Phrase ein"),
    "enterSellAmount" : MessageLookupByLibrary.simpleMessage("Sie müssen zuerst die Verkaufsmenge eingeben"),
    "enterpassword" : MessageLookupByLibrary.simpleMessage("Bitte Kennwort eingeben um fortzufahren."),
    "errorAmountBalance" : MessageLookupByLibrary.simpleMessage("Guthaben unzureichend"),
    "errorNotAValidAddress" : MessageLookupByLibrary.simpleMessage("Ungültige Adresse"),
    "errorNotAValidAddressSegWit" : MessageLookupByLibrary.simpleMessage("Segwit-Adressen werden (noch) nicht unterstützt"),
    ...
    "estimateValue" : MessageLookupByLibrary.simpleMessage("Geschätzter Gesamtwert"),
    "eulaParagraphe1" : m21,
    ...
    "exchangeIdentical" : MessageLookupByLibrary.simpleMessage("Identisch mit CEX"),
    ...
    "exportDesc" : MessageLookupByLibrary.simpleMessage("Bitte wählen Sie die Elemente aus, die in eine verschlüsselte Datei exportiert werden sollen."),
    ...
    "exportSuccessTitle" : MessageLookupByLibrary.simpleMessage("Die Elemente wurden erfolgreich exportiert:"),
    "exportSwapsTitle" : MessageLookupByLibrary.simpleMessage("Swaps"),
    "exportTitle" : MessageLookupByLibrary.simpleMessage("Exportieren"),
    "fakeBalanceAmt" : MessageLookupByLibrary.simpleMessage("Gefälschter Guthaben:"),
    ...
    "faucetTimedOut" : MessageLookupByLibrary.simpleMessage("Zeitüberschreitung der Anfrage"),
    "feedNewsTab" : MessageLookupByLibrary.simpleMessage("Neuigkeiten"),
    "feedNotFound" : MessageLookupByLibrary.simpleMessage("Hier gibt es nichts"),
    "feedNotifTitle" : m36,
    ...
    "feedUnableToProceed" : MessageLookupByLibrary.simpleMessage("Aktualisierung der Nachrichten kann nicht fortgesetzt werden"),
    "feedUnableToUpdate" : MessageLookupByLibrary.simpleMessage("Nachrichten können nicht aktualisiert werden"),
    "feedUpToDate" : MessageLookupByLibrary.simpleMessage("Bereits auf dem neuesten Stand"),
    "feedUpdated" : MessageLookupByLibrary.simpleMessage("Newsfeed aktualisiert"),
    "feedback" : MessageLookupByLibrary.simpleMessage("Protokolldatei teilen"),
    "filtersAll" : MessageLookupByLibrary.simpleMessage("Alle"),
    "filtersButton" : MessageLookupByLibrary.simpleMessage("Filter"),
    "filtersClearAll" : MessageLookupByLibrary.simpleMessage("Alle Filter löschen"),
    ...
    "filtersSuccessful" : MessageLookupByLibrary.simpleMessage("Erfolgreich"),
    ...
    "generalPinNotActive" : MessageLookupByLibrary.simpleMessage("Der allgemeine PIN-Schutz ist nicht aktiv.\nDer Tarnungsmodus ist nicht verfügbar.\nBitte aktivieren Sie den PIN-Schutz."),
    ...
    "hideBalance" : MessageLookupByLibrary.simpleMessage("Guthaben ausblenden"),
    "hintConfirmPassword" : MessageLookupByLibrary.simpleMessage("Kennwort bestätigen"),
    "hintCreatePassword" : MessageLookupByLibrary.simpleMessage("Kennwort erstellen"),
    "hintCurrentPassword" : MessageLookupByLibrary.simpleMessage("Aktuelles Kennwort"),
    "hintEnterPassword" : MessageLookupByLibrary.simpleMessage("Geben Sie Ihr Kennwort ein"),
    "hintEnterSeedPhrase" : MessageLookupByLibrary.simpleMessage("Geben Sie Ihren Seed ein"),
    "hintNameYourWallet" : MessageLookupByLibrary.simpleMessage("Benennen Sie Ihr Wallet"),
    ...
    "iUnderstand" : MessageLookupByLibrary.simpleMessage("Ich habe verstanden"),
    "importButton" : MessageLookupByLibrary.simpleMessage("Importieren"),
    "importDecryptError" : MessageLookupByLibrary.simpleMessage("Ungültiges Kennwort oder beschädigte Daten"),
    "importDesc" : MessageLookupByLibrary.simpleMessage("Zu importierende Gegenstände:"),
    "importFileNotFound" : MessageLookupByLibrary.simpleMessage("Datei nicht gefunden"),
    "importInvalidSwapData" : MessageLookupByLibrary.simpleMessage("Ungültige Swap-Daten. Bitte geben Sie eine gültige Swap-Status JSON-Datei an."),
    "importLink" : MessageLookupByLibrary.simpleMessage("Importieren"),
    "importLoadDesc" : MessageLookupByLibrary.simpleMessage("Bitte wählen Sie eine verschlüsselte Datei zum Importieren aus."),
    "importLoadSwapDesc" : MessageLookupByLibrary.simpleMessage("Bitte wählen Sie eine einfache Textauslagerungsdatei zum Importieren aus."),
    ...
    "importSingleSwapLink" : MessageLookupByLibrary.simpleMessage("Einzigen Swap importieren"),
    "importSingleSwapTitle" : MessageLookupByLibrary.simpleMessage("Swaps importieren"),
    "importSomeItemsSkippedWarning" : MessageLookupByLibrary.simpleMessage("Einige Elemente wurden übersprungen"),
    "importSuccessTitle" : MessageLookupByLibrary.simpleMessage("Die Elemente wurden erfolgreich importiert:"),
    "importSwapFailed" : MessageLookupByLibrary.simpleMessage("Import von Swaps fehlgeschlagen"),
    "importSwapJsonDecodingError" : MessageLookupByLibrary.simpleMessage("Fehler beim Dekodieren der json-Datei"),
    "importTitle" : MessageLookupByLibrary.simpleMessage("Importieren"),
    "infoPasswordDialog" : MessageLookupByLibrary.simpleMessage("Verwenden Sie ein sicheres Kennwort und speichern Sie es nicht auf demselben Gerät"),
    "infoTrade1" : MessageLookupByLibrary.simpleMessage("Der Swap kann nicht rückgängig gemacht werden und ist ein endgültiges Ereignis!"),
    "infoTrade2" : MessageLookupByLibrary.simpleMessage("Der Swap kann bis zu 60 Minuten dauern. Schließen Sie diese Anwendung NICHT!"),
    "infoWalletPassword" : MessageLookupByLibrary.simpleMessage("Aus Sicherheitsgründen müssen Sie ein Kennwort für die Verschlüsselung ihres Wallets angeben."),
    "insufficientBalanceToPay" : m39,
    "insufficientText" : MessageLookupByLibrary.simpleMessage("Die Mindestmenge, die für diesen Auftrag erforderlich ist, beträgt"),
    "insufficientTitle" : MessageLookupByLibrary.simpleMessage("Unzureichendes Volumen"),
    "internetRefreshButton" : MessageLookupByLibrary.simpleMessage("Aktualisieren"),
    "internetRestored" : MessageLookupByLibrary.simpleMessage("Internetverbindung wiederhergestellt"),
    "invalidSwap" : MessageLookupByLibrary.simpleMessage("Swap kann nicht durchgeführt werden"),
    ...
    "latestTxs" : MessageLookupByLibrary.simpleMessage("Letzte Transaktionen"),
    ...
    "logoutWarning" : MessageLookupByLibrary.simpleMessage("Sind Sie sicher, dass Sie sich jetzt abmelden möchten?"),
    ...
    "makeAorder" : MessageLookupByLibrary.simpleMessage("Einen Auftrag erstellen"),
    "makerDetailsCancel" : MessageLookupByLibrary.simpleMessage("Auftrag stornieren"),
    "makerDetailsCreated" : MessageLookupByLibrary.simpleMessage("Erstellt am"),
    ...
    "makerDetailsNoSwaps" : MessageLookupByLibrary.simpleMessage("Durch diesen Auftrag wurden keine Swaps gestartet"),
    ...
    "makerDetailsSwaps" : MessageLookupByLibrary.simpleMessage("Durch diesen Auftrag gestartete Swaps"),
    "makerDetailsTitle" : MessageLookupByLibrary.simpleMessage("Details des Maker-Auftrag"),
    ...
    "marketsNoAsks" : MessageLookupByLibrary.simpleMessage("Keine Anfragen gefunden"),
    "marketsNoBids" : MessageLookupByLibrary.simpleMessage("Keine Angebote gefunden"),
    "marketsOrderDetails" : MessageLookupByLibrary.simpleMessage("Details zum Auftrag"),
    "marketsOrderbook" : MessageLookupByLibrary.simpleMessage("AUFTRAGSBUCH"),
    "marketsPrice" : MessageLookupByLibrary.simpleMessage("PREIS"),
    "marketsSelectCoins" : MessageLookupByLibrary.simpleMessage("Bitte Coins auswählen"),
    "marketsTab" : MessageLookupByLibrary.simpleMessage("Märkte"),
    "marketsTitle" : MessageLookupByLibrary.simpleMessage("MÄRKTE"),
    "matchExportPass" : MessageLookupByLibrary.simpleMessage("Kennwörter müssen übereinstimmen"),
    "matchingCamoChange" : MessageLookupByLibrary.simpleMessage("Ändern"),
    "matchingCamoPinError" : MessageLookupByLibrary.simpleMessage("Ihre allgemeine PIN und die Tarnungs-PIN sind identisch.\nDer Tarnmodus wird nicht verfügbar sein.\nBitte ändern Sie die Tarnungs-PIN."),
    "matchingCamoTitle" : MessageLookupByLibrary.simpleMessage("Ungültige PIN"),
    "max" : MessageLookupByLibrary.simpleMessage("MAX"),
    "maxOrder" : MessageLookupByLibrary.simpleMessage("Max Auftragsvolumen:"),
    "media" : MessageLookupByLibrary.simpleMessage("Neuigkeiten"),
    "mediaBrowse" : MessageLookupByLibrary.simpleMessage("DURCHBLÄTTERN"),
    "mediaBrowseFeed" : MessageLookupByLibrary.simpleMessage("FEED DURCHBLÄTTERN"),
    ...
    "mergedValue" : MessageLookupByLibrary.simpleMessage("Zusammengefasster Wert:"),
    "milliseconds" : MessageLookupByLibrary.simpleMessage("ms"),
    "min" : MessageLookupByLibrary.simpleMessage("MIN"),
    "minOrder" : MessageLookupByLibrary.simpleMessage("Min Auftragsvolumen:"),
    "minValue" : m41,
    "minValueBuy" : m42,
    "minValueOrder" : m43,
    "minValueSell" : m44,
    "minVolumeInput" : m45,
    "minVolumeIsTDH" : MessageLookupByLibrary.simpleMessage("Muss niedriger als die Verkaufsmenge sein"),
    "minVolumeTitle" : MessageLookupByLibrary.simpleMessage("Erforderliches Mindestvolumen"),
    "minVolumeToggle" : MessageLookupByLibrary.simpleMessage("Benutzerdefiniertes Mindestvolumen verwenden"),
    ...
    "multiBaseAmtPlaceholder" : MessageLookupByLibrary.simpleMessage("Menge"),
    "multiBasePlaceholder" : MessageLookupByLibrary.simpleMessage("Coin"),
    "multiBaseSelectTitle" : MessageLookupByLibrary.simpleMessage("Verkaufen"),
    "multiConfirmCancel" : MessageLookupByLibrary.simpleMessage("Abbrechen"),
    "multiConfirmConfirm" : MessageLookupByLibrary.simpleMessage("Bestätigen"),
    ...
    "multiFiatDesc" : MessageLookupByLibrary.simpleMessage("Bitte geben Sie den gewünschten Fiat-Betrag ein:"),
    "multiFiatFill" : MessageLookupByLibrary.simpleMessage("Automatisch ausfüllen"),
    "multiFixErrors" : MessageLookupByLibrary.simpleMessage("Bitte beheben Sie alle Fehler, bevor Sie fortfahren"),
    "multiInvalidAmt" : MessageLookupByLibrary.simpleMessage("Ungültige Menge"),
    "multiInvalidSellAmt" : MessageLookupByLibrary.simpleMessage("Ungültige Verkaufsmenge"),
    "multiLowGas" : m49,
    "multiLowerThanFee" : m50,
    "multiMaxSellAmt" : MessageLookupByLibrary.simpleMessage("Max Verkaufsmenge beträgt"),
    "multiMinReceiveAmt" : MessageLookupByLibrary.simpleMessage("Der Mindestbetrag, den Sie erhalten, beträgt"),
    "multiMinSellAmt" : MessageLookupByLibrary.simpleMessage("Min Verkaufsmenge beträgt"),
    ...
    "noCoinFound" : MessageLookupByLibrary.simpleMessage("Kein Coin gefunden"),
    ...
    "noItemsToExport" : MessageLookupByLibrary.simpleMessage("Keine Elemente ausgewählt"),
    "noItemsToImport" : MessageLookupByLibrary.simpleMessage("Keine Elemente ausgewählt"),
    "noMatchingOrders" : MessageLookupByLibrary.simpleMessage("Keine übereinstimmenden Aufträge gefunden"),
    "noOrder" : m51,
    "noOrderAvailable" : MessageLookupByLibrary.simpleMessage("Klicken Sie hier, um einen Auftrag zu erstellen"),
    "noOrders" : MessageLookupByLibrary.simpleMessage("Keine Aufträge, bitte gehen Sie zum Handel."),
    "noRewardYet" : MessageLookupByLibrary.simpleMessage("Keine Belohnung verfügbar. Bitte versuchen Sie es in 1 Stunde erneut."),
    "noRewards" : MessageLookupByLibrary.simpleMessage("Keine anforderungsfähigen Belohnungen"),
    "noSuchCoin" : MessageLookupByLibrary.simpleMessage("Diese Münze gibt es nicht"),
    "noSwaps" : MessageLookupByLibrary.simpleMessage("Kein Verlauf vorhanden"),
    "noTxs" : MessageLookupByLibrary.simpleMessage("Keine Transaktionen vorhanden"),
    "nonNumericInput" : MessageLookupByLibrary.simpleMessage("Der Wert muss numerisch sein"),
    "notEnoughGas" : m52,
    "notEnoughtBalanceForFee" : MessageLookupByLibrary.simpleMessage("Nicht genügend Guthaben für Gebühren - handeln Sie einen kleinere Menge"),
    "noteOnOrder" : MessageLookupByLibrary.simpleMessage("Hinweis: Übereinstimmende Aufträge können nicht mehr storniert werden."),
    "notePlaceholder" : MessageLookupByLibrary.simpleMessage("Notiz hinzufügen"),
    ...
    "notifSwapCompletedTitle" : MessageLookupByLibrary.simpleMessage("Swap abgeschlossen"),
    "notifSwapFailedText" : m54,
    "notifSwapFailedTitle" : MessageLookupByLibrary.simpleMessage("Swap fehlgeschlagen"),
    "notifSwapStartedText" : m55,
    "notifSwapStartedTitle" : MessageLookupByLibrary.simpleMessage("Neuer swap gestartet"),
    "notifSwapStatusTitle" : MessageLookupByLibrary.simpleMessage("Swap-Status geändert"),
    "notifSwapTimeoutText" : m56,
    "notifSwapTimeoutTitle" : MessageLookupByLibrary.simpleMessage("Swap ist abgelaufen(Zeitüberschreitung)"),
    "notifTxText" : m57,
    "notifTxTitle" : MessageLookupByLibrary.simpleMessage("Eingehende Transaktion"),
    "numberAssets" : m58,
    ...
    "oldLogsUsed" : MessageLookupByLibrary.simpleMessage("Genutzter Speicher"),
    "openMessage" : MessageLookupByLibrary.simpleMessage("Fehlermeldung öffnen"),
    "orderCancel" : m59,
    "orderCreated" : MessageLookupByLibrary.simpleMessage("Auftrag erstellt"),
    "orderCreatedInfo" : MessageLookupByLibrary.simpleMessage("Auftrag erfolgreich erstellt"),
    ...
    "orderDetailsIdentical" : MessageLookupByLibrary.simpleMessage("Identisch mit CEX"),
    ...
    "orderDetailsSettings" : MessageLookupByLibrary.simpleMessage("Durch einmaliges antippen öffnen Sie die Details, durch langes antippen wählen Sie einen Auftrag"),
    ...
    "orderFilled" : m62,
    "orderMatched" : MessageLookupByLibrary.simpleMessage("Auftrag gematched!"),
    "orderMatching" : MessageLookupByLibrary.simpleMessage("Auftrag wird gematched"),
    "orderTypePartial" : MessageLookupByLibrary.simpleMessage("Auftrag"),
    "orderTypeUnknown" : MessageLookupByLibrary.simpleMessage("Unbekannter Auftragstyp"),
    ...
    "ownOrder" : MessageLookupByLibrary.simpleMessage("Dies ist Ihr eigener Auftrag!"),
    "paidFromBalance" : MessageLookupByLibrary.simpleMessage("Bezahlt aus dem Guthaben:"),
    "paidFromVolume" : MessageLookupByLibrary.simpleMessage("Bezahlt aus dem eingegangenen Volumen:"),
    "paidWith" : MessageLookupByLibrary.simpleMessage("Bezahlt mit"),
    "passwordRequirement" : MessageLookupByLibrary.simpleMessage("Das Kennwort muss mindestens 12 Zeichen enthalten, davon ein Kleinbuchstabe, ein Großbuchstabe und ein Sonderzeichen."),
    "paymentUriDetailsAccept" : MessageLookupByLibrary.simpleMessage("Bezahlen"),
    "paymentUriDetailsAcceptQuestion" : MessageLookupByLibrary.simpleMessage("Akzeptieren Sie diese Transaktion?"),
    "paymentUriDetailsAddressSpan" : MessageLookupByLibrary.simpleMessage("Nach Adresse"),
    "paymentUriDetailsAmountSpan" : MessageLookupByLibrary.simpleMessage("Menge:"),
    "paymentUriDetailsCoinSpan" : MessageLookupByLibrary.simpleMessage("Coin:"),
    "paymentUriDetailsDeny" : MessageLookupByLibrary.simpleMessage("Abbrechen"),
    "paymentUriDetailsTitle" : MessageLookupByLibrary.simpleMessage("Zahlung angefordert"),
    "paymentUriInactiveCoin" : m66,
    "placeOrder" : MessageLookupByLibrary.simpleMessage("Auftrag platzieren"),
    "pleaseAddCoin" : MessageLookupByLibrary.simpleMessage("Bitte fügen Sie einen Coin hinzu"),
    "pleaseRestart" : MessageLookupByLibrary.simpleMessage("Bitte starten Sie die App neu, um es erneut zu versuchen, oder drücken Sie die Schaltfläche unten."),
    "portfolio" : MessageLookupByLibrary.simpleMessage("Portfolio"),
    "poweredOnKmd" : MessageLookupByLibrary.simpleMessage("Unterstützt von Komodo"),
    "price" : MessageLookupByLibrary.simpleMessage("Preis"),
    "privateKey" : MessageLookupByLibrary.simpleMessage("Privater Schlüssel"),
    "privateKeys" : MessageLookupByLibrary.simpleMessage("Private Schlüssel"),
    "protectionCtrlConfirmations" : MessageLookupByLibrary.simpleMessage("Bestätigungen"),
    "protectionCtrlCustom" : MessageLookupByLibrary.simpleMessage("Individuelle Schutzeinstellungen verwenden"),
    "protectionCtrlOff" : MessageLookupByLibrary.simpleMessage("AUS"),
    "protectionCtrlOn" : MessageLookupByLibrary.simpleMessage("AN"),
    "protectionCtrlWarning" : MessageLookupByLibrary.simpleMessage("Achtung, dieser Atomic Swap ist nicht durch dPoW geschützt."),
    "pubkey" : MessageLookupByLibrary.simpleMessage("Öffentlicher Schlüssel (Pubkey)"),
    "question_1" : MessageLookupByLibrary.simpleMessage("Speichern Sie meine privaten Schlüssel?"),
    "question_10" : m67,
    "question_2" : m68,
    "question_3" : MessageLookupByLibrary.simpleMessage("Wie lange dauert ein Atomic Swap?"),
    "question_4" : MessageLookupByLibrary.simpleMessage("Muss ich für die Dauer des Swaps online sein?"),
    "question_5" : m69,
    "question_6" : MessageLookupByLibrary.simpleMessage("Bieten Sie einen Support für die Nutzer an?"),
    "question_7" : MessageLookupByLibrary.simpleMessage("Gibt es länderspezifische Einschränkungen?"),
    "question_8" : m70,
    "question_9" : m71,
    ...
    "resetTitle" : MessageLookupByLibrary.simpleMessage("Formular zurücksetzen"),
    "restoreWallet" : MessageLookupByLibrary.simpleMessage("WIEDERHERSTELLEN"),
    "retryActivating" : MessageLookupByLibrary.simpleMessage("Erneuter Versuch, alle Münzen zu aktivieren..."),
    "retryAll" : MessageLookupByLibrary.simpleMessage("Erneuter Versuch, alle zu aktivieren"),
    "rewardsButton" : MessageLookupByLibrary.simpleMessage("Belohnungen beantragen"),
    "rewardsCancel" : MessageLookupByLibrary.simpleMessage("Stornieren"),
    "rewardsError" : MessageLookupByLibrary.simpleMessage("Es ist ein Fehler aufgetreten. Bitte versuchen Sie es später noch einmal."),
    "rewardsInProgressLong" : MessageLookupByLibrary.simpleMessage("Transaktion ist in Bearbeitung"),
    "rewardsInProgressShort" : MessageLookupByLibrary.simpleMessage("in Bearbeitung"),
    "rewardsLowAmountLong" : MessageLookupByLibrary.simpleMessage("UTXO-Menge ist geringer als 10 KMD"),
    "rewardsLowAmountShort" : MessageLookupByLibrary.simpleMessage("<10 KMD"),
    "rewardsOneHourLong" : MessageLookupByLibrary.simpleMessage("Eine Stunde ist noch nicht vergangen"),
    "rewardsOneHourShort" : MessageLookupByLibrary.simpleMessage("<1 Stunde"),
    "rewardsPopupOk" : MessageLookupByLibrary.simpleMessage("Ok"),
    "rewardsPopupTitle" : MessageLookupByLibrary.simpleMessage("Belohnungsstatus:"),
    "rewardsReadMore" : MessageLookupByLibrary.simpleMessage("Lesen Sie mehr über KMD-Belohnungen für aktive Nutzer"),
    "rewardsReceive" : MessageLookupByLibrary.simpleMessage("Empfangen"),
    "rewardsSuccess" : m72,
    "rewardsTableFiat" : MessageLookupByLibrary.simpleMessage("Fiat"),
    "rewardsTableRewards" : MessageLookupByLibrary.simpleMessage("Belohnungen,\nKMD"),
    "rewardsTableStatus" : MessageLookupByLibrary.simpleMessage("Status"),
    "rewardsTableTime" : MessageLookupByLibrary.simpleMessage("Verbleibende Zeit"),
    "rewardsTableTitle" : MessageLookupByLibrary.simpleMessage("Informationen zu den Belohnungen:"),
    "rewardsTableUXTO" : MessageLookupByLibrary.simpleMessage("UTXO Menge,\nKMD"),
    "rewardsTimeDays" : m73,
    "rewardsTimeHours" : m74,
    "rewardsTimeMin" : m75,
    "rewardsTitle" : MessageLookupByLibrary.simpleMessage("Informationen zu den Belohnungen"),
    "russianLanguage" : MessageLookupByLibrary.simpleMessage("Russisch"),
    "saveMerged" : MessageLookupByLibrary.simpleMessage("Zusammenfassung speichern"),
    "searchFilterCoin" : MessageLookupByLibrary.simpleMessage("Coin suchen"),
    "searchFilterSubtitleAVX" : MessageLookupByLibrary.simpleMessage("Alle Avax tokens auswählen"),
    "searchFilterSubtitleBEP" : MessageLookupByLibrary.simpleMessage("Alle BEP tokens auswählen"),
    "searchFilterSubtitleERC" : MessageLookupByLibrary.simpleMessage("Alle ERC tokens auswählen"),
    "searchFilterSubtitleETC" : MessageLookupByLibrary.simpleMessage("Alle ETC tokens auswählen"),
    "searchFilterSubtitleFTM" : MessageLookupByLibrary.simpleMessage("Alle Fantom tokens auswählen"),
    "searchFilterSubtitleHCO" : MessageLookupByLibrary.simpleMessage("Alle HecoChain tokens auswählen"),
    "searchFilterSubtitleHRC" : MessageLookupByLibrary.simpleMessage("Alle Harmony tokens auswählen"),
    "searchFilterSubtitleKRC" : MessageLookupByLibrary.simpleMessage("Alle Kucoin tokens auswählen"),
    "searchFilterSubtitleMVR" : MessageLookupByLibrary.simpleMessage("Alle Moonriver tokens auswählen"),
    "searchFilterSubtitlePLG" : MessageLookupByLibrary.simpleMessage("Alle Polygon tokens auswählen"),
    "searchFilterSubtitleQRC" : MessageLookupByLibrary.simpleMessage("Alle QRC tokens auswählen"),
    "searchFilterSubtitleSBCH" : MessageLookupByLibrary.simpleMessage("Alle SmartBCH tokens auswählen"),
    "searchFilterSubtitleSmartChain" : MessageLookupByLibrary.simpleMessage("Alle SmartChains auswählen"),
    "searchFilterSubtitleTestCoins" : MessageLookupByLibrary.simpleMessage("Alle Test Assets auswählen"),
    "searchFilterSubtitleUBQ" : MessageLookupByLibrary.simpleMessage("Alle Ubiq coins auswählen"),
    "searchFilterSubtitleutxo" : MessageLookupByLibrary.simpleMessage("Alle UTXO coins auswählen"),
    "searchForTicker" : MessageLookupByLibrary.simpleMessage("Ticker suchen"),
    "seconds" : MessageLookupByLibrary.simpleMessage("s"),
    "security" : MessageLookupByLibrary.simpleMessage("Sicherheit"),
    "seeOrders" : m76,
    "seeTxHistory" : MessageLookupByLibrary.simpleMessage("Transaktionsverlauf anzeigen"),
    ...
    "selectFileImport" : MessageLookupByLibrary.simpleMessage("Datei auswählen"),
    ...
    "selectedOrder" : MessageLookupByLibrary.simpleMessage("Ausgewählter Auftrag:"),
    "sell" : MessageLookupByLibrary.simpleMessage("Verkaufen"),
    "sellTestCoinWarning" : MessageLookupByLibrary.simpleMessage("Achtung, Sie sind bereit, Testmünzen OHNE realen Wert zu verkaufen!"),
    "send" : MessageLookupByLibrary.simpleMessage("SENDEN"),
    "setUpPassword" : MessageLookupByLibrary.simpleMessage("KENNWORT EINRICHTEN"),
    "settingDialogSpan1" : MessageLookupByLibrary.simpleMessage("Sind Sie sicher, dass Sie die"),
    "settingDialogSpan2" : MessageLookupByLibrary.simpleMessage("Wallet löschen möchten?"),
    ...
    "settingLanguageTitle" : MessageLookupByLibrary.simpleMessage("Sprachen"),
    "settings" : MessageLookupByLibrary.simpleMessage("Einstellungen"),
    "share" : MessageLookupByLibrary.simpleMessage("Teilen"),
    "shareAddress" : m77,
    "showDetails" : MessageLookupByLibrary.simpleMessage("Details anzeigen"),
    "showMyOrders" : MessageLookupByLibrary.simpleMessage("MEINE AUFTRÄGE ANZEIGEN"),
    "signInWithPassword" : MessageLookupByLibrary.simpleMessage("Mit Kennwort anmelden"),
    "signInWithSeedPhrase" : MessageLookupByLibrary.simpleMessage("Kennwort vergessen? Wallet mit der Seed wiederherstellen"),
    "simple" : MessageLookupByLibrary.simpleMessage("Einfach"),
    "simpleTradeActivate" : MessageLookupByLibrary.simpleMessage("Aktivieren"),
    ...
    "simpleTradeSellTitle" : MessageLookupByLibrary.simpleMessage("Verkaufen"),
    "simpleTradeSend" : MessageLookupByLibrary.simpleMessage("Senden"),
    "simpleTradeShowLess" : MessageLookupByLibrary.simpleMessage("Weniger anzeigen"),
    "simpleTradeShowMore" : MessageLookupByLibrary.simpleMessage("Mehr anzeigen"),
    ...
    "soundSettingsTitle" : MessageLookupByLibrary.simpleMessage("Sound-Einstellungen"),
    "soundsDialogTitle" : MessageLookupByLibrary.simpleMessage("Sounds"),
    "soundsDoNotShowAgain" : MessageLookupByLibrary.simpleMessage("Verstanden, nicht mehr zeigen"),
    "soundsExplanation" : MessageLookupByLibrary.simpleMessage("Während des Swap-Prozesses und wenn ein aktiver Maker-Auftrag erteilt wird, hören Sie akustische Benachrichtigungen.\nDas Atomic-Swap-Protokoll erfordert, dass die Teilnehmer für einen erfolgreichen Handel online sind, und akustische Benachrichtigungen helfen dabei."),
    "soundsNote" : MessageLookupByLibrary.simpleMessage("Beachten Sie, dass Sie Ihre eigenen Sounds in den Anwendungseinstellungen festlegen können."),
    ...
    "swapDetailTitle" : MessageLookupByLibrary.simpleMessage("TAUSCH-DETAILS BESTÄTIGEN"),
    ...
    "swapProgress" : MessageLookupByLibrary.simpleMessage("Fortschrittdetails"),
    ...
    "titleCreatePassword" : MessageLookupByLibrary.simpleMessage("PASSWORT ERSTELLEN"),
    "titleCurrentAsk" : MessageLookupByLibrary.simpleMessage("Auftrag ausgewählt"),
    "to" : MessageLookupByLibrary.simpleMessage("An"),
    "toAddress" : MessageLookupByLibrary.simpleMessage("An Adresse:"),
    "tooManyAssetsEnabledSpan1" : MessageLookupByLibrary.simpleMessage("Sie haben"),
    "tooManyAssetsEnabledSpan2" : MessageLookupByLibrary.simpleMessage("Assets aktiviert. Max Limit aktivierbarer Assets ist"),
    "tooManyAssetsEnabledSpan3" : MessageLookupByLibrary.simpleMessage(". Bitte deaktivieren Sie welche, bevor Sie neue hinzufügen."),
    "tooManyAssetsEnabledTitle" : MessageLookupByLibrary.simpleMessage("Zu viele Assets aktiviert"),
    "totalFees" : MessageLookupByLibrary.simpleMessage("Gesamtgebühren:"),
    "trade" : MessageLookupByLibrary.simpleMessage("HANDEL"),
    "tradeCompleted" : MessageLookupByLibrary.simpleMessage("SWAP ABGESCHLOSSEN!"),
    "tradeDetail" : MessageLookupByLibrary.simpleMessage("HANDELSDETAILS"),
    "tradePreimageError" : MessageLookupByLibrary.simpleMessage("Handelsgebühren konnten nicht berechnet werden"),
    "tradingFee" : MessageLookupByLibrary.simpleMessage("Handelsgebühr:"),
    "tradingMode" : MessageLookupByLibrary.simpleMessage("Handelsart:"),
    "traditionalChinese" : MessageLookupByLibrary.simpleMessage("traditionell"),
    "tryRestarting" : MessageLookupByLibrary.simpleMessage("Wenn auch dann noch einige Coins nicht aktiviert sind, versuchen Sie, die App neu zu starten."),
    ...
    "txFeeTitle" : MessageLookupByLibrary.simpleMessage("Transaktionsgebühr:"),
    "txHash" : MessageLookupByLibrary.simpleMessage("Transaktions ID"),
    "txLimitExceeded" : MessageLookupByLibrary.simpleMessage("Zu viele Anfragen.\nDas Limit für Anfragen zur Transaktionshistorie wurde überschritten.\nBitte versuchen Sie es später noch einmal."),
    "txNotConfirmed" : MessageLookupByLibrary.simpleMessage("UNBESTÄTIGT"),
    "txleft" : m89,
    "unlock" : MessageLookupByLibrary.simpleMessage("Freischalten"),
    "unlockFunds" : MessageLookupByLibrary.simpleMessage("Geldmittel freischalten"),
    "unlockSuccess" : m90,
    "unspendable" : MessageLookupByLibrary.simpleMessage("Nicht verwendbar"),
    "updatesAvailable" : MessageLookupByLibrary.simpleMessage("Neue Version verfügbar"),
    "updatesChecking" : MessageLookupByLibrary.simpleMessage("Nach Updates suchen..."),
    "updatesCurrentVersion" : m91,
    "updatesNotifAvailable" : MessageLookupByLibrary.simpleMessage("Neue Version verfügbar. Bitte updaten."),
    "updatesNotifAvailableVersion" : m92,
    "updatesNotifTitle" : MessageLookupByLibrary.simpleMessage("Update verfügbar"),
    "updatesSkip" : MessageLookupByLibrary.simpleMessage("Vorerst überspringen"),
    "updatesTitle" : m93,
    "updatesUpToDate" : MessageLookupByLibrary.simpleMessage("Bereits auf dem neuesten Stand"),
    "updatesUpdate" : MessageLookupByLibrary.simpleMessage("Update"),
    "uriInsufficientBalanceSpan1" : MessageLookupByLibrary.simpleMessage("Nicht genug Guthaben für die gescannte"),
    "uriInsufficientBalanceSpan2" : MessageLookupByLibrary.simpleMessage("Zahlungsaufforderung."),
    "uriInsufficientBalanceTitle" : MessageLookupByLibrary.simpleMessage("Unzureichendes Guthaben"),
    "value" : MessageLookupByLibrary.simpleMessage("Wert:"),
    "version" : MessageLookupByLibrary.simpleMessage("Version"),
    "viewInExplorerButton" : MessageLookupByLibrary.simpleMessage("Explorer"),
    "viewSeedAndKeys" : MessageLookupByLibrary.simpleMessage("Seed & Private Schlüssel"),
    "volumes" : MessageLookupByLibrary.simpleMessage("Volumen"),
    "walletInUse" : MessageLookupByLibrary.simpleMessage("Wallet-Name existiert bereits"),
    "walletMaxChar" : MessageLookupByLibrary.simpleMessage("Wallet-Name darf maximal 40 Zeichen lang sein"),
    ...
    "warningShareLogs" : MessageLookupByLibrary.simpleMessage("Achtung - in besonderen Fällen enthalten diese Protokolldaten sensible Informationen, die dazu verwendet werden können, Coins aus fehlgeschlagenen Swaps auszugeben!"),
    "weFailedTo" : m94,
    ...
    "willBeRedirected" : MessageLookupByLibrary.simpleMessage("Nach Fertigstellung werden Sie zur Portfolio-Seite weitergeleitet."),
    "withdraw" : MessageLookupByLibrary.simpleMessage("Auszahlung"),
    "withdrawCameraAccessText" : m97,
    "withdrawCameraAccessTitle" : MessageLookupByLibrary.simpleMessage("Zugriff verweigert"),
    "withdrawConfirm" : MessageLookupByLibrary.simpleMessage("Auszahlung bestätigen"),
    "withdrawConfirmError" : MessageLookupByLibrary.simpleMessage("Es ist ein Fehler aufgetreten. Bitte versuchen Sie es später noch einmal."),
    "withdrawValue" : m98,
    "wrongCoinSpan1" : MessageLookupByLibrary.simpleMessage("Sie versuchen, einen QR-Code für eine Zahlung zu scannen"),
    "wrongCoinSpan2" : MessageLookupByLibrary.simpleMessage("aber Sie sind auf dem"),
    "wrongCoinSpan3" : MessageLookupByLibrary.simpleMessage("Auszahlungs-Bildschirm"),
    "wrongCoinTitle" : MessageLookupByLibrary.simpleMessage("Falscher Coin"),
    "wrongPassword" : MessageLookupByLibrary.simpleMessage("Die Kennwörter stimmen nicht überein. Bitte versuche es erneut."),
    "yes" : MessageLookupByLibrary.simpleMessage("Ja"),
    "you have a fresh order that is trying to match with an existing order" : MessageLookupByLibrary.simpleMessage("Sie haben einen neuen Auftrag, der  einem bestehenden Auftrag zugeordnet werden soll"),
    "you have an active swap in progress" : MessageLookupByLibrary.simpleMessage("Sie haben einen aktiven Swap in Arbeit"),
    "you have an order that new orders can match with" : MessageLookupByLibrary.simpleMessage("Sie haben einen Auftrag, dem neue Aufträge zugeordnet werden können"),
