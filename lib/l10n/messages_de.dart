...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} ist für Mobilgeräte auf Android und iPhone sowie für Desktops auf <a href=\"https://firo.org/\">Windows-, Mac- und Linux-Betriebssystemen</a> verfügbar.";

  static m9(appName) =>
      "Bei anderen DEXs können Sie im Allgemeinen nur Assets handeln, die auf einem einzigen Blockchain-Netzwerk basieren, Proxy-Token verwenden und nur einen einzigen Auftrag mit denselben Geldmitteln aufgeben.\n\n${appName} ermöglicht Ihnen den nativen Handel über zwei verschiedene Blockchain-Netzwerke ohne Proxy-Tokens. Sie können auch mehrere Aufträge mit demselben Guthaben platzieren. Sie können zum Beispiel 0,1 BTC für FIRO, QTUM oder VRSC verkaufen - der erste Auftrag, der ausgeführt wird, storniert automatisch alle anderen Aufträge.";

  static m10(appName) =>
      "Mehrere Faktoren bestimmen die Bearbeitungszeit für einen Swap. Die Blockzeit der gehandelten Assets hängt vom jeweiligen Netzwerk ab (Bitcoin ist normalerweise das langsamste). Außerdem kann der Benutzer die Sicherheitseinstellungen anpassen. Zum Beispiel (können Sie ${appName} bitten, eine FIRO-Transaktion nach nur 3 Bestätigungen als endgültig zu betrachten, wodurch die Swap-Zeit kürzer wird als beim Warten auf eine <a href=\"https://firo.org/\">Beglaubigung</a>";
  ...
  static m15(appName) =>
      "Absolut! Weitere Informationen finden Sie in unserer <a href=\"https://firo.org/\">Entwicklerdokumentation</a> oder kontaktieren Sie uns mit Ihren Partnerschaftsanfragen. Haben Sie eine spezielle technische Frage? Die ${appName}-Entwickler-Community ist immer bereit zu helfen!";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "builtFiro": MessageLookupByLibrary.simpleMessage("Auf Firo aufgebaut"),
        "builtOnKmd":
            MessageLookupByLibrary.simpleMessage("Auf Firo aufgebaut"),
        ...
        "dPow": MessageLookupByLibrary.simpleMessage("Firo dPoW Sicherheit"),
        ...
        "poweredOnKmd":
            MessageLookupByLibrary.simpleMessage("Unterstützt von Firo"),
        ...
        "rebrandingAnnouncement": MessageLookupByLibrary.simpleMessage(
            "Es ist eine neue Ära! Wir haben unseren Namen offiziell von „AtomicDEX“ in „Firo Wallet“ geändert."),
