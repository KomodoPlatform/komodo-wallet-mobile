...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} ist für Mobilgeräte auf Android und iPhone sowie für Desktops auf <a href=\"https://piratechain.com/\">Windows-, Mac- und Linux-Betriebssystemen</a> verfügbar.";
  ...
  static m10(appName) =>
      "Mehrere Faktoren bestimmen die Bearbeitungszeit für einen Swap. Die Blockzeit der gehandelten Assets hängt vom jeweiligen Netzwerk ab (Bitcoin ist normalerweise das langsamste). Außerdem kann der Benutzer die Sicherheitseinstellungen anpassen. Zum Beispiel (können Sie ${appName} bitten, eine ARRR-Transaktion nach nur 3 Bestätigungen als endgültig zu betrachten, wodurch die Swap-Zeit kürzer wird als beim Warten auf eine <a href=\"https://piratechain.com/faq/\">Beglaubigung</a>";
  ...
  static m15(appName) =>
      "Absolut! Weitere Informationen finden Sie in unserer <a href=\"https://piratechain.com/faq/\">Entwicklerdokumentation</a> oder kontaktieren Sie uns mit Ihren Partnerschaftsanfragen. Haben Sie eine spezielle technische Frage? Die ${appName}-Entwickler-Community ist immer bereit zu helfen!";
