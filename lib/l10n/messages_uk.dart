...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} доступний для мобільних пристроїв на Android і iPhone, а також для комп’ютерів в <a href=\"https://piratechain.com/\">операційних системах Windows, Mac і Linux</a>.";
  ...
  static m15(appName) =>
      "Абсолютно! Щоб дізнатися більше, прочитайте нашу <a href=\"https://piratechain.com/faq/\">документацію для розробників</a> або зв’яжіться з нами із запитами про партнерство. Є конкретне технічне запитання? Спільнота розробників ${appName} завжди готова допомогти!";
