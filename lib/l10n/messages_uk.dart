...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(appName) =>
      "${appName} доступний для мобільних пристроїв на Android і iPhone, а також для комп’ютерів в <a href=\"https://firo.org/\">операційних системах Windows, Mac і Linux</a>.";

  static m9(appName) =>
      "Інші DEX, як правило, дозволяють лише торгувати активами, які базуються на одній мережі блокчейну, використовують проксі-токени та дозволяють розміщувати лише одне замовлення з тими самими коштами.\n\n${appName} дає вам змогу безпосередньо торгувати між двома різними блокчейн-мережами без проксі-токенів. Ви також можете розмістити кілька замовлень з однаковими коштами. Наприклад, ви можете продати 0,1 BTC за FIRO, QTUM або VRSC — перше заповнене замовлення автоматично скасовує всі інші замовлення.";

  static m10(appName) =>
      "Кілька факторів визначають час обробки для кожного обміну. Час блокування торгових активів залежить від кожної мережі (біткойн зазвичай найповільніший). Крім того, користувач може налаштувати параметри безпеки. Наприклад, ви можете попросити ${appName} вважати транзакцію FIRO остаточною лише після 3 підтверджень, що скорочує час обміну порівняно з очікуванням <a href=\"https://firo.org/security-delayed-proof- of-work-dpow/\">нотаріальне засвідчення</a>.";
  ...
  static m15(appName) =>
      "Абсолютно! Щоб дізнатися більше, прочитайте нашу <a href=\"https://firo.org/\">документацію для розробників</a> або зв’яжіться з нами із запитами про партнерство. Є конкретне технічне запитання? Спільнота розробників ${appName} завжди готова допомогти!";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "rebrandingAnnouncement": MessageLookupByLibrary.simpleMessage(
            "Це нова ера! Ми офіційно змінили назву з \"AtomicDEX\" на \"Firo Wallet\""),
