...
class AppLocalizations {
  ...
  String get appName => Intl.message('atomicDeFi', name: 'appName');
  ...
  String get articleFrom =>
      Intl.message('atomicDeFi NEWS', name: 'articleFrom');
  ...
  String get welcomeName => Intl.message('atomicDeFi', name: 'welcomeName');
  String get welcomeWallet => Intl.message('wallet', name: 'welcomeWallet');
  String get welcomeInfo => Intl.message(
      'atomicDeFi mobile is a next generation multi-coin wallet with native third generation DEX functionality and more.',
      name: 'welcomeInfo');
  ...
  String get eulaTitle1 => Intl.message(
      'End-User License Agreement (EULA) of atomicDeFi mobile:\n\n',
      name: 'eulaTitle1');
