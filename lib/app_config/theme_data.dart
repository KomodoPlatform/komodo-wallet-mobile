...
ColorScheme get _colorScheme => const ColorScheme(
      ...
      onPrimary: Color.fromRGBO(247, 240, 241, 1),
      onSecondary: Color.fromRGBO(247, 240, 241, 1),
      onSurface: Color.fromRGBO(247, 240, 241, 1),
      onBackground: Color.fromRGBO(247, 240, 241, 1),
      onError: Color.fromRGBO(247, 240, 241, 1),
      brightness: Brightness.dark,
    );

// Color scheme light adapted from current dev
ColorScheme get _colorSchemeLight => const ColorScheme(
      primary: Color.fromRGBO(247, 240, 241, 1),
      primaryVariant: Color.fromRGBO(155, 28, 46, 1),
      secondary: Color.fromRGBO(155, 28, 46, 1),
      secondaryVariant: Color.fromRGBO(17, 2, 2, 1),
      surface: Color.fromRGBO(247, 240, 241, 1),
      background: Color.fromRGBO(255, 255, 255, 1),
      error: Color.fromRGBO(202, 78, 61, 1),
      onPrimary: Color.fromRGBO(17, 2, 2, 1),
      onSecondary: Color.fromRGBO(247, 240, 241, 1),
      onSurface: Color.fromRGBO(17, 2, 2, 1),
      onBackground: Color.fromRGBO(17, 2, 2, 1),
      onError: Color.fromRGBO(247, 240, 241, 1),
...
ThemeData getThemeDark() => ThemeData(
      ...
      dialogBackgroundColor: const Color.fromRGBO(17, 2, 2, 1),
...
ThemeData getThemeLight() => ThemeData(
      ...
      dialogBackgroundColor: const Color.fromRGBO(247, 240, 241, 1),
      disabledColor: const Color.fromRGBO(201, 201, 201, 1),
      dividerColor: _dividerThemeData.color,
