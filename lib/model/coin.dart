...
List<Coin> coinFromJson(String str) =>
    new List<Coin>.from(json.decode(str).map((x) => Coin.fromJson(x)));
...
class Coin {
  ...
  factory Coin.fromJson(Map<String, dynamic> json) => new Coin(
        ...
        swapContractAddress: json["swap_contract_address"] == null
            ? null
            : json["swap_contract_address"],
        colorCoin: json["colorCoin"] == null ? null : json["colorCoin"],
        serverList: json["serverList"] == null
            ? null
            : new List<String>.from(json["serverList"].map((x) => x)),
        explorerUrl: json["explorerUrl"] == null
            ? null
            : new List<String>.from(json["explorerUrl"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "swap_contract_address":
            swapContractAddress == null ? null : swapContractAddress,
        "colorCoin": colorCoin == null ? null : colorCoin,
        "serverList": serverList == null
            ? null
            : new List<dynamic>.from(serverList.map((x) => x)),
        "explorerUrl": explorerUrl == null
            ? null
            : new List<dynamic>.from(explorerUrl.map((x) => x)),
      };
