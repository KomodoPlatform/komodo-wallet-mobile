...
void main() {
  ...
  final SerializableFinder restoreWalletScreen = find.text('RESTORE');                        //   - 4 Create Password Screen
  final SerializableFinder createWalletScreen = find.text('CREATE A WALLET');                 //   - 5 Accept Disclaimer Screen
  final SerializableFinder createWalletNameScreen = find.text('WELCOME');                     //   - 6 Create PIN Code Screen
  final SerializableFinder enterYourSeedScreen = find.text('Enter Your Seed Phrase');         //   - 7 Portfolio Screen
  final SerializableFinder createPasswordScreen = find.text('CREATE A PASSWORD');             //   - 8 Markets Screen
  final SerializableFinder disclaimerScreen = find.text('Disclaimer & ToS');                  //   - 9 Feed Screen
  final SerializableFinder createaPINScreen = find.text('Create PIN');                        //   - 10 Setting Screen (Delete Wallet)
  ...
  group('|  (Scenario 4) Markets, Feed and Settings  ', () {
    ...
    test('| -4.13- | Check pressing on coin in price-screen moves you to order-book-screen and pops-up Select-Coin-Popup-Screen', () async {
      expect(await driver.getText(marketsPriceScreen), 'PRICE');
      expect(await driver.getText(marketsOrderBookScreen), 'ORDER BOOK');
    ...
    test('| -4.14- | Check pressing on grey btn BTC/BTC in select-coin-pop-up does not do anything', () async {
      expect(await driver.getText(marketsSelectCoinPopupScreen), 'Select Coin');
    ...
    test('| -4.15- | Check pressing on BTC/KMD in select-coin-pop-up brings up order-book-table', () async {
      expect(await driver.getText(marketsSelectCoinPopupScreen), 'Select Coin');
    ...
    test('| -4.17- | Check coin-select-left button brings up select-coin-screen', () async {
      expect(await driver.getText(marketsPriceScreen), 'PRICE');
      expect(await driver.getText(marketsOrderBookScreen), 'ORDER BOOK');
    ...
    test('| -4.18- | Confirm you can clear coin-select-left-btn field and order-book-table will dissapear', () async {
      expect(await driver.getText(marketsSelectCoinPopupScreen), 'Select Coin');
    ...
    test('| -4.19- | Confirm coin-select-right button brings up select-coin-screen', () async {
      expect(await driver.getText(marketsOrderBookEmptyScreen), 'Please select coins');
