...
void main() {
  ...
  final SerializableFinder createWalletScreen =
      find.text('CREATE A WALLET'); //   - 4 Create Password Screen
  ...
  group('| (Scenario 6) Swaps  ', () {
    ...
    */
    ...
    test('| -6.7- | (Delay: 5 seconds) Check if mm2 successfully connected',
        () async {
    ...
    test('| -6.8- | Swap MORTY for RICK', () async {
      ...
      await driver
          .scrollIntoView(find.byValueKey('item-dialog-morty-market.sell'));
